...
class PerbaikanDataController extends Controller
{
    ...
    {
        // 1. Ambil ID Layanan
        $layanan = JenisLayanan::where('slug', 'perbaikan-data-asn')->first();

        if (!$layanan) {
            return back()->with('error', 'Layanan Perbaikan Data ASN belum dikonfigurasi.');
        }
        ...
        return view('pages.admin.perbaikan_data.index', compact('pengajuan', 'stats'));
    }
    ...
    public function approve(Request $request)
    {
        ...
        return back()->with('success', 'Pengajuan Perbaikan Data disetujui.');
    }
