...
class SatyalancanaController extends Controller
{
    ...
    {
        // 1. Ambil ID Layanan
        $layanan = JenisLayanan::where('slug', 'satyalancana')->first();

        if (!$layanan) {
            return back()->with('error', 'Layanan Satyalancana belum dikonfigurasi.');
        }
        ...
        return view('pages.admin.satyalancana.index', compact('pengajuan', 'stats'));
    }
    ...
    public function approve(Request $request)
    {
        ...
        return back()->with('success', 'Pengajuan Satyalancana disetujui.');
    }
