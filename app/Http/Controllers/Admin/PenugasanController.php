...
class PenugasanController extends Controller
{
    ...
    {
        // 1. Ambil ID Layanan
        $layanan = JenisLayanan::where('slug', 'penugasan')->first();

        if (!$layanan) {
            return back()->with('error', 'Layanan Penugasan belum dikonfigurasi.');
        }
        ...
        return view('pages.admin.penugasan.index', compact('pengajuan', 'stats'));
    }
    ...
    public function approve(Request $request)
    {
        ...
        return back()->with('success', 'Pengajuan Penugasan disetujui.');
    }
