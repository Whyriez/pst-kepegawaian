...
class KonversiAKPendidikanController extends Controller
{
    ...
    {
        // 1. Ambil ID Layanan berdasarkan SLUG yang benar
        $layanan = JenisLayanan::where('slug', 'konversi-ak-pendidikan')->first();

        if (!$layanan) {
            return back()->with('error', 'Layanan Konversi AK Pendidikan belum dikonfigurasi.');
        }
        ...
        return view('pages.admin.konversi_ak_pendidikan.index', compact('pengajuan', 'stats'));
    }
    ...
    public function approve(Request $request)
    {
        ...
        return back()->with('success', 'Pengajuan Konversi AK Pendidikan disetujui.');
    }
