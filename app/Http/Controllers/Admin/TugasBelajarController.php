...
class TugasBelajarController extends Controller
{
    ...
    {
        // 1. Ambil ID Layanan
        $layanan = JenisLayanan::where('slug', 'tugas-belajar')->first();

        if (!$layanan) {
            return back()->with('error', 'Layanan Tugas Belajar belum dikonfigurasi.');
        }
        ...
        return view('pages.admin.tugas_belajar.index', compact('pengajuan', 'stats'));
    }
    ...
    public function approve(Request $request)
    {
        ...
        return back()->with('success', 'Pengajuan Tugas Belajar disetujui.');
    }
