...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="h4 fw-bold text-primary mb-1">Kenaikan Pangkat Reguler</h2>
            <p class="text-muted mb-0">Kelola persetujuan pengajuan kenaikan pangkat reguler pegawai</p>
        </div>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
                <li><a class="dropdown-item" href="{{ route('admin.kp.reguler') }}">Semua</a></li>
                <li><a class="dropdown-item" href="{{ route('admin.kp.reguler', ['status' => 'pending']) }}">Menunggu
                        Verifikasi</a></li>
                <li><a class="dropdown-item" href="{{ route('admin.kp.reguler', ['status' => 'disetujui']) }}">Disetujui</a>
                </li>
                <li><a class="dropdown-item" href="{{ route('admin.kp.reguler', ['status' => 'ditunda']) }}">Ditunda</a>
                </li>
                <li><a class="dropdown-item" href="{{ route('admin.kp.reguler', ['status' => 'ditolak']) }}">Ditolak</a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body d-flex align-items-center">
                    <div class="bg-primary-subtle text-primary rounded-circle p-3 me-3"><i
                ...
                <table class="table table-hover align-middle mb-0">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th class="py-3">Pangkat Saat Ini</th>
                            <th class="py-3">Usulan Baru</th> {{-- Header disesuaikan --}}
                    ...
                    <tbody>
                        @forelse($pengajuan as $item)
                            <tr>
                                ...
                                {{-- 3. Pangkat Lama (Dari Data Pegawai) --}}
                                <td>
                                    <div class="small fw-bold text-secondary">{{ $item->pegawai->pangkat }}</div>
                                    <small class="text-muted">Gol: {{ $item->pegawai->golongan_ruang }}</small>
                                </td>

                                {{-- 4. Usulan Baru (Dari JSON data_tambahan) --}}
                                <td>
                                    <div class="small fw-bold text-primary">{{ $item->data_tambahan['pangkat'] ?? '-' }}
                                    </div>
                                    <small class="text-muted">Gol:
                                        {{ $item->data_tambahan['golongan_ruang'] ?? '-' }}</small>
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center py-5 text-muted">
                                    ...
                                    <p>Belum ada pengajuan kenaikan pangkat reguler.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
    ...
    <div class="modal fade" id="rejectModalPage" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('admin.kp.reguler.reject') }}" method="POST" id="formTolak">
                    @csrf
                    <div class="modal-header bg-danger text-white">
                        <h5 class="modal-title"><i class="fas fa-times-circle me-2"></i>Tolak Pengajuan Reguler</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="kategori" required>
                                ...
                                <option value="masa_kerja_kurang">Masa Kerja Belum Mencukupi (4 Tahun)</option>
                                <option value="skp_kurang">Nilai SKP Kurang Baik</option>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="alasan" rows="4" required
                                placeholder="Jelaskan detail alasan penolakan..."></textarea>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="postponeModalPage" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('admin.kp.reguler.postpone') }}" method="POST" id="formTunda">
                    @csrf
                    <div class="modal-header bg-warning text-dark">
                        <h5 class="modal-title"><i class="fas fa-pause-circle me-2"></i>Tunda Pengajuan Reguler</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="alasan" rows="3" required
                                placeholder="Contoh: Menunggu konfirmasi periode kenaikan pangkat..."></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Batal</button>
    ...
    {{-- FORM APPROVE HIDDEN --}}
    <form id="formApproveHidden" action="{{ route('admin.kp.reguler.approve') }}" method="POST"
        style="display: none;">
        @csrf
    ...
    <script>
        ...
        function confirmApprove(id) {
            Swal.fire({
                ...
                text: "Pastikan masa kerja dan SKP pegawai sudah memenuhi syarat.",
                icon: 'question',
