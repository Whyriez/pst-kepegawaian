...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="h4 fw-bold text-primary mb-1">Penugasan Pegawai</h2>
            <p class="text-muted mb-0">Verifikasi usulan penugasan (Plt, Plh, atau Penugasan Khusus)</p>
        </div>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
                <li><a class="dropdown-item" href="{{ route('admin.penugasan') }}">Semua</a></li>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        <h6 class="text-muted small mb-1">Total Penugasan</h6>
    ...
    <div class="modal fade" id="rejectModalPage" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('admin.penugasan.reject') }}" method="POST" id="formTolak">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="kategori" required>
                                ...
                                <option value="tidak_sesuai_kompetensi">Tidak Sesuai Kompetensi</option>
                                <option value="formasi_tidak_tersedia">Formasi/Posisi Tidak Tersedia</option>
    ...
    <div class="modal fade" id="postponeModalPage" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('admin.penugasan.postpone') }}" method="POST" id="formTunda">
                    @csrf
