...
@section('title', 'Jabatan Fungsional - Kenaikan Jenjang')

@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="h4 fw-bold text-primary mb-1">Kenaikan Jenjang JF</h2>
            <p class="text-muted mb-0">Verifikasi usulan kenaikan jenjang jabatan fungsional</p>
        </div>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
                <li><a class="dropdown-item" href="{{ route('admin.jf.naik_jenjang') }}">Semua</a></li>
                <li><a class="dropdown-item"
                        href="{{ route('admin.jf.naik_jenjang', ['status' => 'pending']) }}">Menunggu Verifikasi</a></li>
                <li><a class="dropdown-item"
                        href="{{ route('admin.jf.naik_jenjang', ['status' => 'disetujui']) }}">Disetujui</a></li>
                <li><a class="dropdown-item"
                        href="{{ route('admin.jf.naik_jenjang', ['status' => 'ditunda']) }}">Ditunda</a></li>
                <li><a class="dropdown-item"
                        href="{{ route('admin.jf.naik_jenjang', ['status' => 'ditolak']) }}">Ditolak</a></li>
            </ul>
        </div>
    </div>
                ...
                <table class="table table-hover align-middle mb-0">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th class="py-3">Usulan Jenjang</th>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center py-5 text-muted">
                                    ...
                                    <p>Belum ada pengajuan kenaikan jenjang.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
    ...
    <div class="modal fade" id="rejectModalPage" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('admin.jf.naik_jenjang.reject') }}" method="POST" id="formTolak">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="kategori" required>
                                ...
                                <option value="tidak_lulus_ukom">Tidak Lulus Uji Kompetensi</option>
                                <option value="formasi_penuh">Formasi Jabatan Penuh</option>
                                <option value="masa_kerja_kurang">Masa Kerja Dalam Jabatan Kurang</option>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="alasan" rows="4" required placeholder="Jelaskan detail kekurangan..."></textarea>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="postponeModalPage" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('admin.jf.naik_jenjang.postpone') }}" method="POST" id="formTunda">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="alasan" rows="3" required
                                placeholder="Menunggu hasil penilaian PAK..."></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Batal</button>
    ...
    {{-- HIDDEN APPROVE --}}
    <form id="formApproveHidden" action="{{ route('admin.jf.naik_jenjang.approve') }}" method="POST"
        style="display: none;">
        @csrf
...
@push('scripts')
    <script>
        function confirmApprove(id) {
            Swal.fire({
                title: 'Setujui Kenaikan Jenjang?',
