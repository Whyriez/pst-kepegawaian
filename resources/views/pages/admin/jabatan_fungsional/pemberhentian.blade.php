...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="h4 fw-bold text-primary mb-1">Pemberhentian Jabatan Fungsional</h2>
            <p class="text-muted mb-0">Verifikasi usulan pembebasan/pemberhentian dari jabatan fungsional</p>
        </div>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
                <li><a class="dropdown-item" href="{{ route('admin.jf.pemberhentian') }}">Semua</a></li>
                <li><a class="dropdown-item"
                        href="{{ route('admin.jf.pemberhentian', ['status' => 'pending']) }}">Menunggu Verifikasi</a></li>
                <li><a class="dropdown-item"
                        href="{{ route('admin.jf.pemberhentian', ['status' => 'disetujui']) }}">Disetujui</a></li>
                <li><a class="dropdown-item"
                        href="{{ route('admin.jf.pemberhentian', ['status' => 'ditunda']) }}">Ditunda</a></li>
                <li><a class="dropdown-item"
                        href="{{ route('admin.jf.pemberhentian', ['status' => 'ditolak']) }}">Ditolak</a></li>
            </ul>
        </div>
    </div>
                ...
                <table class="table table-hover align-middle mb-0">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th class="py-3">Jabatan Diberhentikan</th>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center py-5 text-muted">
                                    ...
                                    <p>Belum ada pengajuan pemberhentian JF.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
    ...
    <div class="modal fade" id="rejectModalPage" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('admin.jf.pemberhentian.reject') }}" method="POST" id="formTolak">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="kategori" required>
                                ...
                                <option value="alasan_tidak_kuat">Alasan Pengunduran Diri Tidak Kuat</option>
                                <option value="sedang_tugas_belajar">Sedang Menjalani Tugas Belajar</option>
                                <option value="masih_ada_tanggungan">Masih Ada Tanggungan Pekerjaan</option>
    ...
    <div class="modal fade" id="postponeModalPage" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('admin.jf.pemberhentian.postpone') }}" method="POST" id="formTunda">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="alasan" rows="3" required
                                placeholder="Menunggu konfirmasi atasan langsung..."></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Batal</button>
    ...
    {{-- HIDDEN APPROVE --}}
    <form id="formApproveHidden" action="{{ route('admin.jf.pemberhentian.approve') }}" method="POST"
        style="display: none;">
        @csrf
