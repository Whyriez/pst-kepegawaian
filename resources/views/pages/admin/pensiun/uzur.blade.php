...
@section('title', 'Pensiun - Uzur (Sakit)')

@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="h4 fw-bold text-primary mb-1">Pensiun Uzur (Kesehatan)</h2>
            <p class="text-muted mb-0">Kelola pengajuan pensiun karena ketidakcakapan jasmani/rohani</p>
        </div>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
                <li><a class="dropdown-item" href="{{ route('admin.pensiun.uzur') }}">Semua</a></li>
                <li><a class="dropdown-item" href="{{ route('admin.pensiun.uzur', ['status' => 'pending']) }}">Menunggu
                        Verifikasi</a></li>
                <li><a class="dropdown-item"
                        href="{{ route('admin.pensiun.uzur', ['status' => 'disetujui']) }}">Disetujui</a></li>
                <li><a class="dropdown-item" href="{{ route('admin.pensiun.uzur', ['status' => 'ditunda']) }}">Ditunda</a>
                </li>
                <li><a class="dropdown-item" href="{{ route('admin.pensiun.uzur', ['status' => 'ditolak']) }}">Ditolak</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            <h5 class="card-title mb-0 text-primary fw-bold"><i class="fas fa-procedures me-2"></i>Daftar Pengajuan Uzur
            </h5>
                ...
                <table class="table table-hover align-middle mb-0">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th class="py-3">Jabatan & Kondisi</th>
                    ...
                    <tbody>
                        @forelse($pengajuan as $item)
                            <tr>
                                ...
                                {{-- 3. Info Kesehatan (Ambil dari JSON) --}}
                                <td>
                                    <div class="small fw-bold">{{ $item->pegawai->jabatan }}</div>
                                    <small class="text-danger d-block text-truncate" style="max-width: 250px;">
                                        <i class="fas fa-notes-medical me-1"></i>
                                        {{ $item->data_tambahan['kesimpulan_medis'] ?? 'Tidak ada data medis' }}
                                    </small>
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center py-5 text-muted">
                                    ...
                                    <p>Belum ada data pengajuan uzur.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
    ...
    <div class="modal fade" id="rejectModalPage" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                {{-- Route Khusus Uzur --}}
                <form action="{{ route('admin.pensiun.uzur.reject') }}" method="POST" id="formTolak">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="kategori" required>
                                ...
                                <option value="rekomendasi_medis_ditolak">Hasil Tim Kesehatan: Masih Cakap</option>
                                <option value="surat_keterangan_invalid">Surat Keterangan Dokter Tidak Valid</option>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="alasan" rows="4" required
                                placeholder="Jelaskan detail penolakan..."></textarea>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="postponeModalPage" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                {{-- Route Khusus Uzur --}}
                <form action="{{ route('admin.pensiun.uzur.postpone') }}" method="POST" id="formTunda">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="alasan" rows="3" required
                                placeholder="Contoh: Menunggu hasil pemeriksaan ulang Tim Kesehatan..."></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Batal</button>
    ...
    {{-- HIDDEN FORM APPROVE --}}
    <form id="formApproveHidden" action="{{ route('admin.pensiun.uzur.approve') }}" method="POST"
        style="display: none;">
        @csrf
