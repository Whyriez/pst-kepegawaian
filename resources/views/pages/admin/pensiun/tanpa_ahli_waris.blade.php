...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="h4 fw-bold text-primary mb-1">Pensiun Tanpa Ahli Waris</h2>
            <p class="text-muted mb-0">Kelola administrasi pegawai meninggal tanpa ahli waris (Penghentian Hak)</p>
        </div>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
                <li><a class="dropdown-item" href="{{ route('admin.pensiun.taw') }}">Semua</a></li>
                <li><a class="dropdown-item" href="{{ route('admin.pensiun.taw', ['status' => 'pending']) }}">Menunggu
                        Verifikasi</a></li>
                <li><a class="dropdown-item"
                        href="{{ route('admin.pensiun.taw', ['status' => 'disetujui']) }}">Disetujui</a></li>
                <li><a class="dropdown-item" href="{{ route('admin.pensiun.taw', ['status' => 'ditunda']) }}">Ditunda</a>
                </li>
                <li><a class="dropdown-item" href="{{ route('admin.pensiun.taw', ['status' => 'ditolak']) }}">Ditolak</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            <h5 class="card-title mb-0 text-primary fw-bold"><i class="fas fa-file-contract me-2"></i>Daftar Pengajuan</h5>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="small fw-bold">
                                        Status: {{ $item->data_tambahan['status_akhir'] ?? 'Meninggal' }}
                                    </div>
                                    <small class="text-muted">
                                        Catatan: {{ $item->data_tambahan['keterangan'] ?? '-' }}
                                    </small>
                                </td>
    ...
    <div class="modal fade" id="rejectModalPage" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                {{-- Route Khusus TAW --}}
                <form action="{{ route('admin.pensiun.taw.reject') }}" method="POST" id="formTolak">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="kategori" required>
                                ...
                                <option value="ahli_waris_ditemukan">Ditemukan Ahli Waris Sah</option>
                                <option value="data_tidak_valid">Data Pegawai Tidak Valid</option>
    ...
    <div class="modal fade" id="postponeModalPage" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                {{-- Route Khusus TAW --}}
                <form action="{{ route('admin.pensiun.taw.postpone') }}" method="POST" id="formTunda">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="alasan" rows="3" required
                                placeholder="Contoh: Menunggu Verifikasi Dukcapil..."></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Batal</button>
    ...
    {{-- HIDDEN FORM APPROVE --}}
    <form id="formApproveHidden" action="{{ route('admin.pensiun.taw.approve') }}" method="POST"
        style="display: none;">
        @csrf
