...
@section('title', 'Pensiun - Pegawai Hilang')

@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="h4 fw-bold text-primary mb-1">Pensiun Pegawai Hilang</h2>
            <p class="text-muted mb-0">Kelola administrasi pegawai yang dinyatakan hilang</p>
        </div>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
                <li><a class="dropdown-item" href="{{ route('admin.pensiun.hilang') }}">Semua</a></li>
                <li><a class="dropdown-item" href="{{ route('admin.pensiun.hilang', ['status' => 'pending']) }}">Menunggu
                        Verifikasi</a></li>
                <li><a class="dropdown-item"
                        href="{{ route('admin.pensiun.hilang', ['status' => 'disetujui']) }}">Disetujui</a></li>
                <li><a class="dropdown-item"
                        href="{{ route('admin.pensiun.hilang', ['status' => 'ditunda']) }}">Ditunda</a></li>
                <li><a class="dropdown-item"
                        href="{{ route('admin.pensiun.hilang', ['status' => 'ditolak']) }}">Ditolak</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            <h5 class="card-title mb-0 text-primary fw-bold"><i class="fas fa-user-secret me-2"></i>Daftar Pegawai Hilang
            </h5>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    <thead class="bg-light">
                        <tr>
                            <th class="ps-4 py-3">Tanggal Lapor</th>
                            <th class="py-3">Pegawai</th>
                            <th class="py-3">Keterangan Hilang</th>
                    ...
                    <tbody>
                        @forelse($pengajuan as $item)
                            <tr>
                                ...
                                {{-- 3. Info Hilang (Ambil dari JSON) --}}
                                <td>
                                    <div class="small fw-bold">
                                        Hilang Sejak: {{ $item->data_tambahan['tanggal_hilang'] ?? '-' }}
                                    </div>
                                    <small class="text-muted">
                                        No. Polisi: {{ $item->data_tambahan['no_laporan_polisi'] ?? '-' }}
                                    </small>
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center py-5 text-muted">
                                    ...
                                    <p>Belum ada data pengajuan hilang.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
    ...
    <div class="modal fade" id="rejectModalPage" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                {{-- Route Khusus Hilang --}}
                <form action="{{ route('admin.pensiun.hilang.reject') }}" method="POST" id="formTolak">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="kategori" required>
                                ...
                                <option value="laporan_polisi_invalid">Laporan Kepolisian Tidak Valid</option>
                                <option value="belum_batas_waktu">Belum Memenuhi Batas Waktu (12 Bulan)</option>
    ...
    <div class="modal fade" id="postponeModalPage" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                {{-- Route Khusus Hilang --}}
                <form action="{{ route('admin.pensiun.hilang.postpone') }}" method="POST" id="formTunda">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="alasan" rows="3" required
                                placeholder="Contoh: Menunggu Berita Acara Kepolisian..."></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Batal</button>
    ...
    {{-- HIDDEN FORM APPROVE --}}
    <form id="formApproveHidden" action="{{ route('admin.pensiun.hilang.approve') }}" method="POST"
        style="display: none;">
        @csrf
