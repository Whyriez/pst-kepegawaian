...
@section('title', 'Pensiun - Batas Usia Pensiun')

@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="h4 fw-bold text-primary mb-1">Pensiun - Batas Usia Pensiun</h2>
            <p class="text-muted mb-0">Kelola persetujuan pengajuan pensiun batas usia pensiun pegawai</p>
        </div>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
                <li><a class="dropdown-item" href="{{ route('admin.pensiun.bup') }}">Semua</a></li>
                <li><a class="dropdown-item" href="{{ route('admin.pensiun.bup', ['status' => 'pending']) }}">Menunggu
                        Verifikasi</a></li>
                <li><a class="dropdown-item"
                        href="{{ route('admin.pensiun.bup', ['status' => 'disetujui']) }}">Disetujui</a></li>
                <li><a class="dropdown-item" href="{{ route('admin.pensiun.bup', ['status' => 'ditunda']) }}">Ditunda</a>
                </li>
                <li><a class="dropdown-item" href="{{ route('admin.pensiun.bup', ['status' => 'ditolak']) }}">Ditolak</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            <h5 class="card-title mb-0 text-primary fw-bold"><i class="fas fa-list me-2"></i>Daftar Pengajuan Pensiun</h5>
                    ...
                    <tbody>
                        @forelse($pengajuan as $item)
                            <tr>
                                ...
                                {{-- 3. Jabatan & TMT Pensiun (Disesuaikan untuk Pensiun) --}}
                                <td>
                                    <div class="small fw-bold">{{ $item->pegawai->jabatan }}</div>
                                    <small class="text-muted">
                                        {{-- Mengambil TMT Pensiun dari JSON jika ada --}}
                                        TMT Pensiun: {{ $item->data_tambahan['tmt_pensiun'] ?? '-' }}
                                    </small>
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center py-5 text-muted">
                                    ...
                                    <p>Belum ada data pengajuan pensiun.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
    ...
    <div class="modal fade" id="rejectModalPage" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.pensiun.bup.reject') }}" method="POST" id="formTolak">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="kategori" required>
                                ...
                                <option value="batas_usia_belum_memenuhi">Belum Memasuki BUP</option>
    ...
    <div class="modal fade" id="postponeModalPage" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                {{-- PERHATIKAN ACTION ROUTE INI --}}
                <form action="{{ route('admin.pensiun.bup.postpone') }}" method="POST" id="formTunda">
                    @csrf
    ...
    {{-- FORM HIDDEN APPROVE --}}
    <form id="formApproveHidden" action="{{ route('admin.pensiun.bup.approve') }}" method="POST"
        style="display: none;">
        @csrf
...
@push('scripts')
    <script>
        ...
        // --- 4. Preview Logic (SAMA PERSIS DENGAN SEBELUMNYA) ---
