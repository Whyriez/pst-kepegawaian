...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="h4 fw-bold text-primary mb-1">Pensiun Atas Permintaan Sendiri</h2>
            <p class="text-muted mb-0">Kelola pengajuan berhenti bekerja atas permintaan pegawai sendiri</p>
        </div>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
                <li><a class="dropdown-item" href="{{ route('admin.pensiun.aps') }}">Semua</a></li>
                <li><a class="dropdown-item" href="{{ route('admin.pensiun.aps', ['status' => 'pending']) }}">Menunggu
                        Verifikasi</a></li>
                <li><a class="dropdown-item"
                        href="{{ route('admin.pensiun.aps', ['status' => 'disetujui']) }}">Disetujui</a></li>
                <li><a class="dropdown-item" href="{{ route('admin.pensiun.aps', ['status' => 'ditunda']) }}">Ditunda</a>
                </li>
                <li><a class="dropdown-item" href="{{ route('admin.pensiun.aps', ['status' => 'ditolak']) }}">Ditolak</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            <h5 class="card-title mb-0 text-primary fw-bold"><i class="fas fa-user-minus me-2"></i>Daftar APS</h5>
                ...
                <table class="table table-hover align-middle mb-0">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th class="py-3">Jabatan & Alasan</th>
                    ...
                    <tbody>
                        @forelse($pengajuan as $item)
                            <tr>
                                ...
                                {{-- 3. Jabatan & Alasan (Khusus APS) --}}
                                <td>
                                    <div class="small fw-bold">{{ $item->pegawai->jabatan }}</div>
                                    <small class="text-muted d-block text-truncate" style="max-width: 200px;" 
                                           title="{{ $item->data_tambahan['alasan_pensiun'] ?? '-' }}">
                                        Alasan: {{ $item->data_tambahan['alasan_pensiun'] ?? 'Tidak disebutkan' }}
                                    </small>
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center py-5 text-muted">
                                    ...
                                    <p>Belum ada data pengajuan APS.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
    ...
    <div class="modal fade" id="rejectModalPage" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                {{-- Route Action Khusus APS --}}
                <form action="{{ route('admin.pensiun.aps.reject') }}" method="POST" id="formTolak">
                    @csrf
                    <div class="modal-header bg-danger text-white">
                        <h5 class="modal-title"><i class="fas fa-times-circle me-2"></i>Tolak Pengajuan APS</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="kategori" required>
                                ...
                                <option value="masa_kerja_kurang">Masa Kerja Belum Mencukupi (Min 20 Thn)</option>
                                <option value="ikatan_dinas">Masih Ada Ikatan Dinas</option>
                                <option value="sedang_tugas_belajar">Sedang Tugas Belajar</option>
                                <option value="sedang_kasus_hukum">Sedang Dalam Proses Hukum</option>
    ...
    <div class="modal fade" id="postponeModalPage" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                {{-- Route Action Khusus APS --}}
                <form action="{{ route('admin.pensiun.aps.postpone') }}" method="POST" id="formTunda">
                    @csrf
                    <div class="modal-header bg-warning text-dark">
                        <h5 class="modal-title"><i class="fas fa-pause-circle me-2"></i>Tunda Pengajuan APS</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="alasan" rows="3" required
                                placeholder="Contoh: Menunggu persetujuan Pimpinan Instansi..."></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Batal</button>
    ...
    {{-- HIDDEN FORM APPROVE --}}
    <form id="formApproveHidden" action="{{ route('admin.pensiun.aps.approve') }}" method="POST"
        style="display: none;">
        @csrf
