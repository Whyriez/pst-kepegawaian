...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="h4 fw-bold text-primary mb-1">Pensiun Meninggal Dunia</h2>
            <p class="text-muted mb-0">Kelola administrasi pemberhentian karena meninggal dunia</p>
        </div>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
                <li><a class="dropdown-item" href="{{ route('admin.pensiun.meninggal') }}">Semua</a></li>
                <li><a class="dropdown-item"
                        href="{{ route('admin.pensiun.meninggal', ['status' => 'pending']) }}">Menunggu Verifikasi</a></li>
                <li><a class="dropdown-item"
                        href="{{ route('admin.pensiun.meninggal', ['status' => 'disetujui']) }}">Disetujui</a></li>
                <li><a class="dropdown-item"
                        href="{{ route('admin.pensiun.meninggal', ['status' => 'ditunda']) }}">Ditunda</a></li>
                <li><a class="dropdown-item"
                        href="{{ route('admin.pensiun.meninggal', ['status' => 'ditolak']) }}">Ditolak</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            <h5 class="card-title mb-0 text-primary fw-bold"><i class="fas fa-user-times me-2"></i>Daftar Pengajuan</h5>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    <thead class="bg-light">
                        <tr>
                            <th class="ps-4 py-3">Tanggal Ajuan</th>
                            <th class="py-3">Pegawai (Alm/Almh)</th>
                            <th class="py-3">Info Kematian</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        {{-- Avatar grayscale untuk indikasi meninggal --}}
                                        <img src="https://ui-avatars.com/api/?name={{ urlencode($item->pegawai->nama_lengkap) }}&background=random"
                                            class="rounded-circle me-2 grayscale" width="32" height="32"
                                ...
                                {{-- 3. Info Kematian (Ambil dari JSON) --}}
                                <td>
                                    <div class="small fw-bold">
                                        Tgl Meninggal: {{ $item->data_tambahan['tanggal_meninggal'] ?? '-' }}
                                    </div>
                                    <small class="text-muted">
                                        Penyebab: {{ $item->data_tambahan['penyebab_kematian'] ?? 'Sakit/Lainnya' }}
                                    </small>
                                </td>
    ...
    <div class="modal fade" id="rejectModalPage" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                {{-- Route Khusus Meninggal --}}
                <form action="{{ route('admin.pensiun.meninggal.reject') }}" method="POST" id="formTolak">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="kategori" required>
                                ...
                                <option value="akte_kematian_invalid">Akte/Surat Kematian Tidak Valid</option>
                                <option value="tanggal_meninggal_salah">Tanggal Meninggal Tidak Sesuai</option>
    ...
    <div class="modal fade" id="postponeModalPage" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                {{-- Route Khusus Meninggal --}}
                <form action="{{ route('admin.pensiun.meninggal.postpone') }}" method="POST" id="formTunda">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="alasan" rows="3" required
                                placeholder="Contoh: Menunggu legalisir surat kematian..."></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Batal</button>
    ...
    {{-- HIDDEN FORM APPROVE --}}
    <form id="formApproveHidden" action="{{ route('admin.pensiun.meninggal.approve') }}" method="POST"
        style="display: none;">
        @csrf
