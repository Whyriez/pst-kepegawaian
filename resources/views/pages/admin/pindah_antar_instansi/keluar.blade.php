...
@section('title', 'Pindah Instansi - Keluar')

@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="h4 fw-bold text-primary mb-1">Pindah Instansi (Keluar)</h2>
            <p class="text-muted mb-0">Verifikasi permohonan pegawai yang akan pindah ke instansi lain</p>
        </div>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
                <li><a class="dropdown-item" href="{{ route('admin.pindah.keluar') }}">Semua</a></li>
                <li><a class="dropdown-item" href="{{ route('admin.pindah.keluar', ['status' => 'pending']) }}">Menunggu
                        Verifikasi</a></li>
                <li><a class="dropdown-item"
                        href="{{ route('admin.pindah.keluar', ['status' => 'disetujui']) }}">Disetujui</a></li>
                <li><a class="dropdown-item" href="{{ route('admin.pindah.keluar', ['status' => 'ditunda']) }}">Ditunda</a>
                </li>
                <li><a class="dropdown-item" href="{{ route('admin.pindah.keluar', ['status' => 'ditolak']) }}">Ditolak</a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        <h6 class="text-muted small mb-1">Total Keluar</h6>
                ...
                <table class="table table-hover align-middle mb-0">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th class="py-3">Jabatan Sekarang</th>
                            <th class="py-3">Tujuan Pindah</th>
                    ...
                    <tbody>
                        @forelse($pengajuan as $item)
                            <tr>
                                ...
                                <td>
                                    <div class="small fw-bold">{{ $item->data_tambahan['unit_kerja'] ?? '-' }}</div>
                                    <small class="text-muted">{{ $item->data_tambahan['jabatan'] ?? '-' }}</small>
                                </td>
                                <td>
                                    {{-- Mengambil data instansi tujuan dari JSON --}}
                                    <div class="small fw-bold text-danger">
                                        <i class="fas fa-map-marker-alt me-1"></i>
                                        {{ $item->data_tambahan['instansi_tujuan'] ?? '-' }}
                                    </div>
                                    <small class="text-muted">
                                        {{ $item->data_tambahan['jabatan_tujuan'] ?? 'Jabatan tidak spesifik' }}
                                    </small>
                                </td>
                                <td>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center py-5 text-muted">
                                    ...
                                    <p>Belum ada pengajuan pindah keluar.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
    ...
    <div class="modal fade" id="rejectModalPage" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('admin.pindah.keluar.reject') }}" method="POST" id="formTolak">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="kategori" required>
                                ...
                                <option value="tenaga_masih_dibutuhkan">Tenaga Masih Dibutuhkan</option>
                                <option value="belum_ada_pengganti">Belum Ada Pengganti</option>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="alasan" rows="4" required placeholder="Jelaskan pertimbangan instansi..."></textarea>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="postponeModalPage" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('admin.pindah.keluar.postpone') }}" method="POST" id="formTunda">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="alasan" rows="3" required placeholder="Menunggu keputusan pimpinan..."></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Batal</button>
    ...
    {{-- HIDDEN APPROVE --}}
    <form id="formApproveHidden" action="{{ route('admin.pindah.keluar.approve') }}" method="POST"
        style="display: none;">
        @csrf
...
@push('scripts')
    {{-- Scripts JS standar untuk Preview & Modal --}}
    <script>
        function confirmApprove(id) {
            Swal.fire({
                title: 'Setujui Pindah Keluar?',
