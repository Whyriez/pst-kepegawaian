...
@section('title', 'Pindah Instansi - Masuk')

@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="h4 fw-bold text-primary mb-1">Pindah Instansi (Masuk)</h2>
            <p class="text-muted mb-0">Verifikasi berkas pegawai yang mengajukan pindah ke instansi ini</p>
        </div>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
                <li><a class="dropdown-item" href="{{ route('admin.pindah.masuk') }}">Semua</a></li>
                <li><a class="dropdown-item" href="{{ route('admin.pindah.masuk', ['status' => 'pending']) }}">Menunggu
                        Verifikasi</a></li>
                <li><a class="dropdown-item"
                        href="{{ route('admin.pindah.masuk', ['status' => 'disetujui']) }}">Disetujui</a></li>
                <li><a class="dropdown-item" href="{{ route('admin.pindah.masuk', ['status' => 'ditunda']) }}">Ditunda</a>
                </li>
                <li><a class="dropdown-item" href="{{ route('admin.pindah.masuk', ['status' => 'ditolak']) }}">Ditolak</a>
                </li>
            </ul>
        </div>
    </div>
                ...
                <table class="table table-hover align-middle mb-0">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th class="py-3">Asal Instansi/Jabatan</th>
                            <th class="py-3">Usulan Tujuan</th>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center py-5 text-muted">
                                    ...
                                    <p>Belum ada pengajuan pindah masuk.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
    ...
    <div class="modal fade" id="rejectModalPage" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('admin.pindah.masuk.reject') }}" method="POST" id="formTolak">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="kategori" required>
                                ...
                                <option value="formasi_penuh">Formasi Jabatan Penuh</option>
                                <option value="kualifikasi_tidak_sesuai">Kualifikasi Pendidikan Tidak Sesuai</option>
                                <option value="dokumen_tidak_lengkap">Dokumen Tidak Lengkap</option>
                                <option value="persetujuan_asal_ditolak">Instansi Asal Tidak Menyetujui</option>
                                <option value="lainnya">Lainnya</option>
                            </select>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-bold">Detail Alasan</label>
                            <textarea class="form-control" name="alasan" rows="4" required placeholder="Jelaskan lebih lanjut..."></textarea>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="postponeModalPage" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('admin.pindah.masuk.postpone') }}" method="POST" id="formTunda">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="alasan" rows="3" required placeholder="Menunggu konfirmasi BKN..."></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Batal</button>
    ...
    {{-- HIDDEN APPROVE --}}
    <form id="formApproveHidden" action="{{ route('admin.pindah.masuk.approve') }}" method="POST"
        style="display: none;">
        @csrf
...
@push('scripts')
    {{-- Scripts JS sama seperti modul sebelumnya (Preview, Modal Handler) --}}
    <script>
        function confirmApprove(id) {
            Swal.fire({
                title: 'Setujui Pindah Masuk?',
        ...
        // Fungsi loadPreview sama seperti di controller sebelumnya
