        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Formulir untuk pengajuan pindah masuk ke instansi</p>
                </div>
                ...
                <form id="form-pindah-masuk" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-step active" id="step-1-pindah-masuk">
                        ...
                        <div class="step-header mb-4 mt-4">
                            ...
                            <p class="text-muted">Isi usulan jabatan dan unit kerja baru</p>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>Jabatan:</strong> <span id="review-jabatan-pindah-masuk">-</span></p>
                                        <p><strong>Unit Kerja:</strong> <span id="review-unit-kerja-pindah-masuk">-</span></p>
                                    </div>
                                    <div class="col-md-6">
