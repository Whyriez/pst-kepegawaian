...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="h4 fw-bold text-primary mb-1">Pencantuman Gelar Akademik</h2>
            <p class="text-muted mb-0">Verifikasi usulan pencantuman gelar pendidikan (S1/S2/S3)</p>
        </div>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
                <li><a class="dropdown-item" href="{{ route('admin.gelar.akademik') }}">Semua</a></li>
                <li><a class="dropdown-item" href="{{ route('admin.gelar.akademik', ['status' => 'pending']) }}">Menunggu
                        Verifikasi</a></li>
                <li><a class="dropdown-item"
                        href="{{ route('admin.gelar.akademik', ['status' => 'disetujui']) }}">Disetujui</a></li>
                <li><a class="dropdown-item" href="{{ route('admin.gelar.akademik', ['status' => 'ditunda']) }}">Ditunda</a>
                </li>
                <li><a class="dropdown-item" href="{{ route('admin.gelar.akademik', ['status' => 'ditolak']) }}">Ditolak</a>
                </li>
            </ul>
        </div>
    </div>
                ...
                <table class="table table-hover align-middle mb-0">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th class="py-3">Usulan Pendidikan</th>
                    ...
                    <tbody>
                        @forelse($pengajuan as $item)
                            <tr>
                                ...
                                <td>
                                    {{-- Menampilkan jenjang pendidikan yang diusulkan --}}
                                    <div class="small fw-bold text-primary">
                                        {{ $item->data_tambahan['jenjang_pendidikan'] ?? '-' }}
                                    </div>
                                </td>
                                <td>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center py-5 text-muted">
                                    ...
                                    <p>Belum ada pengajuan pencantuman gelar.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
    ...
    <div class="modal fade" id="rejectModalPage" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('admin.gelar.akademik.reject') }}" method="POST" id="formTolak">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="kategori" required>
                                ...
                                <option value="izin_belajar_tidak_ada">Tidak Ada Izin Belajar/Tugas Belajar</option>
                                <option value="akreditasi_prodi_kurang">Akreditasi Prodi Tidak Memenuhi</option>
                                <option value="pendidikan_tidak_linier">Pendidikan Tidak Linier dengan Tugas</option>
    ...
    <div class="modal fade" id="postponeModalPage" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('admin.gelar.akademik.postpone') }}" method="POST" id="formTunda">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="alasan" rows="3" required
                                placeholder="Menunggu validasi Forlap Dikti..."></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Batal</button>
    ...
    {{-- HIDDEN APPROVE --}}
    <form id="formApproveHidden" action="{{ route('admin.gelar.akademik.approve') }}" method="POST"
        style="display: none;">
        @csrf
