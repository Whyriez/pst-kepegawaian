...
@section('content')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                ...
                <form id="form-pensiun-meninggal" action="{{ route('pensiun.meninggal.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-step" id="step-2-meninggal">
                                ...
                                <div>
                                    ...
                                    <div class="mt-2">
                                        <small class="text-muted">
                                            ...
                                            <span id="upload-progress-meninggal">0/{{ count($syarat) }}</span> dokumen terunggah
                                        </small>
                                    </div>
                                </div>
                            </div>
                        ...
                        {{-- LOOPING DOKUMEN (MENGGUNAKAN CARD) --}}
                        <div class="row">
                            ...
                            @empty
                                <div class="col-12">
                                    <div class="alert alert-warning">
                                        Belum ada syarat dokumen yang diatur di database untuk layanan ini (pensiun-meninggal).
                                    </div>
                                </div>
                            @endforelse
                        </div>
    ...
    <style>
        /* COPY PASTE STYLE DARI FILE ASLI */
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.btn-next-meninggal').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    // Validasi Step 1
                    if(next == 2 && !document.getElementById('nama_pegawai_meninggal').value) {
