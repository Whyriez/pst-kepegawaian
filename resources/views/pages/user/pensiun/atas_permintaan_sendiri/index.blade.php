...
@section('title', 'Riwayat Pensiun APS')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Pensiun Atas Permintaan Sendiri (APS)</h2>
                    <p class="text-muted mb-0">Kelola riwayat pengajuan pensiun APS Anda.</p>
                </div>
                <a href="{{ route('pensiun.aps.create') }}" class="btn btn-primary shadow-sm">
                    <i class="fas fa-plus-circle me-2"></i>Ajukan Pensiun APS
                </a>
            </div>
        </div>
                                            ...
                                            @if(in_array($item->status, ['pending', 'perbaikan']))
                                                ...
                                                <li>
                                                    <a class="dropdown-item fw-bold text-warning"
                                                       href="{{ route('pensiun.aps.edit', ['id' => $item->id]) }}">
                            ...
                            <tr>
                                <td colspan="6" class="text-center py-5">
                                    <div class="py-4">
                                        ...
                                        <a href="{{ route('pensiun.aps.create') }}" class="btn btn-sm btn-primary mt-2">
                                            Ajukan Sekarang
                                        </a>
                                    </div>
                                </td>
