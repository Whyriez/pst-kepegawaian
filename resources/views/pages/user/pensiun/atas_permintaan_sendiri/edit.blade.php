...
@section('title', 'Edit Pensiun APS')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Edit Pengajuan Pensiun APS</h2>
                    <p class="text-muted mb-0">Perbaiki data atau dokumen pengajuan pensiun Anda.</p>
                </div>
                <a href="{{ route('pensiun.aps') }}" class="btn btn-secondary">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                {{-- ACTION FORM UPDATE --}}
                <form id="form-pensiun-aps"
                      action="{{ route('pensiun.aps.update', $pengajuan->id) }}"
                      method="POST"
                    ...
                    <div class="form-step active" id="step-1-aps">
                        <div class="step-header mb-4">
                            ...
                            <p class="text-muted">Pastikan data sesuai dengan kondisi terkini.</p>
                        </div>

                        {{-- Hidden Data --}}
                        <input type="hidden" name="nip_display_aps" value="{{ $pengajuan->pegawai->nip }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="jabatan_aps" name="jabatan_aps"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="pangkat_aps" name="pangkat_aps"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="satuan_kerja_aps" name="satuan_kerja_aps"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="golongan_aps" name="golongan_aps"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" class="form-control"
                                           id="tmt_pensiun_aps" name="tmt_pensiun_aps"
                        ...
                        <div class="d-flex justify-content-end mt-5">
                            <button type="button" class="btn btn-primary btn-next-aps" data-next="2">
                    ...
                    <div class="form-step" id="step-3-aps">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>NIP:</strong> <span id="review-nip-aps">{{ $pengajuan->pegawai->nip }}</span></p>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>Pangkat/Gol:</strong> <span id="review-pangkat-aps">-</span> / <span id="review-golongan-aps">-</span></p>
                        ...
                        <div class="card border-0 bg-light mb-4">
                            <div class="card-body">
                                ...
                                <div id="review-documents-aps" class="small"></div>
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.btn-next-aps').forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    if (next === 3) {
                        ...
                        if (document.querySelectorAll('#step-2-aps input.is-invalid').length > 0) {
                        ...
                        let valid = true;
                        document.querySelectorAll('#step-2-aps input[type="file"][required]').forEach(input => {
                            if (input.files.length === 0) {
                                input.classList.add('is-invalid');
                                valid = false;
                            }
            ...
            function updateReview() {
                ...
                document.getElementById('review-nip-aps').textContent = document.getElementById('nip_view').value;
                document.getElementById('review-jabatan-aps').textContent = get('jabatan_aps');
                document.getElementById('review-pangkat-aps').textContent = get('pangkat_aps');
                document.getElementById('review-satuan-kerja-aps').textContent = get('satuan_kerja_aps');
                document.getElementById('review-golongan-aps').textContent = get('golongan_aps');

                // Format Tanggal TMT
                const tmt = get('tmt_pensiun_aps');
                document.getElementById('review-tmt-aps').textContent = tmt !== '-' ? new Date(tmt).toLocaleDateString('id-ID', {
                    day: 'numeric', month: 'long', year: 'numeric'
                }) : '-';

                // Render List Dokumen
                const container = document.getElementById('review-documents-aps');
                container.innerHTML = '';
