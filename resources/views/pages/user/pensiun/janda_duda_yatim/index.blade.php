...
@section('title', 'Riwayat Pensiun Janda/Duda/Yatim')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Pensiun Janda/Duda/Yatim</h2>
                    <p class="text-muted mb-0">Kelola pengajuan pensiun Janda/Duda/Yatim Anda.</p>
                </div>
                <a href="{{ route('pensiun.janda_duda_yatim.create') }}" class="btn btn-primary shadow-sm">
                    <i class="fas fa-plus-circle me-2"></i>Ajukan Pensiun
                </a>
            </div>
        </div>
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tr>
                            <th class="py-3 px-3">Golongan</th>
                            <th class="py-3">Jabatan</th>
                            <th class="py-3">TMT Pensiun</th>
                            ...
                            <tr>
                                <td class="px-3">
                                    <span class="badge bg-light text-dark border">
                                        {{ $item->data_tambahan['golongan'] ?? '-' }}
                                    </span>
                                </td>
                                <td>{{ $item->data_tambahan['jabatan'] ?? '-' }}</td>
                                <td>
                                    <span class="text-danger fw-bold">
                                        {{ isset($item->data_tambahan['tmt_pensiun']) ? \Carbon\Carbon::parse($item->data_tambahan['tmt_pensiun'])->format('d M Y') : '-' }}
                                    </span>
                                </td>
                                <td>
                                    <div class="text-muted small">{{ $item->tanggal_pengajuan->format('d M Y') }}</div>
                                </td>
                                <td>
                                            ...
                                            @if(in_array($item->status, ['pending', 'perbaikan']))
                                                ...
                                                <li>
                                                    <a class="dropdown-item fw-bold text-warning"
                                                       href="{{ route('pensiun.janda_duda_yatim.edit', ['id' => $item->id]) }}">
                            ...
                            <tr>
                                <td colspan="6" class="text-center py-5">
                                    <div class="py-4">
                                        ...
                                        <a href="{{ route('pensiun.janda_duda_yatim.create') }}" class="btn btn-sm btn-primary mt-2">
                                            Ajukan Sekarang
                                        </a>
                                    </div>
                                </td>
                ...
                html: `
                    <div class="text-start">
                        <table class="table table-sm table-borderless">
                            <tr><td width="35%"><strong>Layanan</strong></td><td>: Pensiun JDY</td></tr>
