                ...
                <form id="form-pensiun-jdy" action="{{ route('pensiun.janda_duda_yatim.store') }}" method="POST"
                    ...
                    <div class="form-step active" id="step-1-jdy">
                        <div class="step-header mb-4">
                            ...
                            <p class="text-muted">Isi data diri pegawai (Almarhum/Pensiunan) yang terkait</p>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_pegawai_jdy" class="form-label">Nama Pegawai <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-user"></i></span>
                                    <input type="text" class="form-control" id="nama_pegawai_jdy"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="jabatan_jdy" class="form-label">Jabatan Pegawai <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-briefcase"></i></span>
                                    <input type="text" class="form-control" id="jabatan_jdy" name="jabatan_jdy"
                                           required>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="pangkat_jdy" class="form-label">Pangkat Pegawai <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-star"></i></span>
                                    <input type="text" class="form-control" id="pangkat_jdy" name="pangkat_jdy"
                                           required>
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="nip_display_jdy" class="form-label">NIP Pegawai <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-id-card"></i></span>
                                    <input type="text" class="form-control bg-light" id="nip_display_jdy"
                                           name="nip_display_jdy" required readonly>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="satuan_kerja_jdy" class="form-label">Satuan Kerja <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-building"></i></span>
                                    <input type="text" class="form-control" id="satuan_kerja_jdy"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="golongan_jdy" class="form-label">Golongan/Ruang <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-layer-group"></i></span>
                                    <input type="text" class="form-control" id="golongan_jdy" name="golongan_jdy"
                                           required>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="tmt_pensiun_jdy" class="form-label">TMT Pensiun <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-calendar-alt"></i></span>
                                    <input type="date" class="form-control" id="tmt_pensiun_jdy" name="tmt_pensiun_jdy"
                                           required>
                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function validateStep(currentStep) {
                ...
                // VALIDASI STEP 1: Data Diri & NIP
                if (currentStep == 1) {
                    const nama = document.getElementById('nama_pegawai_jdy').value.trim();
                    const jabatan = document.getElementById('jabatan_jdy').value.trim();
