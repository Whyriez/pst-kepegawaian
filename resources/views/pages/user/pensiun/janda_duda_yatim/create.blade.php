...
@section('content')
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Formulir untuk pengajuan pensiun bagi janda/duda/yatim</p>
                </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                {{-- FORM ACTION --}}
                <form id="form-pensiun-jdy" action="{{ route('pensiun.janda_duda_yatim.store') }}" method="POST"
                    ...
                    <div class="form-step active" id="step-1-jdy">
                        <div class="step-header mb-4">
                            ...
                            <p class="text-muted">Data diri pegawai (Almarhum/Pensiunan) diambil otomatis dari sistem.</p>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_pegawai_jdy" class="form-label">Nama Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-user"></i></span>
                                    <input type="text" class="form-control bg-light" id="nama_pegawai_jdy"
                                           name="nama_pegawai_jdy"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="nip_display_jdy" class="form-label">NIP Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-id-card"></i></span>
                                    <input type="text" class="form-control bg-light" id="nip_display_jdy"
                                           name="nip_display_jdy"
                                           value="{{ $pegawai->nip ?? '-' }}"
                                           readonly>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="jabatan_jdy" class="form-label">Jabatan</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-briefcase"></i></span>
                                    <input type="text" class="form-control bg-light" id="jabatan_jdy"
                                           name="jabatan_jdy"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="pangkat_jdy" class="form-label">Pangkat</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-star"></i></span>
                                    <input type="text" class="form-control bg-light" id="pangkat_jdy"
                                           name="pangkat_jdy"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="satuan_kerja_jdy" class="form-label">Satuan Kerja</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-building"></i></span>
                                    <input type="text" class="form-control bg-light" id="satuan_kerja_jdy"
                                           name="satuan_kerja_jdy"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="golongan_jdy" class="form-label">Golongan/Ruang</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-layer-group"></i></span>
                                    <input type="text" class="form-control bg-light" id="golongan_jdy"
                                           name="golongan_jdy"
                        ...
                        <div class="step-header mb-4 mt-4 border-top pt-4">
                            <h5 class="fw-bold text-primary mb-2">
                                <i class="fas fa-calendar-check me-2"></i>Detail Pensiun
                            </h5>
                            <p class="text-muted">Lengkapi data tanggal mulai pensiun.</p>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" class="form-control" id="tmt_pensiun_jdy"
                                           name="tmt_pensiun_jdy" required>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-2">
                                        <small class="text-muted">
                                            ...
                                            <span id="upload-progress-jdy">0/{{ count($syarat) }}</span> dokumen
                                            terunggah
                                        </small>
                                    </div>
                                </div>
                            ...
                            @empty
                                <div class="col-12">
                                    <div class="alert alert-warning">
                                        Belum ada syarat dokumen yang diatur di database untuk layanan ini (pensiun-janda_duda_yatim).
                                    </div>
                                </div>
                            @endforelse
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>Pangkat/Gol:</strong> <span id="review-pangkat-jdy">-</span> / <span
                                                id="review-golongan-jdy">-</span></p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function validateStep(currentStep) {
                ...
                // VALIDASI STEP 1: Data Diri (Readonly) & TMT (Wajib)
                if (currentStep == 1) {
                    const nip = document.getElementById('nip_display_jdy').value.trim();
                    const tmt = document.getElementById('tmt_pensiun_jdy').value.trim();
                    ...
                    if (!nip || nip === '-') {
                        ...
                        isValid = false;
                        errorMsg = 'Harap pilih TMT Pensiun!';
                    }
                }

                // VALIDASI STEP 2: Dokumen Required
                if (currentStep == 2) {
                    const requiredInputs = document.querySelectorAll('#step-2-jdy input[type="file"][required]');
                    let emptyCount = 0;
            ...
            function updateUploadProgress() {
                const allFileInputs = document.querySelectorAll('#step-2-jdy input[type="file"]');
                let filledCount = 0;
            ...
            const tmtInput = document.getElementById('tmt_pensiun_jdy');
