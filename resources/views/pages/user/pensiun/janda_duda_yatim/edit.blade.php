                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>NIP:</strong> <span id="review-nip-jdy">{{ $pengajuan->pegawai->nip }}</span></p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.btn-next-jdy').forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    if (next === 3) {
                        ...
                        const reqInputs = document.querySelectorAll('#step-2-jdy input[type="file"][required]');
            ...
            function updateReview() {
                ...
                document.getElementById('review-tmt-jdy').textContent = get('tmt_pensiun_jdy');
