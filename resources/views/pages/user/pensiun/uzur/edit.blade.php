...
@section('title', 'Edit Pensiun Uzur')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Edit Pengajuan Pensiun Uzur</h2>
                    <p class="text-muted mb-0">Perbaiki data atau dokumen pengajuan pensiun karena sakit.</p>
                </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                {{-- ACTION FORM UPDATE --}}
                <form id="form-pensiun-uzur"
                      action="{{ route('pensiun.uzur.update', $pengajuan->id) }}"
                      method="POST"
                    ...
                    <div class="form-step active" id="step-1-uzur">
                        ...
                        {{-- Hidden NIP Display --}}
                        <input type="hidden" name="nip_display_uzur" value="{{ $pengajuan->pegawai->nip }}">

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Nama Pegawai</label>
                                <input type="text" class="form-control bg-light"
                                       id="nama_pegawai_uzur"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="jabatan_uzur" name="jabatan_uzur"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="satuan_kerja_uzur" name="satuan_kerja_uzur"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="pangkat_uzur" name="pangkat_uzur"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="golongan_uzur" name="golongan_uzur"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>NIP:</strong> <span
                                                id="review-nip-uzur">{{ $pengajuan->pegawai->nip }}</span></p>
                                        <p><strong>Jabatan:</strong> <span id="review-jabatan-uzur">-</span></p>
                                    </div>
                                    <div class="col-md-6">
                                        <p><strong>Satuan Kerja:</strong> <span id="review-satuan-kerja-uzur">-</span>
                                        </p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.btn-next-uzur').forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    if (next === 3) {
                        ...
                        if (document.querySelectorAll('#step-2-uzur input.is-invalid').length > 0) {
                        ...
                        let valid = true;
                        document.querySelectorAll('#step-2-uzur input[type="file"][required]').forEach(input => {
                            if (input.files.length === 0) {
                                input.classList.add('is-invalid');
                                valid = false;
                            }
            ...
            function updateReview() {
                ...
                document.getElementById('review-nip-uzur').textContent = document.getElementById('nip_view').value;
                document.getElementById('review-jabatan-uzur').textContent = get('jabatan_uzur');
                document.getElementById('review-pangkat-uzur').textContent = get('pangkat_uzur');
                document.getElementById('review-satuan-kerja-uzur').textContent = get('satuan_kerja_uzur');
                document.getElementById('review-golongan-uzur').textContent = get('golongan_uzur');

                // Render List Dokumen
                const container = document.getElementById('review-documents-uzur');
                container.innerHTML = '';
