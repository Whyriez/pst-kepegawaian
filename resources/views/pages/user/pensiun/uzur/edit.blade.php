                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>NIP:</strong> <span id="review-nip-uzur">{{ $pengajuan->pegawai->nip }}</span></p>
            ...
            document.querySelectorAll('.btn-next-uzur').forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    if (next === 3) {
                        ...
                        const reqInputs = document.querySelectorAll('#step-2-uzur input[type="file"][required]');
