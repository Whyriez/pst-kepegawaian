    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('pensiun.uzur') }}" class="btn btn-secondary">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                {{-- ACTION FORM --}}
                <form id="form-pensiun-uzur" action="{{ route('pensiun.uzur.store') }}" method="POST"
                    ...
                    <div class="form-step active" id="step-1-uzur">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_pegawai_uzur" class="form-label">Nama Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-user"></i></span>
                                    <input type="text" class="form-control bg-light" id="nama_pegawai_uzur"
                                           name="nama_pegawai_uzur"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="nip_display_uzur" class="form-label">NIP Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-id-card"></i></span>
                                    <input type="text" class="form-control bg-light" id="nip_display_uzur"
                                           name="nip_display_uzur"
                                           value="{{ $pegawai->nip ?? '-' }}"
                                           readonly>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="jabatan_uzur" class="form-label">Jabatan</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-briefcase"></i></span>
                                    <input type="text" class="form-control bg-light" id="jabatan_uzur"
                                           name="jabatan_uzur"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="satuan_kerja_uzur" class="form-label">Satuan Kerja</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-building"></i></span>
                                    <input type="text" class="form-control bg-light" id="satuan_kerja_uzur"
                                           name="satuan_kerja_uzur"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="pangkat_uzur" class="form-label">Pangkat</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-star"></i></span>
                                    <input type="text" class="form-control bg-light" id="pangkat_uzur"
                                           name="pangkat_uzur"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="golongan_uzur" class="form-label">Golongan/Ruang</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-layer-group"></i></span>
                                    <input type="text" class="form-control bg-light" id="golongan_uzur"
                                           name="golongan_uzur"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="tmt_pensiun_uzur" class="form-label">TMT Pensiun <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-calendar-alt"></i></span>
                                    <input type="date" class="form-control" id="tmt_pensiun_uzur"
                                           name="tmt_pensiun_uzur" required>
                                </div>
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            <div></div>
                            <button type="button" class="btn btn-primary btn-next-uzur" data-next="2">
                                ...
                                <div>
                                    ...
                                    <div class="mt-2">
                                        <small class="text-muted">
                                            ...
                                            <span id="upload-progress-uzur">0/{{ count($syarat) }}</span> dokumen
                                            terunggah
                                        </small>
                                    </div>
                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function validateStep(currentStep) {
                ...
                if (currentStep == 1) {
                    const nip = document.getElementById('nip_display_uzur').value.trim();
                    const tmt = document.getElementById('tmt_pensiun_uzur').value.trim();
                ...
                if (currentStep == 2) {
                    const requiredInputs = document.querySelectorAll('#step-2-uzur input[type="file"][required]');
                    let emptyCount = 0;
            ...
            function updateUploadProgress() {
                const allFileInputs = document.querySelectorAll('#step-2-uzur input[type="file"]');
                let filledCount = 0;
