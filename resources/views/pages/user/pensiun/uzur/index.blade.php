...
@section('title', 'Riwayat Pensiun Uzur')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Pensiun Uzur (Sakit)</h2>
                    <p class="text-muted mb-0">Kelola riwayat pengajuan pensiun karena uzur/sakit.</p>
                </div>
                <a href="{{ route('pensiun.uzur.create') }}" class="btn btn-primary shadow-sm">
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        @forelse($pengajuans as $item)
                            <tr>
                                ...
                                {{-- 3. TMT Pensiun --}}
                                <td>
                                    {{-- Cek apakah ada data TMT, jika tidak ada tampilkan strip (-) --}}
                                            ...
                                            @if(in_array($item->status, ['pending', 'perbaikan']))
                                                ...
                                                <li>
                                                    <a class="dropdown-item fw-bold text-warning"
                                                       href="{{ route('pensiun.uzur.edit', ['id' => $item->id]) }}">
                            ...
                            <tr>
                                <td colspan="6" class="text-center py-5">
                                    <div class="py-4">
                                        ...
                                        <a href="{{ route('pensiun.uzur.create') }}" class="btn btn-sm btn-primary mt-2">
                                            Ajukan Sekarang
                                        </a>
                                    </div>
                                </td>
            ...
            Swal.fire({
                ...
                html: `
                    <div class="text-start">
                        <p class="mb-2"><strong>Status:</strong> <span class="badge bg-secondary">${status}</span></p>
                        <hr>
