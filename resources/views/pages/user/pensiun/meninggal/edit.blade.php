                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>NIP:</strong> <span id="review-nip-meninggal">{{ $pengajuan->pegawai->nip }}</span></p>
            ...
            document.querySelectorAll('.btn-next-meninggal').forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    if (next === 3) {
                        ...
                        const reqInputs = document.querySelectorAll('#step-2-meninggal input[type="file"][required]');
