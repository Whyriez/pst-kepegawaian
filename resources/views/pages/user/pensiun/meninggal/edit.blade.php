...
@section('title', 'Edit Pensiun Meninggal')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Edit Pengajuan Pensiun Meninggal</h2>
                    <p class="text-muted mb-0">Perbaiki data atau dokumen pengajuan.</p>
                </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                {{-- ACTION FORM UPDATE --}}
                <form id="form-pensiun-meninggal"
                      action="{{ route('pensiun.meninggal.update', $pengajuan->id) }}"
                      method="POST"
                    ...
                    <div class="form-step active" id="step-1-meninggal">
                        <div class="step-header mb-4">
                            ...
                            <p class="text-muted">Pastikan data pegawai yang meninggal dunia sudah benar.</p>
                        </div>

                        {{-- Hidden NIP Display --}}
                        <input type="hidden" name="nip_display_meninggal" value="{{ $pengajuan->pegawai->nip }}">

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Nama Pegawai</label>
                                <input type="text" class="form-control bg-light"
                                       id="nama_pegawai_meninggal"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="jabatan_meninggal" name="jabatan_meninggal"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="satuan_kerja_meninggal" name="satuan_kerja_meninggal"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="pangkat_meninggal" name="pangkat_meninggal"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="golongan_meninggal" name="golongan_meninggal"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.btn-next-meninggal').forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    if (next === 3) {
                        ...
                        if (document.querySelectorAll('#step-2-meninggal input.is-invalid').length > 0) {
                        ...
                        let valid = true;
                        document.querySelectorAll('#step-2-meninggal input[type="file"][required]').forEach(input => {
                            if (input.files.length === 0) {
                                input.classList.add('is-invalid');
                                valid = false;
                            }
            ...
            function updateReview() {
                ...
                document.getElementById('review-nip-meninggal').textContent = document.getElementById('nip_view').value;
                document.getElementById('review-jabatan-meninggal').textContent = get('jabatan_meninggal');
                document.getElementById('review-pangkat-meninggal').textContent = get('pangkat_meninggal');
                document.getElementById('review-satuan-kerja-meninggal').textContent = get('satuan_kerja_meninggal');
                document.getElementById('review-golongan-meninggal').textContent = get('golongan_meninggal');

                // Render List Dokumen
                const container = document.getElementById('review-documents-meninggal');
                container.innerHTML = '';
