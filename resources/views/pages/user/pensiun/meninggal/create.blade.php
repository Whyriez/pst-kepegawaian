                ...
                <form id="form-pensiun-meninggal" action="{{ route('pensiun.meninggal.store') }}" method="POST"
                    ...
                    <div class="form-step active" id="step-1-meninggal">
                        <div class="step-header mb-4">
                            ...
                            <p class="text-muted">Data diri pegawai (Almarhum) diambil otomatis dari sistem.</p>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_pegawai_meninggal" class="form-label">Nama Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-user"></i></span>
                                    <input type="text" class="form-control bg-light" id="nama_pegawai_meninggal"
                                           name="nama_pegawai_meninggal"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="nip_display_meninggal" class="form-label">NIP Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-id-card"></i></span>
                                    <input type="text" class="form-control bg-light" id="nip_display_meninggal"
                                           name="nip_display_meninggal"
                                           value="{{ $pegawai->nip ?? '-' }}"
                                           readonly>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="jabatan_meninggal" class="form-label">Jabatan</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-briefcase"></i></span>
                                    <input type="text" class="form-control bg-light" id="jabatan_meninggal"
                                           name="jabatan_meninggal"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="satuan_kerja_meninggal" class="form-label">Satuan Kerja</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-building"></i></span>
                                    <input type="text" class="form-control bg-light" id="satuan_kerja_meninggal"
                                           name="satuan_kerja_meninggal"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="pangkat_meninggal" class="form-label">Pangkat</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-star"></i></span>
                                    <input type="text" class="form-control bg-light" id="pangkat_meninggal"
                                           name="pangkat_meninggal"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="golongan_meninggal" class="form-label">Golongan/Ruang</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-layer-group"></i></span>
                                    <input type="text" class="form-control bg-light" id="golongan_meninggal"
                                           name="golongan_meninggal"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function validateStep(currentStep) {
                ...
                if (currentStep == 1) {
                    const nip = document.getElementById('nip_display_meninggal').value.trim();
