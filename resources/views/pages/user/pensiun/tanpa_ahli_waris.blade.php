    ...
    <div class="container-fluid p-0">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                ...
                <form id="form-pensiun-taw" action="{{ route('pensiun.taw.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control bg-light" id="nip_display_taw" name="nip_display_taw" required readonly>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="satuan_kerja_taw" name="satuan_kerja_taw" required>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="pangkat_taw" name="pangkat_taw" required>
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="golongan_taw" name="golongan_taw" required>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-2">
                                        <small class="text-muted">
                                            ...
                                            <span id="upload-progress-taw">0/{{ count($syarat) }}</span> dokumen terunggah
                                        </small>
                                    </div>
                                </div>
                            </div>
                            ...
                            @empty
                                <div class="col-12">
                                    <div class="alert alert-warning">
                                        Belum ada syarat dokumen yang diatur di database untuk layanan ini (pensiun-taw).
                                    </div>
                                </div>
                            @endforelse
                        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.btn-next-taw').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    if(next == 2 && !document.getElementById('nama_pegawai_taw').value) {
