                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="nama_pegawai_jdy" name="nama_pegawai_jdy"
                                           required>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="satuan_kerja_jdy" name="satuan_kerja_jdy"
                                           required>
                                </div>
