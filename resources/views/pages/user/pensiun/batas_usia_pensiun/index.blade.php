...
@section('title', 'Riwayat Pensiun BUP')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Pensiun Batas Usia (BUP)</h2>
                    <p class="text-muted mb-0">Kelola pengajuan pensiun batas usia Anda.</p>
                </div>
                <a href="{{ route('pensiun.bup.create') }}" class="btn btn-primary shadow-sm">
                                            ...
                                            @if(in_array($item->status, ['pending', 'perbaikan']))
                                                ...
                                                <li>
                                                    ...
                                                    <a class="dropdown-item fw-bold text-warning"
                                                       href="{{ route('pensiun.bup.edit', ['id' => $item->id]) }}">
                            ...
                            <tr>
                                <td colspan="6" class="text-center py-5">
                                    <div class="py-4">
                                        ...
                                        <h6 class="text-muted fw-bold">Belum ada pengajuan BUP</h6>
                                        <a href="{{ route('pensiun.bup.create') }}" class="btn btn-sm btn-primary mt-2">
                                            Ajukan Sekarang
                                        </a>
                                    </div>
                                </td>
                ...
                html: `
                    <div class="text-start">
                        <table class="table table-sm table-borderless">
                            <tr><td width="30%"><strong>Layanan</strong></td><td>: Pensiun BUP</td></tr>
