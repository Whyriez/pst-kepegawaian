...
@section('title', 'Edit Pensiun BUP')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Edit Pengajuan Pensiun BUP</h2>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                {{-- ACTION FORM --}}
                <form id="form-pensiun-bup"
                      action="{{ route('pensiun.bup.update', $pengajuan->id) }}"
                      method="POST"
                    ...
                    <div class="form-step active" id="step-1-pensiun-bup">
                        ...
                        {{-- Hidden NIP --}}
                        <input type="hidden" name="nip_display_pensiun_bup" value="{{ $pengajuan->pegawai->nip }}">

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Nama Pegawai</label>
                                <input type="text" class="form-control bg-light"
                                       id="nama_pegawai_pensiun_bup"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="satuan_kerja_pensiun_bup" name="satuan_kerja_pensiun_bup"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="golongan_ruang_pensiun_bup" name="golongan_ruang_pensiun_bup"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control"
                                       id="tmt_pensiun_bup" name="tmt_pensiun_bup"
