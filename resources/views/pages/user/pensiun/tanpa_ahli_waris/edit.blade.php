...
@section('title', 'Edit Pensiun TAW')
...
@section('content')
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Edit Pengajuan Pensiun Tanpa Ahli Waris</h2>
                    <p class="text-muted mb-0">Perbaiki data atau dokumen pengajuan pensiun.</p>
                </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                {{-- ACTION FORM UPDATE --}}
                <form id="form-pensiun-taw"
                      action="{{ route('pensiun.taw.update', $pengajuan->id) }}"
                      method="POST"
                    ...
                    <div class="form-step active" id="step-1-taw">
                        <div class="step-header mb-4">
                            ...
                            <p class="text-muted">Pastikan data pegawai sudah benar.</p>
                        </div>

                        {{-- Hidden NIP Display --}}
                        <input type="hidden" name="nip_display_taw" value="{{ $pengajuan->pegawai->nip }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="jabatan_taw" name="jabatan_taw"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="satuan_kerja_taw" name="satuan_kerja_taw"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="pangkat_taw" name="pangkat_taw"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="golongan_taw" name="golongan_taw"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>NIP:</strong> <span
                                                id="review-nip-taw">{{ $pengajuan->pegawai->nip }}</span></p>
                                        <p><strong>Jabatan:</strong> <span id="review-jabatan-taw">-</span></p>
                                    </div>
                                    <div class="col-md-6">
                                        <p><strong>Satuan Kerja:</strong> <span id="review-satuan-kerja-taw">-</span>
                                        </p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.btn-next-taw').forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    if (next === 3) {
                        ...
                        if (document.querySelectorAll('#step-2-taw input.is-invalid').length > 0) {
                        ...
                        let valid = true;
                        document.querySelectorAll('#step-2-taw input[type="file"][required]').forEach(input => {
                            if (input.files.length === 0) {
                                input.classList.add('is-invalid');
                                valid = false;
                            }
            ...
            // Preview File
            document.querySelectorAll('input[type="file"]').document.querySelectorAll('input[type="file"]').forEach(input => {
            ...
            function updateReview() {
                ...
                document.getElementById('review-nip-taw').textContent = document.getElementById('nip_view').value;
                document.getElementById('review-jabatan-taw').textContent = get('jabatan_taw');
                document.getElementById('review-pangkat-taw').textContent = get('pangkat_taw');
                document.getElementById('review-satuan-kerja-taw').textContent = get('satuan_kerja_taw');
                document.getElementById('review-golongan-taw').textContent = get('golongan_taw');

                // Render List Dokumen
                const container = document.getElementById('review-documents-taw');
                container.innerHTML = '';
