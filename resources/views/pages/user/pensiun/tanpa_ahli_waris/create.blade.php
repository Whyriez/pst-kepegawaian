...
@section('content')
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Formulir untuk pengajuan pensiun bagi pegawai tanpa ahli waris</p>
                </div>
                <a href="{{ route('pensiun.taw') }}" class="btn btn-secondary">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                {{-- ACTION FORM --}}
                <form id="form-pensiun-taw" action="{{ route('pensiun.taw.store') }}" method="POST"
                    ...
                    <div class="form-step active" id="step-1-taw">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_pegawai_taw" class="form-label">Nama Pegawai <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-user"></i></span>
                                    <input type="text" class="form-control" id="nama_pegawai_taw"
                                           name="nama_pegawai_taw" required>
                                </div>
                                <div class="invalid-feedback">Harap isi nama pegawai</div>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="nip_display_taw" class="form-label">NIP Pegawai <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-id-card"></i></span>
                                    <input type="text" class="form-control bg-light" id="nip_display_taw"
                                           name="nip_display_taw" required readonly>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="jabatan_taw" class="form-label">Jabatan Pegawai <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-briefcase"></i></span>
                                    <input type="text" class="form-control" id="jabatan_taw" name="jabatan_taw"
                                           required>
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="satuan_kerja_taw" class="form-label">Satuan Kerja <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-building"></i></span>
                                    <input type="text" class="form-control" id="satuan_kerja_taw"
                                           name="satuan_kerja_taw" required>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="pangkat_taw" class="form-label">Pangkat Pegawai <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="golongan_taw" class="form-label">Golongan/Ruang <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            <div></div>
                            <button type="button" class="btn btn-primary btn-next-taw" data-next="2">
                                ...
                                <div>
                                    ...
                                    <div class="mt-2">
                                        <small class="text-muted">
                                            ...
                                            <span id="upload-progress-taw">0/{{ count($syarat) }}</span> dokumen
                                            terunggah
                                        </small>
                                    </div>
                                </div>
                    ...
                    <div class="form-step" id="step-3-taw">
                        ...
                        <div class="card border-0 bg-light mb-4">
                            <div class="card-body">
                                ...
                                <div id="review-documents-taw" class="small"></div>
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function showStep(idx) {
                ...
                document.getElementById(`step-${idx}-taw`).classList.add('active');
                for (let i = 0; i < idx; i++) {
            ...
            function validateStep(currentStep) {
                ...
                if (currentStep == 1) {
                    const nama = document.getElementById('nama_pegawai_taw').value.trim();
                    const jabatan = document.getElementById('jabatan_taw').value.trim();
                ...
                if (currentStep == 2) {
                    const requiredInputs = document.querySelectorAll('#step-2-taw input[type="file"][required]');
                    let emptyCount = 0;
            ...
            document.querySelectorAll('.btn-next-taw').forEach(btn => {
            ...
            document.querySelectorAll('.btn-prev-taw').forEach(btn => {
                btn.addEventListener('click', function () {
            ...
            function updateUploadProgress() {
                const allFileInputs = document.querySelectorAll('#step-2-taw input[type="file"]');
                let filledCount = 0;
            ...
            // --- LOGIKA CEK NIP ---
            const btnCek = document.getElementById('btn-cek-nip-taw');
            if (btnCek) {
                btnCek.addEventListener('click', function () {
                    const nip = document.getElementById('nip_pegawai_taw').value;
                    if (!nip) {
                    ...
                    fetch(`{{ url('/kenaikan-pangkat/ajax/cek-nip') }}/${nip}`)
                        ...
                        .then(res => {
                            if (res.success) {
                                ...
                                set('nama_pegawai_taw', d.nama);
                                set('jabatan_taw', d.jabatan);
                                set('pangkat_taw', d.pangkat);
                                set('nip_display_taw', d.nip);
                                set('satuan_kerja_taw', d.unit_kerja);
                                set('golongan_taw', d.golongan_ruang);
            ...
            function updateReview() {
                ...
                setText('review-nama-taw', get('nama_pegawai_taw'));
                setText('review-nip-taw', get('nip_display_taw'));
                setText('review-jabatan-taw', get('jabatan_taw'));
                setText('review-satuan-kerja-taw', get('satuan_kerja_taw'));
                setText('review-pangkat-taw', get('pangkat_taw'));
                setText('review-golongan-taw', get('golongan_taw'));
            ...
            // --- SUBMIT FORM ---
            document.getElementById('form-pensiun-taw').addEventListener('submit', function (e) {
