...
@section('title', 'Riwayat Pensiun TAW')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Pensiun Tanpa Ahli Waris</h2>
                    <p class="text-muted mb-0">Kelola riwayat pengajuan pensiun TAW.</p>
                </div>
                <a href="{{ route('pensiun.taw.create') }}" class="btn btn-primary shadow-sm">
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        @forelse($pengajuans as $item)
                            <tr>
                                ...
                                {{-- 3. TMT Pensiun (Kosong untuk TAW) --}}
                                <td>
                                            ...
                                            @if(in_array($item->status, ['pending', 'perbaikan']))
                                                ...
                                                <li>
                                                    <a class="dropdown-item fw-bold text-warning"
                                                       href="{{ route('pensiun.taw.edit', ['id' => $item->id]) }}">
                            ...
                            <tr>
                                <td colspan="6" class="text-center py-5">
                                    <div class="py-4">
                                        ...
                                        <a href="{{ route('pensiun.taw.create') }}" class="btn btn-sm btn-primary mt-2">
                                            Ajukan Sekarang
                                        </a>
                                    </div>
                                </td>
                ...
                html: `
                    <div class="text-start">
                        <table class="table table-sm table-borderless">
                            <tr><td width="35%"><strong>Layanan</strong></td><td>: Pensiun Tanpa Ahli Waris</td></tr>
