                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>NIP:</strong> <span id="review-nip-hilang">{{ $pengajuan->pegawai->nip }}</span></p>
                                        <p><strong>Jabatan:</strong> <span id="review-jabatan-hilang">-</span></p>
                                    </div>
                                    <div class="col-md-6">
                                        <p><strong>Satuan Kerja:</strong> <span id="review-satuan-kerja-hilang">-</span></p>
            ...
            document.querySelectorAll('.btn-next-hilang').forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    if (next === 3) {
                        ...
                        const reqInputs = document.querySelectorAll('#step-2-hilang input[type="file"][required]');
