...
@section('title', 'Edit Pensiun Hilang')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Edit Pengajuan Pensiun Hilang</h2>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                {{-- ACTION FORM UPDATE --}}
                <form id="form-pensiun-hilang"
                      action="{{ route('pensiun.hilang.update', $pengajuan->id) }}"
                      method="POST"
                    ...
                    <div class="form-step active" id="step-1-hilang">
                        <div class="step-header mb-4">
                            ...
                            <p class="text-muted">Pastikan data pegawai yang dinyatakan hilang sudah benar.</p>
                        </div>

                        {{-- Hidden NIP Display --}}
                        <input type="hidden" name="nip_display_hilang" value="{{ $pengajuan->pegawai->nip }}">

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Nama Pegawai</label>
                                <input type="text" class="form-control bg-light"
                                       id="nama_pegawai_hilang"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="jabatan_hilang" name="jabatan_hilang"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="satuan_kerja_hilang" name="satuan_kerja_hilang"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="pangkat_hilang" name="pangkat_hilang"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="golongan_hilang" name="golongan_hilang"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>NIP:</strong> <span
                                                id="review-nip-hilang">{{ $pengajuan->pegawai->nip }}</span></p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.btn-next-hilang').forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    if (next === 3) {
                        ...
                        if (document.querySelectorAll('#step-2-hilang input.is-invalid').length > 0) {
                        ...
                        let valid = true;
                        document.querySelectorAll('#step-2-hilang input[type="file"][required]').forEach(input => {
                            if (input.files.length === 0) {
                                input.classList.add('is-invalid');
                                valid = false;
                            }
            ...
            function updateReview() {
                ...
                document.getElementById('review-nip-hilang').textContent = document.getElementById('nip_view').value;
                document.getElementById('review-jabatan-hilang').textContent = get('jabatan_hilang');
                document.getElementById('review-pangkat-hilang').textContent = get('pangkat_hilang');
                document.getElementById('review-satuan-kerja-hilang').textContent = get('satuan_kerja_hilang');
                document.getElementById('review-golongan-hilang').textContent = get('golongan_hilang');

                // Render List Dokumen
                const container = document.getElementById('review-documents-hilang');
                container.innerHTML = '';
