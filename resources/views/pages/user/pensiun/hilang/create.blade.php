    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Form Pengajuan Pensiun Hilang</h2>
                    <p class="text-muted mb-0">Formulir untuk pengajuan pensiun karena pegawai dinyatakan hilang</p>
                </div>
                <a href="{{ route('pensiun.hilang') }}" class="btn btn-secondary">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                {{-- ACTION FORM --}}
                <form id="form-pensiun-hilang" action="{{ route('pensiun.hilang.store') }}" method="POST"
                    ...
                    <div class="form-step active" id="step-1-hilang">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_pegawai_hilang" class="form-label">Nama Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-user"></i></span>
                                    <input type="text" class="form-control bg-light" id="nama_pegawai_hilang"
                                           name="nama_pegawai_hilang"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="nip_display_hilang" class="form-label">NIP Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-id-card"></i></span>
                                    <input type="text" class="form-control bg-light" id="nip_display_hilang"
                                           name="nip_display_hilang"
                                           value="{{ $pegawai->nip ?? '-' }}"
                                           readonly>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="jabatan_hilang" class="form-label">Jabatan</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-briefcase"></i></span>
                                    <input type="text" class="form-control bg-light" id="jabatan_hilang"
                                           name="jabatan_hilang"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="satuan_kerja_hilang" class="form-label">Satuan Kerja</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-building"></i></span>
                                    <input type="text" class="form-control bg-light" id="satuan_kerja_hilang"
                                           name="satuan_kerja_hilang"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="pangkat_hilang" class="form-label">Pangkat</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-star"></i></span>
                                    <input type="text" class="form-control bg-light" id="pangkat_hilang"
                                           name="pangkat_hilang"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="golongan_hilang" class="form-label">Golongan/Ruang</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-layer-group"></i></span>
                                    <input type="text" class="form-control bg-light" id="golongan_hilang"
                                           name="golongan_hilang"
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            <div></div>
                            <button type="button" class="btn btn-primary btn-next-hilang" data-next="2">
                    ...
                    <div class="form-step" id="step-2-hilang">
                                ...
                                <div>
                                    ...
                                    <div class="mt-2">
                                        <small class="text-muted">
                                            ...
                                            <span id="upload-progress-hilang">0/{{ count($syarat) }}</span> dokumen
                                            terunggah
                                        </small>
                                    </div>
                                </div>
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            <button type="button" class="btn btn-outline-secondary btn-prev-hilang" data-prev="1">
                                <i class="fas fa-arrow-left me-2"></i>Kembali
                            </button>
                            <button type="button" class="btn btn-primary btn-next-hilang" data-next="3">
                                Lanjut <i class="fas fa-arrow-right ms-2"></i>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="form-step" id="step-3-hilang">
                        ...
                        <div class="card border-0 bg-light mb-4">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <p><strong>Nama:</strong> <span id="review-nama-hilang">-</span></p>
                                        <p><strong>NIP:</strong> <span id="review-nip-hilang">-</span></p>
                                        <p><strong>Jabatan:</strong> <span id="review-jabatan-hilang">-</span></p>
                                    </div>
                                    <div class="col-md-6">
                                        <p><strong>Satuan Kerja:</strong> <span id="review-satuan-kerja-hilang">-</span>
                                        </p>
                                        <p><strong>Pangkat:</strong> <span id="review-pangkat-hilang">-</span></p>
                                        <p><strong>Golongan:</strong> <span id="review-golongan-hilang">-</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-check mb-4">
                            <input class="form-check-input" type="checkbox" id="confirm-data-hilang" required>
                            <label class="form-check-label" for="confirm-data-hilang">
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            <button type="button" class="btn btn-outline-secondary btn-prev-hilang" data-prev="2">
                                <i class="fas fa-arrow-left me-2"></i>Kembali
                            </button>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function validateStep(currentStep) {
                ...
                if (currentStep == 1) {
                    const nip = document.getElementById('nip_display_hilang').value.trim();
                ...
                if (currentStep == 2) {
                    const requiredInputs = document.querySelectorAll('#step-2-hilang input[type="file"][required]');
                    let emptyCount = 0;
            ...
            function updateUploadProgress() {
                const allFileInputs = document.querySelectorAll('#step-2-hilang input[type="file"]');
                let filledCount = 0;
