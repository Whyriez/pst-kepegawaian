                ...
                <form id="form-pensiun-hilang" action="{{ route('pensiun.hilang.store') }}" method="POST"
                    ...
                    <div class="form-step active" id="step-1-hilang">
                        <div class="step-header mb-4">
                            ...
                            <p class="text-muted">Isi data diri pegawai yang dinyatakan hilang</p>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_pegawai_hilang" class="form-label">Nama Pegawai <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-user"></i></span>
                                    <input type="text" class="form-control" id="nama_pegawai_hilang"
                                           name="nama_pegawai_hilang" required>
                                </div>
                                <div class="invalid-feedback">Harap isi nama pegawai</div>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="nip_display_hilang" class="form-label">NIP Pegawai <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-id-card"></i></span>
                                    <input type="text" class="form-control bg-light" id="nip_display_hilang"
                                           name="nip_display_hilang" required readonly>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="jabatan_hilang" class="form-label">Jabatan Pegawai <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="satuan_kerja_hilang" class="form-label">Satuan Kerja <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="pangkat_hilang" class="form-label">Pangkat Pegawai <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="golongan_hilang" class="form-label">Golongan/Ruang <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function validateStep(currentStep) {
                ...
                if (currentStep == 1) {
                    const nama = document.getElementById('nama_pegawai_hilang').value.trim();
                    const jabatan = document.getElementById('jabatan_hilang').value.trim();
