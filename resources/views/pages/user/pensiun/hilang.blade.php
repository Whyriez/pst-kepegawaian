        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Formulir untuk pengajuan pensiun karena pegawai hilang</p>
                </div>
                ...
                <form id="form-pensiun-hilang" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-step active" id="step-1-hilang">
                        <div class="step-header mb-4">
                            ...
                            <p class="text-muted">Isi data diri pegawai yang hilang</p>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_pegawai_hilang" class="form-label">Nama Pegawai <span class="text-danger">*</span></label>
                                <div class="input-group">
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            <div></div> <button type="button" class="btn btn-primary btn-next-hilang" data-next="2">
                    ...
                    <div class="form-step" id="step-2-hilang">
                        <div class="step-header mb-4">
                            ...
                            <p class="text-muted">Unggah dokumen-dokumen yang diperlukan untuk pengajuan pensiun hilang</p>
                        </div>
