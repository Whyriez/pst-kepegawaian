...
@section('title', 'Edit Gelar Akademik')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Edit Pengajuan Gelar Akademik</h2>
                    <p class="text-muted mb-0">Perbaiki data atau dokumen pengajuan pencantuman gelar akademik Anda.</p>
                </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                {{-- ACTION FORM UPDATE --}}
                <form id="form-gelar-akademik"
                      action="{{ route('gelar.akademik.update', $pengajuan->id) }}"
                      method="POST"
                    ...
                    <div class="form-step active" id="step-1-gelar-akademik">
                        <div class="step-header mb-4">
                            ...
                            <p class="text-muted">Pastikan data pegawai dan jenjang pendidikan sudah benar.</p>
                        </div>

                        {{-- Hidden NIP Display --}}
                        <input type="hidden" name="nip_display_gelar_akademik" value="{{ $pengajuan->pegawai->nip }}">

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Nama Pegawai</label>
                                <input type="text" class="form-control bg-light"
                                       id="nama_pegawai_gelar_akademik"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="jabatan_gelar_akademik" name="jabatan_gelar_akademik"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="pangkat_gelar_akademik" name="pangkat_gelar_akademik"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="satuan_kerja_gelar_akademik" name="satuan_kerja_gelar_akademik"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="golongan_ruang_gelar_akademik" name="golongan_ruang_gelar_akademik"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function updateReview() {
                ...
                document.getElementById('review-pangkat-gelar-akademik').textContent = get('pangkat_gelar_akademik');
                document.getElementById('review-satuan-kerja-gelar-akademik').textContent = get('satuan_kerja_gelar_akademik');
