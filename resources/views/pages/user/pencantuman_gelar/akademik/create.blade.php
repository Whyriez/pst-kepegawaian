    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('gelar.akademik') }}" class="btn btn-secondary">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                {{-- ACTION FORM --}}
                <form id="form-gelar-akademik" action="{{ route('gelar.akademik.store') }}" method="POST"
                    ...
                    <div class="form-step active" id="step-1-gelar-akademik">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_pegawai_gelar_akademik" class="form-label">Nama Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-user"></i></span>
                                    <input type="text" class="form-control bg-light" id="nama_pegawai_gelar_akademik"
                                           name="nama_pegawai_gelar_akademik"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="nip_display_gelar_akademik" class="form-label">NIP Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-id-card"></i></span>
                                    <input type="text" class="form-control bg-light" id="nip_display_gelar_akademik"
                                           name="nip_display_gelar_akademik"
                                           value="{{ $pegawai->nip ?? '-' }}"
                                           readonly>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="jabatan_gelar_akademik" class="form-label">Jabatan</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-briefcase"></i></span>
                                    <input type="text" class="form-control bg-light" id="jabatan_gelar_akademik"
                                           name="jabatan_gelar_akademik"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="pangkat_gelar_akademik" class="form-label">Pangkat</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-star"></i></span>
                                    <input type="text" class="form-control bg-light" id="pangkat_gelar_akademik"
                                           name="pangkat_gelar_akademik"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="satuan_kerja_gelar_akademik" class="form-label">Satuan Kerja</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-building"></i></span>
                                    <input type="text" class="form-control bg-light" id="satuan_kerja_gelar_akademik"
                                           name="satuan_kerja_gelar_akademik"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="golongan_ruang_gelar_akademik" class="form-label">Golongan/Ruang</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-layer-group"></i></span>
                                    <input type="text" class="form-control bg-light" id="golongan_ruang_gelar_akademik"
                                           name="golongan_ruang_gelar_akademik"
                        ...
                        <div class="step-header mb-4 mt-4 border-top pt-4">
                            <h5 class="fw-bold text-primary mb-2">
                                <i class="fas fa-graduation-cap me-2"></i>Detail Gelar
                            </h5>
                            <p class="text-muted">Pilih jenjang pendidikan yang akan dicantumkan gelar akademiknya.</p>
                        </div>

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="jenjang_pendidikan_gelar_akademik" class="form-label">Jenjang Pendidikan <span class="text-danger">*</span></label>
                                <div class="input-group">
                                ...
                                <div>
                                    ...
                                    <div class="mt-2">
                                        <small class="text-muted">
                                            ...
                                            <span id="upload-progress-gelar-akademik">0/{{ count($syarat) }}</span>
                                            dokumen terunggah
                                        </small>
                                    </div>
                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function validateStep(currentStep) {
                ...
                // VALIDASI STEP 1: Data Diri (Readonly) & Jenjang (Wajib)
                if (currentStep == 1) {
                    const nip = document.getElementById('nip_display_gelar_akademik').value.trim();
                    const jenjang = document.getElementById('jenjang_pendidikan_gelar_akademik').value.trim();
                    ...
                    if (!nip || nip === '-') {
                        ...
                        isValid = false;
                        errorMsg = 'Harap pilih Jenjang Pendidikan!';
                    }
                }

                // VALIDASI STEP 2: Dokumen Required
                if (currentStep == 2) {
                    const requiredInputs = document.querySelectorAll('#step-2-gelar-akademik input[type="file"][required]');
                    let emptyCount = 0;
            ...
            function updateUploadProgress() {
                const allFileInputs = document.querySelectorAll('#step-2-gelar-akademik input[type="file"]');
                let filledCount = 0;
