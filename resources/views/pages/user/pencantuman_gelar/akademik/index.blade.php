...
@section('title', 'Riwayat Gelar Akademik')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Pencantuman Gelar Akademik</h2>
                    <p class="text-muted mb-0">Riwayat pengajuan pencantuman gelar akademik.</p>
                </div>
                <a href="{{ route('gelar.akademik.create') }}" class="btn btn-primary shadow-sm">
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tr>
                            <th class="py-3 px-3">Jenjang Pendidikan (Lama)</th>
                            <th class="py-3">Jenjang Pendidikan (Baru)</th>
                        ...
                        @forelse($pengajuans as $item)
                            <tr>
                                {{-- 1. Jenjang Pendidikan Lama (Ambil dari data pegawai jika ada, atau -) --}}
                                <td class="px-3">
                                    <div class="fw-bold text-dark">{{ $item->pegawai->pendidikan_terakhir ?? '-' }}</div>
                                </td>

                                {{-- 2. Jenjang Pendidikan Diusulkan --}}
                                <td>
                                            ...
                                            @if(in_array($item->status, ['pending', 'perbaikan']))
                                                ...
                                                <li>
                                                    <a class="dropdown-item fw-bold text-warning"
                                                       href="{{ route('gelar.akademik.edit', ['id' => $item->id]) }}">
                            ...
                            <tr>
                                <td colspan="5" class="text-center py-5">
                                    <div class="py-4">
                                        ...
                                        <a href="{{ route('gelar.akademik.create') }}" class="btn btn-sm btn-primary mt-2">
                                            Ajukan Sekarang
                                        </a>
                                    </div>
                                </td>
                ...
                html: `
                    <div class="text-start">
                        <table class="table table-sm table-borderless">
                            <tr><td width="35%"><strong>Layanan</strong></td><td>: Gelar Akademik</td></tr>
