...
@section('content')
    <div class="container-fluid p-0">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                {{-- ACTION FORM --}}
                <form id="form-gelar-profesi" action="{{ route('gelar.profesi.store') }}" method="POST"
                    ...
                    <div class="form-step active" id="step-1-gelar-profesi">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_pegawai_gelar_profesi" class="form-label">Nama Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-user"></i></span>
                                    <input type="text" class="form-control bg-light" id="nama_pegawai_gelar_profesi"
                                           name="nama_pegawai_gelar_profesi"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="nip_display_gelar_profesi" class="form-label">NIP Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-id-card"></i></span>
                                    <input type="text" class="form-control bg-light" id="nip_display_gelar_profesi"
                                           name="nip_display_gelar_profesi"
                                           value="{{ $pegawai->nip ?? '-' }}"
                                           readonly>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="jabatan_gelar_profesi" class="form-label">Jabatan</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-briefcase"></i></span>
                                    <input type="text" class="form-control bg-light" id="jabatan_gelar_profesi"
                                           name="jabatan_gelar_profesi"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="pangkat_gelar_profesi" class="form-label">Pangkat</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-star"></i></span>
                                    <input type="text" class="form-control bg-light" id="pangkat_gelar_profesi"
                                           name="pangkat_gelar_profesi"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="satuan_kerja_gelar_profesi" class="form-label">Satuan Kerja</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-building"></i></span>
                                    <input type="text" class="form-control bg-light" id="satuan_kerja_gelar_profesi"
                                           name="satuan_kerja_gelar_profesi"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="golongan_ruang_gelar_profesi" class="form-label">Golongan/Ruang</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-layer-group"></i></span>
                                    <input type="text" class="form-control bg-light" id="golongan_ruang_gelar_profesi"
                                           name="golongan_ruang_gelar_profesi"
                        ...
                        <div class="step-header mb-4 mt-4 border-top pt-4">
                            <h5 class="fw-bold text-primary mb-2">
                                <i class="fas fa-user-tie me-2"></i>Detail Profesi
                            </h5>
                            <p class="text-muted">Lengkapi data profesi yang akan dicantumkan.</p>
                        </div>

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="jenjang_pendidikan_gelar_profesi" class="form-label">Jenjang Pendidikan <span class="text-danger">*</span></label>
                                <div class="input-group">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="usul_profesi_gelar_profesi" class="form-label">Usul Profesi <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-user-tie"></i></span>
                                    <input type="text" class="form-control" id="usul_profesi_gelar_profesi"
                                           name="usul_profesi_gelar_profesi" placeholder="Contoh: Apt., Drg., Ns."
                                           required>
                                </div>
                                <div class="invalid-feedback">Harap isi usul profesi</div>
                            </div>
                        </div>
                    ...
                    <div class="form-step" id="step-2-gelar-profesi">
                        <div class="step-header mb-4">
                            ...
                            <p class="text-muted">Unggah dokumen-dokumen yang diperlukan untuk pengajuan pencantuman gelar
                                profesi</p>
                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-2">
                                        <small class="text-muted">
                                            ...
                                            <span id="upload-progress-gelar-profesi">0/{{ count($syarat) }}</span>
                                            dokumen terunggah
                                        </small>
                                    </div>
                                </div>
                            ...
                            @empty
                                <div class="col-12">
                                    <div class="alert alert-warning">
                                        Belum ada syarat dokumen yang diatur di database untuk layanan ini (gelar-profesi).
                                    </div>
                                </div>
                            @endforelse
                        </div>
                        ...
                        <div class="card border-0 bg-light mb-4">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <p><strong>Satuan Kerja:</strong> <span id="review-satuan-kerja-gelar-profesi">-</span>
                                        </p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function validateStep(currentStep) {
                ...
                // VALIDASI STEP 1: Data Diri (Readonly) & Profesi (Wajib)
                if (currentStep == 1) {
                    const nip = document.getElementById('nip_display_gelar_profesi').value.trim();
                    const jenjang = document.getElementById('jenjang_pendidikan_gelar_profesi').value.trim();
                    const profesi = document.getElementById('usul_profesi_gelar_profesi').value.trim();
                    ...
                    if (!nip || nip === '-') {
                        ...
                        isValid = false;
                        errorMsg = 'Harap pilih Jenjang Pendidikan dan isi Usul Profesi!';
                    }
                }

                // VALIDASI STEP 2: Dokumen Required
                if (currentStep == 2) {
                    const requiredInputs = document.querySelectorAll('#step-2-gelar-profesi input[type="file"][required]');
                    let emptyCount = 0;
            ...
            function updateUploadProgress() {
                const allFileInputs = document.querySelectorAll('#step-2-gelar-profesi input[type="file"]');
                let filledCount = 0;
            ...
            // --- LOGIKA CEK NIP ---
            const btnCek = document.getElementById('btn-cek-nip-gelar-profesi');
            if (btnCek) {
                btnCek.addEventListener('click', function () {
                    const nip = document.getElementById('nip_pegawai_gelar_profesi').value;
                    if (!nip) {
                    ...
                    fetch(`{{ url('/kenaikan-pangkat/ajax/cek-nip') }}/${nip}`)
                        ...
                        .then(res => {
                            if (res.success) {
                                ...
                                set('nama_pegawai_gelar_profesi', d.nama);
                                set('jabatan_gelar_profesi', d.jabatan);
                                set('pangkat_gelar_profesi', d.pangkat);
                                set('nip_display_gelar_profesi', d.nip);
                                set('satuan_kerja_gelar_profesi', d.unit_kerja);
                                set('golongan_ruang_gelar_profesi', d.golongan_ruang);
            ...
            function updateReview() {
                ...
                setText('review-nama-gelar-profesi', get('nama_pegawai_gelar_profesi'));
                setText('review-nip-gelar-profesi', get('nip_display_gelar_profesi'));
                setText('review-jabatan-gelar-profesi', get('jabatan_gelar_profesi'));
                setText('review-pangkat-gelar-profesi', get('pangkat_gelar_profesi'));
                setText('review-satuan-kerja-gelar-profesi', get('satuan_kerja_gelar_profesi'));
                setText('review-golongan-ruang-gelar-profesi', get('golongan_ruang_gelar_profesi'));
                setText('review-jenjang-pendidikan-gelar-profesi', get('jenjang_pendidikan_gelar_profesi'));
                setText('review-usul-profesi-gelar-profesi', get('usul_profesi_gelar_profesi'));
            ...
            // --- SUBMIT FORM ---
            document.getElementById('form-gelar-profesi').addEventListener('submit', function (e) {
