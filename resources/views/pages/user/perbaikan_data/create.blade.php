    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('perbaikan_data') }}" class="btn btn-secondary">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                {{-- ACTION FORM --}}
                <form id="form-perbaikan-data-asn" action="{{ route('perbaikan_data.store') }}" method="POST"
                    ...
                    <div class="form-step active" id="step-1-perbaikan-data-asn">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_pegawai_perbaikan_data_asn" class="form-label">Nama Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-user"></i></span>
                                    <input type="text" class="form-control bg-light" id="nama_pegawai_perbaikan_data_asn"
                                           name="nama_pegawai_perbaikan_data_asn"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="nip_display_perbaikan_data_asn" class="form-label">NIP Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-id-card"></i></span>
                                    <input type="text" class="form-control bg-light" id="nip_display_perbaikan_data_asn"
                                           name="nip_display_perbaikan_data_asn"
                                           value="{{ $pegawai->nip ?? '-' }}"
                                           readonly>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="jabatan_pegawai_perbaikan_data_asn" class="form-label">Jabatan Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-briefcase"></i></span>
                                    <input type="text" class="form-control bg-light" id="jabatan_pegawai_perbaikan_data_asn"
                                           name="jabatan_pegawai_perbaikan_data_asn"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="pangkat_pegawai_perbaikan_data_asn" class="form-label">Pangkat Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-star"></i></span>
                                    <input type="text" class="form-control bg-light" id="pangkat_pegawai_perbaikan_data_asn"
                                           name="pangkat_pegawai_perbaikan_data_asn"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="unit_kerja_pegawai_perbaikan_data_asn" class="form-label">Unit Kerja Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-building"></i></span>
                                    <input type="text" class="form-control bg-light" id="unit_kerja_pegawai_perbaikan_data_asn"
                                           name="unit_kerja_pegawai_perbaikan_data_asn"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="golongan_ruang_pegawai_perbaikan_data_asn" class="form-label">Golongan Ruang Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-layer-group"></i></span>
                                    <input type="text" class="form-control bg-light" id="golongan_ruang_pegawai_perbaikan_data_asn"
                                           name="golongan_ruang_pegawai_perbaikan_data_asn"
                                ...
                                <div>
                                    ...
                                    <div class="mt-2">
                                        <small class="text-muted">
                                            ...
                                            <span id="upload-progress-perbaikan-data-asn">0/{{ count($syarat) }}</span>
                                            dokumen terunggah
                                        </small>
                                    </div>
                                </div>
                    ...
                    <div class="form-step" id="step-3-perbaikan-data-asn">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>Jabatan:</strong> <span id="review-jabatan-perbaikan-data-asn">-</span>
                                        </p>
                                    </div>
                                    <div class="col-md-6">
                                        <p><strong>Pangkat:</strong> <span id="review-pangkat-perbaikan-data-asn">-</span>
                                        </p>
                                        <p><strong>Unit Kerja:</strong> <span
                                                id="review-unit-kerja-perbaikan-data-asn">-</span></p>
                                        <p><strong>Golongan Ruang:</strong> <span
                                                id="review-golongan-ruang-perbaikan-data-asn">-</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-check mb-4">
                            <input class="form-check-input" type="checkbox" id="confirm-data-perbaikan-data-asn"
                                   required>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function validateStep(currentStep) {
                ...
                if (currentStep == 1) {
                    const nip = document.getElementById('nip_display_perbaikan_data_asn').value.trim();
                ...
                if (currentStep == 2) {
                    const requiredInputs = document.querySelectorAll('#step-2-perbaikan-data-asn input[type="file"][required]');
                    let emptyCount = 0;
            ...
            function updateUploadProgress() {
                const allFileInputs = document.querySelectorAll('#step-2-perbaikan-data-asn input[type="file"]');
                let filledCount = 0;
