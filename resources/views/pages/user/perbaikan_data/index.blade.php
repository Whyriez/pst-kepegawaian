...
@section('title', 'Riwayat Perbaikan Data ASN')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Perbaikan Data ASN</h2>
                    <p class="text-muted mb-0">Riwayat pengajuan perbaikan data ASN.</p>
                </div>
                <a href="{{ route('perbaikan_data.create') }}" class="btn btn-primary shadow-sm">
                    <i class="fas fa-edit me-2"></i>Ajukan Perbaikan
                </a>
            </div>
        </div>
                                            ...
                                            @if(in_array($item->status, ['pending', 'perbaikan']))
                                                ...
                                                <li>
                                                    <a class="dropdown-item fw-bold text-warning"
                                                       href="{{ route('perbaikan_data.edit', ['id' => $item->id]) }}">
                            ...
                            <tr>
                                <td colspan="5" class="text-center py-5">
                                    <div class="py-4">
                                        ...
                                        <a href="{{ route('perbaikan_data.create') }}" class="btn btn-sm btn-primary mt-2">
                                            Ajukan Sekarang
                                        </a>
                                    </div>
                                </td>
                ...
                html: `
                    <div class="text-start">
                        <table class="table table-sm table-borderless">
                            <tr><td width="35%"><strong>Layanan</strong></td><td>: Perbaikan Data ASN</td></tr>
