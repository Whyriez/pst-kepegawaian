    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Edit Pengajuan Penugasan</h2>
                    <p class="text-muted mb-0">Perbaiki data atau dokumen pengajuan penugasan.</p>
                </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                ...
                <form id="form-penugasan"
                      action="{{ route('penugasan.update', $pengajuan->id) }}"
                      method="POST"
                    ...
                    <div class="form-step active" id="step-1-penugasan">
                        ...
                        {{-- Hidden NIP Display --}}
                        <input type="hidden" name="nip_display_penugasan" value="{{ $pengajuan->pegawai->nip }}">

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Nama Pegawai</label>
                                <input type="text" class="form-control bg-light"
                                       id="nama_pegawai_penugasan"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="jabatan_penugasan" name="jabatan_penugasan"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="pangkat_penugasan" name="pangkat_penugasan"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="satuan_kerja_penugasan" name="satuan_kerja_penugasan"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="golongan_ruang_penugasan" name="golongan_ruang_penugasan"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.btn-next-penugasan').forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    if (next === 3) {
                        ...
                        if (document.querySelectorAll('#step-2-penugasan input.is-invalid').length > 0) {
                        ...
                        let valid = true;
                        document.querySelectorAll('#step-2-penugasan input[type="file"][required]').forEach(input => {
                            if (input.files.length === 0) {
                                input.classList.add('is-invalid');
                                valid = false;
                            }
            ...
            function updateReview() {
                ...
                document.getElementById('review-nip-penugasan').textContent = get('nip_display_penugasan');
                document.getElementById('review-jabatan-penugasan').textContent = get('jabatan_penugasan');
                document.getElementById('review-pangkat-penugasan').textContent = get('pangkat_penugasan');
                document.getElementById('review-satuan-kerja-penugasan').textContent = get('satuan_kerja_penugasan');
                document.getElementById('review-golongan-ruang-penugasan').textContent = get('golongan_ruang_penugasan');

                // Render List Dokumen
                const container = document.getElementById('review-documents-penugasan');
                container.innerHTML = '';
