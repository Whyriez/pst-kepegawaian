                        ...
                        <div class="card border-0 bg-light mb-4">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <p><strong>Unit Kerja:</strong> <span id="review-satuan-kerja-penugasan">-</span></p>
            ...
            document.querySelectorAll('.btn-next-penugasan').forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    if (next === 3) {
                        ...
                        const reqInputs = document.querySelectorAll('#step-2-penugasan input[type="file"][required]');
