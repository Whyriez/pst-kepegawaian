                    ...
                    <div class="form-step active" id="step-1-penugasan">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_pegawai_penugasan" class="form-label">Nama Pegawai <span
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="nip_display_penugasan" class="form-label">NIP Pegawai <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="jabatan_penugasan" class="form-label">Jabatan Pegawai <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-briefcase"></i></span>
                                    <input type="text" class="form-control" id="jabatan_penugasan"
                                           name="jabatan_penugasan" required>
                                </div>
                                <div class="invalid-feedback">Harap isi jabatan pegawai</div>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="pangkat_penugasan" class="form-label">Pangkat Pegawai <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-star"></i></span>
                                    <input type="text" class="form-control" id="pangkat_penugasan"
                                           name="pangkat_penugasan" required>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="satuan_kerja_penugasan" class="form-label">Satuan Kerja <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="golongan_ruang_penugasan" class="form-label">Golongan/Ruang <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function validateStep(currentStep) {
                ...
                if (currentStep == 1) {
                    const nama = document.getElementById('nama_pegawai_penugasan').value.trim();
                    const jabatan = document.getElementById('jabatan_penugasan').value.trim();
