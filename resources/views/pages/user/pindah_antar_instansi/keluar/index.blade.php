...
@section('title', 'Riwayat Pindah Keluar')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Pindah Antar Instansi - Keluar</h2>
                    <p class="text-muted mb-0">Riwayat pengajuan pindah keluar ke instansi lain.</p>
                </div>
                <a href="{{ route('pindah.keluar.create') }}" class="btn btn-primary shadow-sm">
                    <i class="fas fa-plus-circle me-2"></i>Ajukan Pindah Keluar
                </a>
            </div>
        </div>
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tr>
                            <th class="py-3 px-3">Satuan Kerja Asal</th>
                            <th class="py-3">Instansi Tujuan</th>
                            <th class="py-3">Jabatan Tujuan</th>
                        ...
                        @forelse($pengajuans as $item)
                            <tr>
                                {{-- 1. Satker Asal --}}
                                <td class="px-3">
                                    <div class="fw-bold text-dark">{{ $item->data_tambahan['unit_kerja'] ?? '-' }}</div>
                                ...
                                {{-- 3. Jabatan Tujuan --}}
                                <td>
                                    {{ $item->data_tambahan['jabatan_tujuan'] ?? '-' }}
                                </td>
                                            ...
                                            @if(in_array($item->status, ['pending', 'perbaikan']))
                                                ...
                                                <li>
                                                    <a class="dropdown-item fw-bold text-warning"
                                                       href="{{ route('pindah.keluar.edit', ['id' => $item->id]) }}">
                            ...
                            <tr>
                                <td colspan="5" class="text-center py-5">
                                    <div class="py-4">
                                        ...
                                        <a href="{{ route('pindah.keluar.create') }}" class="btn btn-sm btn-primary mt-2">
                                            Ajukan Sekarang
                                        </a>
                                    </div>
                                </td>
                ...
                html: `
                    <div class="text-start">
                        <table class="table table-sm table-borderless">
                            <tr><td width="35%"><strong>Layanan</strong></td><td>: Pindah Keluar</td></tr>
