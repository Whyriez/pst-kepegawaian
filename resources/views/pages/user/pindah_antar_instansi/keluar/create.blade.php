                    ...
                    <div class="form-step active" id="step-1-pindah-keluar">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_pegawai_pindah_keluar" class="form-label">Nama Pegawai <span
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="nip_display_pindah_keluar" class="form-label">NIP Pegawai <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-id-card"></i></span>
                                    <input type="text" class="form-control bg-light" id="nip_display_pindah_keluar"
                                           name="nip_display_pindah_keluar" required readonly>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="jabatan_pindah_keluar" class="form-label">Jabatan Pegawai (Saat Ini) <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="unit_kerja_pindah_keluar" class="form-label">Unit Kerja Pegawai (Saat Ini) <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="pangkat_pindah_keluar" class="form-label">Pangkat Pegawai <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="golongan_ruang_pindah_keluar" class="form-label">Golongan/Ruang <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="instansi_tujuan_pindah_keluar" class="form-label">Instansi Tujuan <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-building"></i></span>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="jabatan_tujuan_pindah_keluar" class="form-label">Jabatan di Instansi Tujuan
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function validateStep(currentStep) {
                ...
                // VALIDASI STEP 1: Data Diri & Tujuan
                if (currentStep == 1) {
                    const nama = document.getElementById('nama_pegawai_pindah_keluar').value.trim();
