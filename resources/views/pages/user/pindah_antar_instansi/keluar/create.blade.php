    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('pindah.keluar') }}" class="btn btn-secondary">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                {{-- ACTION FORM --}}
                <form id="form-pindah-keluar" action="{{ route('pindah.keluar.store') }}" method="POST"
                    ...
                    <div class="form-step active" id="step-1-pindah-keluar">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_pegawai_pindah_keluar" class="form-label">Nama Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-user"></i></span>
                                    <input type="text" class="form-control bg-light" id="nama_pegawai_pindah_keluar"
                                           name="nama_pegawai_pindah_keluar"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="nip_display_pindah_keluar" class="form-label">NIP Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-id-card"></i></span>
                                    <input type="text" class="form-control bg-light" id="nip_display_pindah_keluar"
                                           name="nip_display_pindah_keluar"
                                           value="{{ $pegawai->nip ?? '-' }}"
                                           readonly>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="jabatan_pindah_keluar" class="form-label">Jabatan (Saat Ini)</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-briefcase"></i></span>
                                    <input type="text" class="form-control bg-light" id="jabatan_pindah_keluar"
                                           name="jabatan_pindah_keluar"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="unit_kerja_pindah_keluar" class="form-label">Unit Kerja (Saat Ini)</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-building"></i></span>
                                    <input type="text" class="form-control bg-light" id="unit_kerja_pindah_keluar"
                                           name="unit_kerja_pindah_keluar"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="pangkat_pindah_keluar" class="form-label">Pangkat</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-star"></i></span>
                                    <input type="text" class="form-control bg-light" id="pangkat_pindah_keluar"
                                           name="pangkat_pindah_keluar"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="golongan_ruang_pindah_keluar" class="form-label">Golongan/Ruang</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-layer-group"></i></span>
                                    <input type="text" class="form-control bg-light" id="golongan_ruang_pindah_keluar"
                                           name="golongan_ruang_pindah_keluar"
                        ...
                        <div class="step-header mb-4 mt-4 border-top pt-4">
                            <h5 class="fw-bold text-primary mb-2">
                                <i class="fas fa-sign-out-alt me-2"></i>Informasi Instansi Tujuan
                            </h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="invalid-feedback">Harap isi jabatan tujuan</div>
                            </div>
                        </div>

                        <div class="d-flex justify-content-between mt-5">
                            <div></div>
                            <button type="button" class="btn btn-primary btn-next-pindah-keluar" data-next="2">
                                ...
                                <div>
                                    ...
                                    <div class="mt-2">
                                        <small class="text-muted">
                                            ...
                                            <span id="upload-progress-pindah-keluar">0/{{ count($syarat) }}</span> dokumen
                                            terunggah
                                        </small>
                                    </div>
                                </div>
                            ...
                            @empty
                                <div class="col-12">
                                    <div class="alert alert-warning">
                                        Belum ada syarat dokumen yang diatur di database untuk layanan ini (pindah-keluar).
                                    </div>
                                </div>
                            @endforelse
                        </div>
                    ...
                    <div class="form-step" id="step-3-pindah-keluar">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>Jabatan Asal:</strong> <span id="review-jabatan-pindah-keluar">-</span>
                                        </p>
                                        <p><strong>Unit Kerja Asal:</strong> <span
                                                id="review-unit-kerja-pindah-keluar">-</span></p>
                                    </div>
                                    <div class="col-md-6">
                                        <p><strong>Pangkat/Gol:</strong> <span id="review-pangkat-pindah-keluar">-</span> /
                                            <span id="review-golongan-ruang-pindah-keluar">-</span></p>
                                        <div class="border-top pt-2 mt-2">
                                            <p class="text-primary fw-bold mb-1">Tujuan Pindah:</p>
                                            <p><strong>Instansi:</strong> <span
                                                    id="review-instansi-tujuan-pindah-keluar">-</span></p>
                                            <p><strong>Jabatan:</strong> <span
                                                    id="review-jabatan-tujuan-pindah-keluar">-</span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card border-0 bg-light mb-4">
                            <div class="card-body">
                                ...
                                <div id="review-documents-pindah-keluar" class="small"></div>
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function showStep(idx) {
                ...
                document.getElementById(`step-${idx}-pindah-keluar`).classList.add('active');
                for (let i = 0; i < idx; i++) {
            ...
            function validateStep(currentStep) {
                ...
                // VALIDASI STEP 1: Data Diri (Readonly) & Tujuan (Wajib)
                if (currentStep == 1) {
                    const nip = document.getElementById('nip_display_pindah_keluar').value.trim();
                    const instansiTujuan = document.getElementById('instansi_tujuan_pindah_keluar').value.trim();
                    const jabatanTujuan = document.getElementById('jabatan_tujuan_pindah_keluar').value.trim();

                    if (!nip || nip === '-') {
                        isValid = false;
                        errorMsg = 'Data Pegawai tidak ditemukan. Hubungi admin.';
                    } else if (!instansiTujuan || !jabatanTujuan) {
                        isValid = false;
                        errorMsg = 'Harap lengkapi Instansi Tujuan dan Jabatan Tujuan!';
                    }
                }

                // VALIDASI STEP 2: Dokumen Required
                if (currentStep == 2) {
                    const requiredInputs = document.querySelectorAll('#step-2-pindah-keluar input[type="file"][required]');
                    let emptyCount = 0;
            ...
            document.querySelectorAll('.btn-next-pindah-keluar').forEach(btn => {
            ...
            document.querySelectorAll('.btn-prev-pindah-keluar').forEach(btn => {
                btn.addEventListener('click', function () {
            ...
            function updateUploadProgress() {
                const allFileInputs = document.querySelectorAll('#step-2-pindah-keluar input[type="file"]');
                let filledCount = 0;
            ...
            // --- LOGIKA CEK NIP ---
            const btnCek = document.getElementById('btn-cek-nip-pindah-keluar');
            if (btnCek) {
                btnCek.addEventListener('click', function () {
                    const nip = document.getElementById('nip_pegawai_pindah_keluar').value;
                    if (!nip) {
                    ...
                    fetch(`{{ url('/kenaikan-pangkat/ajax/cek-nip') }}/${nip}`)
                        ...
                        .then(res => {
                            if (res.success) {
                                ...
                                set('nama_pegawai_pindah_keluar', d.nama);
                                set('jabatan_pindah_keluar', d.jabatan);
                                set('pangkat_pindah_keluar', d.pangkat);
                                set('nip_display_pindah_keluar', d.nip);
                                set('unit_kerja_pindah_keluar', d.unit_kerja);
                                set('golongan_ruang_pindah_keluar', d.golongan_ruang);
            ...
            function updateReview() {
                ...
                // Set Data Diri
                setText('review-nama-pindah-keluar', get('nama_pegawai_pindah_keluar'));
                setText('review-nip-pindah-keluar', get('nip_display_pindah_keluar'));
                setText('review-jabatan-pindah-keluar', get('jabatan_pindah_keluar'));
                setText('review-unit-kerja-pindah-keluar', get('unit_kerja_pindah_keluar'));
                setText('review-pangkat-pindah-keluar', get('pangkat_pindah_keluar'));
                setText('review-golongan-ruang-pindah-keluar', get('golongan_ruang_pindah_keluar'));

                // Set Data Tujuan
                setText('review-instansi-tujuan-pindah-keluar', get('instansi_tujuan_pindah_keluar'));
                setText('review-jabatan-tujuan-pindah-keluar', get('jabatan_tujuan_pindah_keluar'));
            ...
            // --- SUBMIT FORM ---
            document.getElementById('form-pindah-keluar').addEventListener('submit', function (e) {
