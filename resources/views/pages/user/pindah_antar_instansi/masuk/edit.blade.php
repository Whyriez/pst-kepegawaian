...
@section('title', 'Edit Pindah Masuk')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Edit Pindah Masuk Instansi</h2>
                    <p class="text-muted mb-0">Perbaiki data atau dokumen pengajuan pindah masuk Anda.</p>
                </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                {{-- ACTION FORM UPDATE --}}
                <form id="form-pindah-masuk"
                      action="{{ route('pindah.masuk.update', $pengajuan->id) }}"
                      method="POST"
                    ...
                    <div class="form-step active" id="step-1-pindah-masuk">
                        ...
                        {{-- Hidden NIP Display --}}
                        <input type="hidden" name="nip_display_pindah_masuk" value="{{ $pengajuan->pegawai->nip }}">

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Nama Pegawai</label>
                                <input type="text" class="form-control bg-light"
                                       id="nama_pegawai_pindah_masuk"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Jabatan Pegawai (Asal) <span class="text-danger">*</span></label>
                                <input type="text" class="form-control"
                                       id="jabatan_pindah_masuk" name="jabatan_pindah_masuk"
                                       value="{{ $pengajuan->data_tambahan['jabatan'] ?? '' }}" required>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label class="form-label">Unit Kerja Pegawai (Asal) <span class="text-danger">*</span></label>
                                <input type="text" class="form-control"
                                       id="unit_kerja_pindah_masuk" name="unit_kerja_pindah_masuk"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="pangkat_pindah_masuk" name="pangkat_pindah_masuk"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="golongan_ruang_pindah_masuk" name="golongan_ruang_pindah_masuk"
                        ...
                        <div class="step-header mb-4 mt-4 border-top pt-4">
                            ...
                            <p class="text-muted">Perbaiki usulan jabatan dan unit kerja tujuan jika diperlukan</p>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="usul_jabatan_pindah_masuk" name="usul_jabatan_pindah_masuk"
                                       value="{{ $pengajuan->data_tambahan['usul_jabatan'] ?? '' }}" required>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label class="form-label">Usul Unit Kerja <span class="text-danger">*</span></label>
                                <input type="text" class="form-control"
                                       id="usul_unit_kerja_pindah_masuk" name="usul_unit_kerja_pindah_masuk"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>NIP:</strong> <span id="review-nip-pindah-masuk">{{ $pengajuan->pegawai->nip }}</span></p>
                                        <p><strong>Jabatan Asal:</strong> <span id="review-jabatan-pindah-masuk">-</span></p>
                                        <p><strong>Unit Kerja Asal:</strong> <span id="review-unit-kerja-pindah-masuk">-</span></p>
                                    </div>
                                    <div class="col-md-6">
                                        <p><strong>Pangkat/Gol:</strong> <span id="review-pangkat-pindah-masuk">-</span> / <span id="review-golongan-ruang-pindah-masuk">-</span></p>
                                        <div class="border-top pt-2 mt-2">
                                            <p class="text-primary fw-bold mb-1">Usulan Baru:</p>
                                            <p><strong>Jabatan:</strong> <span id="review-usul-jabatan-pindah-masuk">-</span></p>
                                            <p><strong>Unit Kerja:</strong> <span id="review-usul-unit-kerja-pindah-masuk">-</span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.btn-next-pindah-masuk').forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    if (next === 3) {
                        ...
                        const reqInputs = document.querySelectorAll('#step-2-pindah-masuk input[type="file"][required]');
            ...
            function updateReview() {
                ...
                document.getElementById('review-jabatan-pindah-masuk').textContent = get('jabatan_pindah_masuk');
                document.getElementById('review-unit-kerja-pindah-masuk').textContent = get('unit_kerja_pindah_masuk');
                document.getElementById('review-pangkat-pindah-masuk').textContent = get('pangkat_pindah_masuk');
                document.getElementById('review-golongan-ruang-pindah-masuk').textContent = get('golongan_ruang_pindah_masuk');

                // Data Usulan
                document.getElementById('review-usul-jabatan-pindah-masuk').textContent = get('usul_jabatan_pindah_masuk');
                document.getElementById('review-usul-unit-kerja-pindah-masuk').textContent = get('usul_unit_kerja_pindah_masuk');

                // Review Dokumen
                const container = document.getElementById('review-documents-pindah-masuk');
                container.innerHTML = '';
