            ...
            <div class="card-body">
                ...
                <form id="form-pindah-masuk"
                    ...
                    <div class="form-step active" id="step-1-pindah-masuk">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Jabatan Pegawai (Asal) <span
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Unit Kerja Pegawai (Asal) <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>NIP:</strong> <span
                                                id="review-nip-pindah-masuk">{{ $pengajuan->pegawai->nip }}</span></p>
                                        <p><strong>Jabatan Asal:</strong> <span
                                                id="review-jabatan-pindah-masuk">-</span></p>
            ...
            document.querySelectorAll('.btn-next-pindah-masuk').forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    if (next === 3) {
                        ...
                        if (document.querySelectorAll('#step-2-pindah-masuk input.is-invalid').length > 0) {
                        ...
                        let valid = true;
                        document.querySelectorAll('#step-2-pindah-masuk input[type="file"][required]').forEach(input => {
                            if (input.files.length === 0) {
                                input.classList.add('is-invalid');
                                valid = false;
                            }
