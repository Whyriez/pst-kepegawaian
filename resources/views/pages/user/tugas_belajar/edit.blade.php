                    ...
                    <div class="form-step active" id="step-1-tugas-belajar">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control" id="jenis_tugas_belajar" name="jenis_tugas_belajar" required>
                                    <option value="">- Pilih Jenis -</option>
                                    @php $jenis = $pengajuan->data_tambahan['jenis_tugas_belajar'] ?? ''; @endphp
                                    <option value="Dalam Negeri" {{ $jenis == 'Dalam Negeri' ? 'selected' : '' }}>Dalam Negeri</option>
                                    <option value="Luar Negeri" {{ $jenis == 'Luar Negeri' ? 'selected' : '' }}>Luar Negeri</option>
                                    <option value="Program Kemitraan" {{ $jenis == 'Program Kemitraan' ? 'selected' : '' }}>Program Kemitraan</option>
                                    <option value="Beasiswa Pemerintah" {{ $jenis == 'Beasiswa Pemerintah' ? 'selected' : '' }}>Beasiswa Pemerintah</option>
                                    <option value="Beasiswa Swasta" {{ $jenis == 'Beasiswa Swasta' ? 'selected' : '' }}>Beasiswa Swasta</option>
                                </select>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="border-top pt-2 mt-2">
                                            ...
                                            <p><strong>Jenis:</strong> <span id="review-jenis-tugas-belajar">-</span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.btn-next-tugas-belajar').forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    if (next === 3) {
                        ...
                        const reqInputs = document.querySelectorAll('#step-2-tugas-belajar input[type="file"][required]');
            ...
            function updateReview() {
                ...
                document.getElementById('review-jenis-tugas-belajar').textContent = get('jenis_tugas_belajar');
