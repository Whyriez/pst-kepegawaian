...
@section('title', 'Edit Tugas Belajar')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Edit Pengajuan Tugas Belajar</h2>
                    <p class="text-muted mb-0">Perbaiki data atau dokumen pengajuan tugas belajar Anda.</p>
                </div>
                <a href="{{ route('tugas_belajar') }}" class="btn btn-secondary">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                {{-- ACTION FORM UPDATE --}}
                <form id="form-tugas-belajar"
                      action="{{ route('tugas_belajar.update', $pengajuan->id) }}"
                      method="POST"
                    ...
                    <div class="form-step active" id="step-1-tugas-belajar">
                        <div class="step-header mb-4">
                            ...
                            <p class="text-muted">Pastikan data pegawai dan rencana pendidikan sudah benar.</p>
                        </div>

                        {{-- Hidden NIP Display --}}
                        <input type="hidden" name="nip_display_tugas_belajar" value="{{ $pengajuan->pegawai->nip }}">

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Nama Pegawai</label>
                                <input type="text" class="form-control bg-light"
                                       id="nama_pegawai_tugas_belajar" name="nama_pegawai_tugas_belajar"
                                       value="{{ $pengajuan->data_tambahan['nama'] ?? $pengajuan->pegawai->nama_lengkap }}"
                                       readonly>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="jabatan_tugas_belajar" name="jabatan_tugas_belajar"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="pangkat_tugas_belajar" name="pangkat_tugas_belajar"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="satuan_kerja_tugas_belajar" name="satuan_kerja_tugas_belajar"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="golongan_ruang_tugas_belajar" name="golongan_ruang_tugas_belajar"
                        ...
                        <div class="step-header mb-4 mt-4 border-top pt-4">
                            ...
                            <p class="text-muted">Perbaiki jenis tugas belajar jika diperlukan</p>
                        </div>

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Jenis Tugas Belajar <span class="text-danger">*</span></label>
                                <select class="form-control" id="jenis_tugas_belajar" name="jenis_tugas_belajar"
                                        required>
                                    <option value="">- Pilih Jenis -</option>
                                    @php $jenis = $pengajuan->data_tambahan['jenis_tugas_belajar'] ?? ''; @endphp
                                    <option value="Dalam Negeri" {{ $jenis == 'Dalam Negeri' ? 'selected' : '' }}>Dalam
                                        Negeri
                                    </option>
                                    <option value="Luar Negeri" {{ $jenis == 'Luar Negeri' ? 'selected' : '' }}>Luar
                                        Negeri
                                    </option>
                                    <option
                                        value="Program Kemitraan" {{ $jenis == 'Program Kemitraan' ? 'selected' : '' }}>
                                        Program Kemitraan
                                    </option>
                                    <option
                                        value="Beasiswa Pemerintah" {{ $jenis == 'Beasiswa Pemerintah' ? 'selected' : '' }}>
                                        Beasiswa Pemerintah
                                    </option>
                                    <option value="Beasiswa Swasta" {{ $jenis == 'Beasiswa Swasta' ? 'selected' : '' }}>
                                        Beasiswa Swasta
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>Jabatan:</strong> <span id="review-jabatan-tugas-belajar">-</span>
                                        </p>
                                        <p><strong>Pangkat:</strong> <span id="review-pangkat-tugas-belajar">-</span>
                                        </p>
                                    </div>
                                    <div class="col-md-6">
                                        <p><strong>Satuan Kerja:</strong> <span
                                                id="review-satuan-kerja-tugas-belajar">-</span>
                                        </p>
                                        ...
                                        <div class="border-top pt-2 mt-2">
                                            ...
                                            <p><strong>Jenis:</strong> <span id="review-jenis-tugas-belajar">-</span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.btn-next-tugas-belajar').forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    if (next === 3) {
                        ...
                        if (document.querySelectorAll('#step-2-tugas-belajar input.is-invalid').length > 0) {
                        ...
                        let valid = true;
                        document.querySelectorAll('#step-2-tugas-belajar input[type="file"][required]').forEach(input => {
                            if (input.files.length === 0) {
                                input.classList.add('is-invalid');
                                valid = false;
                            }
            ...
            function updateReview() {
                ...
                document.getElementById('review-nip-tugas-belajar').textContent = get('nip_display_tugas_belajar');
                document.getElementById('review-jabatan-tugas-belajar').textContent = get('jabatan_tugas_belajar');
                document.getElementById('review-pangkat-tugas-belajar').textContent = get('pangkat_tugas_belajar');
                document.getElementById('review-satuan-kerja-tugas-belajar').textContent = get('satuan_kerja_tugas_belajar');
                document.getElementById('review-golongan-ruang-tugas-belajar').textContent = get('golongan_ruang_tugas_belajar');

                // Data Studi
                const pSelect = document.getElementById('jenis_tugas_belajar');
                document.getElementById('review-jenis-tugas-belajar').textContent = pSelect.options[pSelect.selectedIndex]?.text || '-';

                // Render List Dokumen
                const container = document.getElementById('review-documents-tugas-belajar');
                container.innerHTML = '';
