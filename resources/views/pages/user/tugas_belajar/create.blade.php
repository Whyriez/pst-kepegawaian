                    ...
                    <div class="form-step active" id="step-1-tugas-belajar">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_pegawai_tugas_belajar" class="form-label">Nama Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-user"></i></span>
                                    <input type="text" class="form-control bg-light" id="nama_pegawai_tugas_belajar"
                                           name="nama_pegawai_tugas_belajar"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="nip_display_tugas_belajar" class="form-label">NIP Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-id-card"></i></span>
                                    <input type="text" class="form-control bg-light" id="nip_display_tugas_belajar"
                                           name="nip_display_tugas_belajar"
                                           value="{{ $pegawai->nip ?? '-' }}"
                                           readonly>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="jabatan_tugas_belajar" class="form-label">Jabatan</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-briefcase"></i></span>
                                    <input type="text" class="form-control bg-light" id="jabatan_tugas_belajar"
                                           name="jabatan_tugas_belajar"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="pangkat_tugas_belajar" class="form-label">Pangkat</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-star"></i></span>
                                    <input type="text" class="form-control bg-light" id="pangkat_tugas_belajar"
                                           name="pangkat_tugas_belajar"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="satuan_kerja_tugas_belajar" class="form-label">Satuan Kerja</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-building"></i></span>
                                    <input type="text" class="form-control bg-light" id="satuan_kerja_tugas_belajar"
                                           name="satuan_kerja_tugas_belajar"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="golongan_ruang_tugas_belajar" class="form-label">Golongan/Ruang</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-layer-group"></i></span>
                                    <input type="text" class="form-control bg-light" id="golongan_ruang_tugas_belajar"
                                           name="golongan_ruang_tugas_belajar"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function validateStep(currentStep) {
                ...
                // VALIDASI STEP 1: Data Diri (Readonly) & Jenis (Wajib)
                if (currentStep == 1) {
                    const nip = document.getElementById('nip_display_tugas_belajar').value.trim();
