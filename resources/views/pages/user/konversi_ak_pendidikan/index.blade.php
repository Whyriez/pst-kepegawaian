...
@section('title', 'Riwayat Konversi AK Pendidikan')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Konversi Angka Kredit Pendidikan</h2>
                    <p class="text-muted mb-0">Riwayat pengajuan konversi angka kredit pendidikan.</p>
                </div>
                <a href="{{ route('konversi_ak_pendidikan.create') }}" class="btn btn-primary shadow-sm">
                    <i class="fas fa-exchange-alt me-2"></i>Ajukan Konversi
                </a>
            </div>
        </div>
                                            ...
                                            @if(in_array($item->status, ['pending', 'perbaikan']))
                                                ...
                                                <li>
                                                    <a class="dropdown-item fw-bold text-warning"
                                                       href="{{ route('konversi_ak_pendidikan.edit', ['id' => $item->id]) }}">
                            ...
                            <tr>
                                <td colspan="4" class="text-center py-5">
                                    <div class="py-4">
                                        ...
                                        <a href="{{ route('konversi_ak_pendidikan.create') }}" class="btn btn-sm btn-primary mt-2">
                                            Ajukan Sekarang
                                        </a>
                                    </div>
                                </td>
                ...
                html: `
                    <div class="text-start">
                        <table class="table table-sm table-borderless">
                            <tr><td width="35%"><strong>Layanan</strong></td><td>: Konversi AK Pendidikan</td></tr>
