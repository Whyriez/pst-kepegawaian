                    ...
                    <div class="form-step active" id="step-1-konversi-ak-pendidikan">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_pegawai_konversi_ak_pendidikan" class="form-label">Nama Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-user"></i></span>
                                    <input type="text" class="form-control bg-light" id="nama_pegawai_konversi_ak_pendidikan"
                                           name="nama_pegawai_konversi_ak_pendidikan"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="nip_display_konversi_ak_pendidikan" class="form-label">NIP Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-id-card"></i></span>
                                    <input type="text" class="form-control bg-light" id="nip_display_konversi_ak_pendidikan"
                                           name="nip_display_konversi_ak_pendidikan"
                                           value="{{ $pegawai->nip ?? '-' }}"
                                           readonly>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="jabatan_konversi_ak_pendidikan" class="form-label">Jabatan Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-briefcase"></i></span>
                                    <input type="text" class="form-control bg-light" id="jabatan_konversi_ak_pendidikan"
                                           name="jabatan_konversi_ak_pendidikan"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="pangkat_konversi_ak_pendidikan" class="form-label">Pangkat Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-star"></i></span>
                                    <input type="text" class="form-control bg-light" id="pangkat_konversi_ak_pendidikan"
                                           name="pangkat_konversi_ak_pendidikan"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="satuan_kerja_konversi_ak_pendidikan" class="form-label">Satuan Kerja</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-building"></i></span>
                                    <input type="text" class="form-control bg-light" id="satuan_kerja_konversi_ak_pendidikan"
                                           name="satuan_kerja_konversi_ak_pendidikan"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="golongan_ruang_konversi_ak_pendidikan" class="form-label">Golongan/Ruang</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-layer-group"></i></span>
                                    <input type="text" class="form-control bg-light" id="golongan_ruang_konversi_ak_pendidikan"
                                           name="golongan_ruang_konversi_ak_pendidikan"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function validateStep(currentStep) {
                ...
                if (currentStep == 1) {
                    const nip = document.getElementById('nip_display_konversi_ak_pendidikan').value.trim();
                    if (!nip || nip === '-') {
                        isValid = false;
