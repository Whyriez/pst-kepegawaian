            ...
            <div class="card-body">
                ...
                <form id="form-konversi-ak-pendidikan"
                    ...
                    <div class="form-step active" id="step-1-konversi-ak-pendidikan">
                        ...
                        {{-- Hidden NIP Display --}}
                        <input type="hidden" name="nip_display_konversi_ak_pendidikan"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control bg-light"
                                       id="nama_pegawai_konversi_ak_pendidikan"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="satuan_kerja_konversi_ak_pendidikan"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="golongan_ruang_konversi_ak_pendidikan"
                    ...
                    <div class="form-step" id="step-3-konversi-ak-pendidikan">
                        ...
                        <div class="card border-0 bg-light mb-4">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <p><strong>Nama:</strong> <span id="review-nama-konversi-ak-pendidikan">-</span>
                                        </p>
                                        <p><strong>NIP:</strong> <span id="review-nip-konversi-ak-pendidikan">-</span>
                                        </p>
                                        <p><strong>Jabatan:</strong> <span
                                                id="review-jabatan-konversi-ak-pendidikan">-</span></p>
                                    </div>
                                    <div class="col-md-6">
                                        <p><strong>Pangkat:</strong> <span
                                                id="review-pangkat-konversi-ak-pendidikan">-</span></p>
                                        <p><strong>Satuan Kerja:</strong> <span
                                                id="review-satuan-kerja-konversi-ak-pendidikan">-</span></p>
                                        <p><strong>Golongan/Ruang:</strong> <span
                                                id="review-golongan-ruang-konversi-ak-pendidikan">-</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-check mb-4">
                            <input class="form-check-input" type="checkbox" id="confirm-data-konversi-ak-pendidikan"
                                   required>
            ...
            document.querySelectorAll('.btn-next-konversi-ak-pendidikan').forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    if (next === 3) {
                        ...
                        if (document.querySelectorAll('#step-2-konversi-ak-pendidikan input.is-invalid').length > 0) {
                        ...
                        let valid = true;
                        document.querySelectorAll('#step-2-konversi-ak-pendidikan input[type="file"][required]').forEach(input => {
                            if (input.files.length === 0) {
                                input.classList.add('is-invalid');
                                valid = false;
                            }
