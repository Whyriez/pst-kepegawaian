...
@section('content')
    <div class="container-fluid p-0">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                ...
                <form id="form-kp-penyesuaian-ijazah" action="{{ route('kp.penyesuaian_ijazah.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-step active" id="step-1-kp-penyesuaian-ijazah">
                            ...
                            <div class="card-body">
                                ...
                                <div class="input-group w-75">
                                    <input type="text" class="form-control" id="nip_pegawai_kp_penyesuaian_ijazah" 
                                           placeholder="Masukkan NIP" value="{{ Auth::user()->pegawai->nip ?? '' }}">
                                    <button class="btn btn-outline-primary" type="button" id="btn-cek-nip-kp-penyesuaian-ijazah">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="nama_pegawai_kp_penyesuaian_ijazah" name="nama_pegawai_kp_penyesuaian_ijazah" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Jabatan Pegawai <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="jabatan_kp_penyesuaian_ijazah" name="jabatan_kp_penyesuaian_ijazah" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="pangkat_kp_penyesuaian_ijazah" name="pangkat_kp_penyesuaian_ijazah" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">NIP Pegawai <span class="text-danger">*</span></label>
                                <input type="text" class="form-control bg-light" id="nip_display_kp_penyesuaian_ijazah" name="nip_display_kp_penyesuaian_ijazah" required readonly>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="unit_kerja_kp_penyesuaian_ijazah" name="unit_kerja_kp_penyesuaian_ijazah" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Golongan Ruang <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="golongan_ruang_kp_penyesuaian_ijazah" name="golongan_ruang_kp_penyesuaian_ijazah" required>
                            </div>
                        </div>

                        <div class="d-flex justify-content-end mt-4">
                            <button type="button" class="btn btn-primary btn-next-kp-penyesuaian-ijazah" data-next="2">Lanjut <i class="fas fa-arrow-right ms-2"></i></button>
                        </div>
                    </div>
                    ...
                    <div class="form-step" id="step-2-kp-penyesuaian-ijazah">
                        ...
                        {{-- LOOPING DOKUMEN DARI CONTROLLER --}}
                        <div class="row">
                            ...
                            @empty
                                <div class="col-12"><div class="alert alert-warning">Belum ada syarat dokumen di database untuk layanan ini.</div></div>
                            @endforelse
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-control" id="periode_kenaikan_pangkat_kp_penyesuaian_ijazah" name="periode_kenaikan_pangkat_kp_penyesuaian_ijazah" required>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <button type="button" class="btn btn-outline-secondary btn-prev-kp-penyesuaian-ijazah" data-prev="1">Kembali</button>
                            <button type="button" class="btn btn-primary btn-next-kp-penyesuaian-ijazah" data-next="3">Lanjut</button>
                        </div>
                    </div>
                    ...
                    <div class="form-step" id="step-3-kp-penyesuaian-ijazah">
                        <div class="step-header mb-4">
                            ...
                            <p class="text-muted">Pastikan data sudah benar sebelum dikirim.</p>
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            <button type="button" class="btn btn-outline-secondary btn-prev-kp-penyesuaian-ijazah" data-prev="2">Kembali</button>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // --- SWAL NOTIFIKASI DARI CONTROLLER ---
        @if(session('success'))
        ...
        @endif
        @if($errors->any())
            Swal.fire('Validasi Gagal', 'Cek kembali inputan Anda', 'warning');
        @endif
        ...
        document.querySelectorAll('.btn-next-kp-penyesuaian-ijazah').forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                if(next == 2 && !document.getElementById('nama_pegawai_kp_penyesuaian_ijazah').value) {
                    Swal.fire('Data Kosong', 'Silakan Cek NIP terlebih dahulu!', 'warning'); return;
                }
                showStep(next);
            });
        });
        ...
        function updateReview() {
            ...
            document.getElementById('rev-nama').textContent = get('nama_pegawai_kp_penyesuaian_ijazah');
            document.getElementById('rev-nip').textContent = get('nip_display_kp_penyesuaian_ijazah');
            document.getElementById('rev-jabatan').textContent = get('jabatan_kp_penyesuaian_ijazah');
            document.getElementById('rev-unit').textContent = get('unit_kerja_kp_penyesuaian_ijazah');
            
            const periode = document.getElementById('periode_kenaikan_pangkat_kp_penyesuaian_ijazah');
            ...
            document.querySelectorAll('input[type="file"]').forEach(input => {
                if(input.files.length > 0) {
                    ...
                    docList.innerHTML += `<div><i class="fas fa-check"></i> ${label}: ${name}</div>`;
                }
            });
        }
        ...
        document.getElementById('form-kp-penyesuaian-ijazah').addEventListener('submit', function(e) {
            if(!document.getElementById('confirm-data').checked) {
                ...
                // JANGAN ADA e.preventDefault() DI SINI AGAR FORM TERKIRIM
                Swal.fire({
