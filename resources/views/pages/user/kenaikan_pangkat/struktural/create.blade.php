...
@section('content')
    <div class="container-fluid p-0">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                {{-- ACTION FORM --}}
                <form id="form-kp-struktural" action="{{ route('kp.struktural.store') }}" method="POST"
                    ...
                    <div class="form-step" id="step-2-kp-struktural">
                                ...
                                <div>
                                    ...
                                    <div class="mt-2">
                                        <small class="text-muted">
                                            ...
                                            <span id="upload-progress-kp-struktural">0/{{ count($syarat) }}</span>
                                            dokumen terunggah
                                        </small>
                                    </div>
                                </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6 mb-3">
                                <label for="periode_kenaikan_pangkat_kp_struktural" class="form-label">Periode Kenaikan
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            <button type="button" class="btn btn-outline-secondary btn-prev-kp-struktural"
                                    data-prev="1">
                                <i class="fas fa-arrow-left me-2"></i>Kembali
                            </button>
                    ...
                    <div class="form-step" id="step-3-kp-struktural">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>NIP:</strong> <span id="review-nip-kp-struktural">-</span></p>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>Golongan/Ruang:</strong> <span
                                                id="review-golongan-ruang-kp-struktural">-</span></p>
                                        <div class="border-top pt-2 mt-2">
                                            <p class="text-primary fw-bold mb-1">Periode:</p>
                                            <p><strong>Bulan:</strong> <span id="review-periode-kp-struktural">-</span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            ...
                            <button type="submit" class="btn btn-success">
                                <i class="fas fa-paper-plane me-2"></i>Ajukan KP Struktural
                            </button>
                        </div>
                    </div>
                </form>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function validateStep(currentStep) {
                ...
                if (currentStep == 1) {
                    const nama = document.getElementById('nama_pegawai_kp_struktural').value.trim();
                    if (!nama) {
                        isValid = false;
                ...
                if (currentStep == 2) {
                    // Cek Periode
                    const periode = document.getElementById('periode_kenaikan_pangkat_kp_struktural').value;
                    if (!periode) {
                        isValid = false;
                        errorMsg = 'Silakan pilih Periode Kenaikan Pangkat!';
                    } else {
                        // Cek File Required
                        const requiredInputs = document.querySelectorAll('#step-2-kp-struktural input[type="file"][required]');
                        let emptyCount = 0;
            ...
            function updateUploadProgress() {
                const allFileInputs = document.querySelectorAll('#step-2-kp-struktural input[type="file"]');
                let filledCount = 0;
                allFileInputs.forEach(input => {
                    if (input.files.length > 0) filledCount++;
                });
                const progressEl = document.getElementById('upload-progress-kp-struktural');
            ...
            function updateReview() {
                ...
                setText('review-nama-kp-struktural', get('nama_pegawai_kp_struktural'));
                setText('review-nip-kp-struktural', get('nip_display_kp_struktural'));
                setText('review-jabatan-kp-struktural', get('jabatan_kp_struktural'));
                setText('review-unit-kerja-kp-struktural', get('unit_kerja_kp_struktural'));
                setText('review-pangkat-kp-struktural', get('pangkat_kp_struktural'));
                setText('review-golongan-ruang-kp-struktural', get('golongan_ruang_kp_struktural'));

                const periodeSelect = document.getElementById('periode_kenaikan_pangkat_kp_struktural');
                const periodeText = periodeSelect.options[periodeSelect.selectedIndex]?.text || '-';
                setText('review-periode-kp-struktural', periodeText);

                // Smart Icon Logic
                const docContainer = document.getElementById('review-documents-kp-struktural');
            ...
            document.getElementById('form-kp-struktural').addEventListener('submit', function (e) {
                if (!document.getElementById('confirm-data-kp-struktural').checked) {
                    e.preventDefault();
