    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.btn-next-kp-struktural').forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    if (next === 3) {
                        ...
                        const reqInputs = document.querySelectorAll('#step-2-kp-struktural input[type="file"][required]');
            ...
            function updateReview() {
                ...
                document.getElementById('review-nama-kp-struktural').textContent = get('nama_pegawai_kp_struktural') || '{{ $pengajuan->pegawai->nama_lengkap }}';
                ...
                document.getElementById('review-periode-kp-struktural').textContent = document.getElementById('periode_kenaikan_pangkat_kp_struktural').value;
