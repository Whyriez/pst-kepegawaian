...
@section('title', 'Riwayat KP Struktural')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Kenaikan Pangkat Struktural</h2>
                    <p class="text-muted mb-0">Kelola dan pantau pengajuan KP Struktural Anda.</p>
                </div>
                <a href="{{ route('kp.struktural.create') }}" class="btn btn-primary shadow-sm">
                    <i class="fas fa-plus-circle me-2"></i>Ajukan KP Struktural
                </a>
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white py-3">
                <h5 class="card-title mb-0 fw-bold"><i class="fas fa-history me-2 text-primary"></i>Riwayat KP Struktural</h5>
            </div>
                                            ...
                                            @if(in_array($item->status, ['pending', 'perbaikan']))
                                                ...
                                                <li>
                                                    <a class="dropdown-item fw-bold text-warning"
                                                       href="{{ route('kp.struktural.edit', ['id' => $item->id]) }}">
                            ...
                            <tr>
                                <td colspan="6" class="text-center py-5">
                                    <div class="py-4">
                                        ...
                                        <h6 class="text-muted fw-bold">Belum ada pengajuan KP Struktural</h6>
                                        <p class="text-muted small mb-3">Mulai pengajuan kenaikan pangkat struktural Anda di sini.</p>
                                        <a href="{{ route('kp.struktural.create') }}" class="btn btn-sm btn-primary">
                                            Ajukan Sekarang
                                        </a>
                                    </div>
                                </td>
                ...
                html: `
                    <div class="text-start">
                        <table class="table table-sm table-borderless">
                            <tr><td width="30%"><strong>Layanan</strong></td><td>: KP Struktural</td></tr>
