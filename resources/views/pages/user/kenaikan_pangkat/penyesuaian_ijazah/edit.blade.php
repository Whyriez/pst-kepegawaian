...
@section('title', 'Edit KP Penyesuaian Ijazah')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Edit Penyesuaian Ijazah</h2>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                {{-- ACTION FORM --}}
                <form id="form-kp-penyesuaian-ijazah"
                      action="{{ route('kp.penyesuaian_ijazah.update', $pengajuan->id) }}"
                      method="POST"
                    ...
                    <div class="form-step active" id="step-1-kp-penyesuaian-ijazah">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control bg-light"
                                       id="nama_pegawai_kp_penyesuaian_ijazah"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="unit_kerja_kp_penyesuaian_ijazah"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="golongan_ruang_kp_penyesuaian_ijazah"
                    ...
                    <div class="form-step" id="step-2-kp-penyesuaian-ijazah">
                        ...
                        <div class="alert alert-warning">
                            ...
                            Biarkan kosong jika tidak ingin mengganti dokumen yang sudah ada.
                        </div>
