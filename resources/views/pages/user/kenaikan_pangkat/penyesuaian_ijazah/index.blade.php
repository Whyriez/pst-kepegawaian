...
@section('title', 'Riwayat KP Penyesuaian Ijazah')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Penyesuaian Ijazah</h2>
                    <p class="text-muted mb-0">Kelola pengajuan Kenaikan Pangkat Penyesuaian Ijazah (PI).</p>
                </div>
                <a href="{{ route('kp.penyesuaian_ijazah.create') }}" class="btn btn-primary shadow-sm">
                    <i class="fas fa-plus-circle me-2"></i>Ajukan Penyesuaian Ijazah
                </a>
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white py-3">
                <h5 class="card-title mb-0 fw-bold"><i class="fas fa-history me-2 text-primary"></i>Riwayat Pengajuan PI
                </h5>
            </div>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        @forelse($pengajuans as $item)
                            <tr>
                                ...
                                {{-- 2. Golongan Diusulkan (Diambil dari Data Tambahan JSON) --}}
                                <td>
                                ...
                                <td class="text-end px-3">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0">
                                            ...
                                            {{-- Edit (Muncul jika Pending/Perbaikan) --}}
                                            @if(in_array($item->status, ['pending', 'perbaikan']))
                                                ...
                                                <li>
                                                    <a class="dropdown-item fw-bold text-warning"
                                                       href="{{ route('kp.penyesuaian_ijazah.edit', ['id' => $item->id]) }}">
                            ...
                            <tr>
                                <td colspan="6" class="text-center py-5">
                                    <div class="py-4">
                                        ...
                                        <h6 class="text-muted fw-bold">Belum ada pengajuan PI</h6>
                                        <p class="text-muted small mb-3">Mulai ajukan Penyesuaian Ijazah Anda
                                            sekarang.</p>
                                        <a href="{{ route('kp.penyesuaian_ijazah.create') }}"
                ...
                html: `
                    <div class="text-start">
                        <table class="table table-sm table-borderless">
                            <tr><td width="30%"><strong>Layanan</strong></td><td>: Penyesuaian Ijazah</td></tr>
