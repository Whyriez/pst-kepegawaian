    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('kp.penyesuaian_ijazah') }}" class="btn btn-secondary">
            ...
            <div class="card-body">
                ...
                <form id="form-kp-penyesuaian-ijazah" action="{{ route('kp.penyesuaian_ijazah.store') }}" method="POST"
                    ...
                    <div class="form-step active" id="step-1-kp-penyesuaian-ijazah">
                        ...
                        {{-- CARD CEK NIP DIHAPUS, GANTI TAMPILAN LANGSUNG --}}

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_pegawai_kp_penyesuaian_ijazah" class="form-label">Nama Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-user"></i></span>
                                    <input type="text" class="form-control bg-light" id="nama_pegawai_kp_penyesuaian_ijazah"
                                           name="nama_pegawai_kp_penyesuaian_ijazah"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="jabatan_kp_penyesuaian_ijazah" class="form-label">Jabatan Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-briefcase"></i></span>
                                    <input type="text" class="form-control bg-light" id="jabatan_kp_penyesuaian_ijazah"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="pangkat_kp_penyesuaian_ijazah" class="form-label">Pangkat Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-star"></i></span>
                                    <input type="text" class="form-control bg-light" id="pangkat_kp_penyesuaian_ijazah"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="nip_display_kp_penyesuaian_ijazah" class="form-label">NIP Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-id-card"></i></span>
                                    <input type="text" class="form-control bg-light" id="nip_display_kp_penyesuaian_ijazah"
                                           name="nip_display_kp_penyesuaian_ijazah"
                                           value="{{ $pegawai->nip ?? '-' }}"
                                           readonly>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="unit_kerja_kp_penyesuaian_ijazah" class="form-label">Unit Kerja</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-building"></i></span>
                                    <input type="text" class="form-control bg-light" id="unit_kerja_kp_penyesuaian_ijazah"
                                           name="unit_kerja_kp_penyesuaian_ijazah"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="golongan_ruang_kp_penyesuaian_ijazah" class="form-label">Golongan Ruang</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-layer-group"></i></span>
                                    <input type="text" class="form-control bg-light" id="golongan_ruang_kp_penyesuaian_ijazah"
                                           name="golongan_ruang_kp_penyesuaian_ijazah"
                            ...
                            @empty
                                <div class="col-12">
                                    <div class="alert alert-warning">
                                        Belum ada syarat dokumen yang diatur di database untuk layanan ini (kp-penyesuaian-ijazah).
                                    </div>
                                </div>
                            @endforelse
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function validateStep(currentStep) {
                ...
                // VALIDASI STEP 1: Data Diri (Cek NIP Terisi dari Database)
                if (currentStep == 1) {
                    const nip = document.getElementById('nip_display_kp_penyesuaian_ijazah').value.trim();
                    if (!nip || nip === '-') {
                        isValid = false;
            ...
            function handleFileUpload(input) {
                ...
                // Jika tidak ada data-attribute, default ke 2MB (2048 KB)
                const dbMaxSizeKb = parseInt(input.getAttribute('data-max-size')) || 2048;
                const maxSizeBytes = dbMaxSizeKb * 1024;

                // Ambil allowed types, misal "pdf,jpg" -> array ["pdf", "jpg"]
