...
@section('title', 'Riwayat KP Fungsional')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Kenaikan Pangkat Fungsional</h2>
                    <p class="text-muted mb-0">Kelola dan pantau pengajuan KP Fungsional Anda.</p>
                </div>
                <a href="{{ route('kp.fungsional.create') }}" class="btn btn-primary shadow-sm">
                    <i class="fas fa-plus-circle me-2"></i>Ajukan KP Fungsional
                </a>
            </div>
        </div>
            ...
            <div class="col-md-3 col-sm-6 mb-3">
                <div class="card border-0 shadow-sm card-status border-start border-primary border-4">
                    <div class="card-body">
                        ...
                        <div class="h2 mb-0 fw-bold text-dark">{{ $pengajuans->count() }}</div>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 mb-3">
            ...
            Swal.fire({
                ...
                html: `
                    <div class="text-start">
                        ...
                        <hr>
                        <p class="mb-1 fw-bold">Catatan Lengkap:</p>
                        <div class="alert alert-light border p-3 bg-light">
                            ${catatan}
                        </div>
                    </div>
                `,
