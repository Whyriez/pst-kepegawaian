...
@section('title', 'Kenaikan Pangkat Reguler')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Form KP Reguler</h2>
                    <p class="text-muted mb-0">Formulir untuk kenaikan pangkat reguler</p>
                </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                {{-- ACTION FORM --}}
                <form id="form-kp-reguler" action="{{ route('kp.reguler.store') }}" method="POST"
                    ...
                    <div class="form-step active" id="step-1-kp-reguler">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_pegawai_kp_reguler" class="form-label">Nama Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-user"></i></span>
                                    <input type="text" class="form-control bg-light" id="nama_pegawai_kp_reguler"
                                           name="nama_pegawai_kp_reguler"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="jabatan_kp_reguler" class="form-label">Jabatan Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-briefcase"></i></span>
                                    <input type="text" class="form-control bg-light" id="jabatan_kp_reguler"
                                           name="jabatan_kp_reguler"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="pangkat_kp_reguler" class="form-label">Pangkat Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-star"></i></span>
                                    <input type="text" class="form-control bg-light" id="pangkat_kp_reguler"
                                           name="pangkat_kp_reguler"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="nip_display_kp_reguler" class="form-label">NIP Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-id-card"></i></span>
                                    <input type="text" class="form-control bg-light" id="nip_display_kp_reguler"
                                           name="nip_display_kp_reguler"
                                           value="{{ $pegawai->nip ?? '-' }}"
                                           readonly>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="unit_kerja_kp_reguler" class="form-label">Unit Kerja</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-building"></i></span>
                                    <input type="text" class="form-control bg-light" id="unit_kerja_kp_reguler"
                                           name="unit_kerja_kp_reguler"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="golongan_ruang_kp_reguler" class="form-label">Golongan Ruang</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-layer-group"></i></span>
                                    <input type="text" class="form-control bg-light" id="golongan_ruang_kp_reguler"
                                           name="golongan_ruang_kp_reguler"
                    ...
                    <div class="form-step" id="step-2-kp-reguler">
                        <div class="step-header mb-4">
                            <h5 class="fw-bold text-primary mb-2"><i class="fas fa-file-upload me-2"></i>Upload Dokumen
                            </h5>
                        ...
                        @php
                            ...
                            // 2. Cari ukuran file TERBESAR di antara semua dokumen
                                ...
                                <div>
                                    ...
                                    <div class="mt-2">
                                        <small class="text-muted">
                                            ...
                                            <span id="upload-progress-kp-reguler">0/{{ count($syarat) }}</span> dokumen
                                            terunggah
                                        </small>
                                    </div>
                                </div>
                            ...
                            @forelse($syarat as $dokumen)
                                <div class="col-md-6 mb-3">
                                    <div class="file-upload-card h-100">
                                        ...
                                        {{-- Logic accept attribute (tambah titik, misal: .pdf,.jpg) --}}
                                        @php
                            ...
                            @empty
                                <div class="col-12">
                                    <div class="alert alert-warning">
                                        Belum ada syarat dokumen yang diatur di database untuk layanan ini (kp-reguler).
                                    </div>
                                </div>
                            @endforelse
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6 mb-3">
                                <label for="periode_kenaikan_pangkat_kp_reguler" class="form-label">Periode Kenaikan
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            <button type="button" class="btn btn-outline-secondary btn-prev-kp-reguler"
                                    data-prev="1">
                                <i class="fas fa-arrow-left me-2"></i>Kembali
                            </button>
                    ...
                    <div class="form-step" id="step-3-kp-reguler">
                        <div class="step-header mb-4">
                            <h5 class="fw-bold text-primary mb-2"><i class="fas fa-check-circle me-2"></i>Konfirmasi
                            </h5>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>NIP:</strong> <span id="review-nip-kp-reguler">-</span></p>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>Pangkat/Gol:</strong> <span id="review-pangkat-kp-reguler">-</span> /
                                            <span id="review-golongan-ruang-kp-reguler">-</span></p>
                                        <div class="border-top pt-2 mt-2">
                                            <p class="text-primary fw-bold mb-1">Periode:</p>
                                            <p><strong>Bulan:</strong> <span id="review-periode-kp-reguler">-</span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            ...
                            <button type="submit" class="btn btn-success">
                                <i class="fas fa-paper-plane me-2"></i>Ajukan KP Reguler
                            </button>
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function validateStep(currentStep) {
                ...
                // VALIDASI STEP 1: Data Diri (Cek apakah NIP terisi dari DB)
                if (currentStep == 1) {
                    const nip = document.getElementById('nip_display_kp_reguler').value.trim();
                    if (!nip || nip === '-') {
                        isValid = false;
                ...
                if (currentStep == 2) {
                    // Cek Periode
                    const periode = document.getElementById('periode_kenaikan_pangkat_kp_reguler').value;
                    if (!periode) {
                        isValid = false;
                        errorMsg = 'Silakan pilih Periode Kenaikan Pangkat!';
                    } else {
                        // Cek File Required
                        const requiredInputs = document.querySelectorAll('#step-2-kp-reguler input[type="file"][required]');
                        let emptyCount = 0;
            ...
            function handleFileUpload(input) {
                ...
                // Jika tidak ada (error fallback), default ke 2MB
            ...
            function updateUploadProgress() {
                const allFileInputs = document.querySelectorAll('#step-2-kp-reguler input[type="file"]');
                let filledCount = 0;
                allFileInputs.forEach(input => {
                    if (input.files.length > 0) filledCount++;
                });
                const progressEl = document.getElementById('upload-progress-kp-reguler');
            ...
            // --- LOGIKA CEK NIP ---
            const btnCek = document.getElementById('btn-cek-nip-kp-reguler');
            if (btnCek) {
                btnCek.addEventListener('click', function () {
                    const nip = document.getElementById('nip_pegawai_kp_reguler').value;
                    if (!nip) {
                    ...
                    fetch(`{{ url('/kenaikan-pangkat/ajax/cek-nip') }}/${nip}`)
                        ...
                        .then(res => {
                            if (res.success) {
                                ...
                                set('nama_pegawai_kp_reguler', d.nama);
                                set('jabatan_kp_reguler', d.jabatan);
                                set('pangkat_kp_reguler', d.pangkat);
                                set('nip_display_kp_reguler', d.nip);
                                set('unit_kerja_kp_reguler', d.unit_kerja);
                                set('golongan_ruang_kp_reguler', d.golongan_ruang);
            ...
            function updateReview() {
                ...
                setText('review-nama-kp-reguler', get('nama_pegawai_kp_reguler'));
                setText('review-nip-kp-reguler', get('nip_display_kp_reguler'));
                setText('review-jabatan-kp-reguler', get('jabatan_kp_reguler'));
                setText('review-unit-kerja-kp-reguler', get('unit_kerja_kp_reguler'));
                setText('review-pangkat-kp-reguler', get('pangkat_kp_reguler'));
                setText('review-golongan-ruang-kp-reguler', get('golongan_ruang_kp_reguler'));

                const periodeSelect = document.getElementById('periode_kenaikan_pangkat_kp_reguler');
                const periodeText = periodeSelect.options[periodeSelect.selectedIndex]?.text || '-';
                setText('review-periode-kp-reguler', periodeText);

                // Smart Icon Logic
                const docContainer = document.getElementById('review-documents-kp-reguler');
            ...
            // --- SUBMIT FORM ---
            document.getElementById('form-kp-reguler').addEventListener('submit', function (e) {
                if (!document.getElementById('confirm-data-kp-reguler').checked) {
                    e.preventDefault();
