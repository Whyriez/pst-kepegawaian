                ...
                <form id="form-kp-reguler" action="{{ route('kp.reguler.store') }}" method="POST"
                    ...
                    <div class="form-step active" id="step-1-kp-reguler">
                        <div class="step-header mb-4">
                            ...
                            <p class="text-muted">Isi data diri pegawai yang mengajukan kenaikan pangkat reguler</p>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="nip_pegawai_kp_reguler"
                                                   name="nip_pegawai_kp_reguler" placeholder="Masukkan NIP Pegawai"
                                                   value="{{ Auth::user()->pegawai->nip ?? '' }}">
                                            <button class="btn btn-outline-primary" type="button"
                                                    id="btn-cek-nip-kp-reguler">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_pegawai_kp_reguler" class="form-label">Nama Pegawai <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-user"></i></span>
                                    <input type="text" class="form-control" id="nama_pegawai_kp_reguler"
                                           name="nama_pegawai_kp_reguler" required>
                                </div>
                                <div class="invalid-feedback">Harap isi nama pegawai</div>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="jabatan_kp_reguler" class="form-label">Jabatan Pegawai <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-briefcase"></i></span>
                                    <input type="text" class="form-control" id="jabatan_kp_reguler"
                                           name="jabatan_kp_reguler" required>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="pangkat_kp_reguler" class="form-label">Pangkat Pegawai <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-star"></i></span>
                                    <input type="text" class="form-control" id="pangkat_kp_reguler"
                                           name="pangkat_kp_reguler" required>
                                </div>
                                <div class="invalid-feedback">Harap isi pangkat pegawai</div>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="nip_display_kp_reguler" class="form-label">NIP Pegawai <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-id-card"></i></span>
                                    <input type="text" class="form-control bg-light" id="nip_display_kp_reguler"
                                           name="nip_display_kp_reguler" required readonly>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="unit_kerja_kp_reguler" class="form-label">Unit Kerja <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-building"></i></span>
                                    <input type="text" class="form-control" id="unit_kerja_kp_reguler"
                                           name="unit_kerja_kp_reguler" required>
                                </div>
                                <div class="invalid-feedback">Harap isi unit kerja</div>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="golongan_ruang_kp_reguler" class="form-label">Golongan Ruang <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-layer-group"></i></span>
                                    <input type="text" class="form-control" id="golongan_ruang_kp_reguler"
                                           name="golongan_ruang_kp_reguler" required>
                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function validateStep(currentStep) {
                ...
                if (currentStep == 1) {
                    const nama = document.getElementById('nama_pegawai_kp_reguler').value.trim();
                    if (!nama) {
                        isValid = false;
