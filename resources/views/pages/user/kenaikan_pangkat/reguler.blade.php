...
@section('content')
    <div class="container-fluid p-0">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                {{-- REAL FORM ACTION --}}
                <form id="form-kp-reguler" action="{{ route('kp.reguler.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-step active" id="step-1-kp-reguler">
                        ...
                        <div class="card bg-light border-0 mb-4">
                            <div class="card-body">
                                ...
                                <div class="input-group w-75">
                                    ...
                                    <button class="btn btn-outline-primary" type="button" id="btn-cek-nip-kp-reguler">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="nama_pegawai_kp_reguler" name="nama_pegawai_kp_reguler" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Jabatan Pegawai <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="jabatan_kp_reguler" name="jabatan_kp_reguler" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="pangkat_kp_reguler" name="pangkat_kp_reguler" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">NIP Pegawai <span class="text-danger">*</span></label>
                                <input type="text" class="form-control bg-light" id="nip_display_kp_reguler" name="nip_display_kp_reguler" required readonly>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="unit_kerja_kp_reguler" name="unit_kerja_kp_reguler" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Golongan Ruang <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="golongan_ruang_kp_reguler" name="golongan_ruang_kp_reguler" required>
                            </div>
                        </div>
                    ...
                    <div class="form-step" id="step-2-kp-reguler">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-control" id="periode_kenaikan_pangkat_kp_reguler" name="periode_kenaikan_pangkat_kp_reguler" required>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <button type="button" class="btn btn-outline-secondary btn-prev-kp-reguler" data-prev="1">Kembali</button>
                            <button type="button" class="btn btn-primary btn-next-kp-reguler" data-next="3">Lanjut</button>
                        </div>
                    </div>
                    ...
                    <div class="form-step" id="step-3-kp-reguler">
                        ...
                        <div class="d-flex justify-content-between">
                            <button type="button" class="btn btn-outline-secondary btn-prev-kp-reguler" data-prev="2">Kembali</button>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.btn-next-kp-reguler').forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                if(next == 2 && !document.getElementById('nama_pegawai_kp_reguler').value) {
        ...
        function updateReview() {
            ...
            document.getElementById('rev-nama').textContent = get('nama_pegawai_kp_reguler');
            document.getElementById('rev-nip').textContent = get('nip_display_kp_reguler');
            document.getElementById('rev-jabatan').textContent = get('jabatan_kp_reguler');
            document.getElementById('rev-unit').textContent = get('unit_kerja_kp_reguler');
            
            const periode = document.getElementById('periode_kenaikan_pangkat_kp_reguler');
