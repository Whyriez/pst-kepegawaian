                    ...
                    <div class="form-step active" id="step-1-jf-naik-jenjang">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_pegawai_jf_naik_jenjang" class="form-label">Nama Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-user"></i></span>
                                    <input type="text" class="form-control bg-light" id="nama_pegawai_jf_naik_jenjang"
                                           name="nama_pegawai_jf_naik_jenjang"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="nip_display_jf_naik_jenjang" class="form-label">NIP Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-id-card"></i></span>
                                    <input type="text" class="form-control bg-light" id="nip_display_jf_naik_jenjang"
                                           name="nip_display_jf_naik_jenjang"
                                           value="{{ $pegawai->nip ?? '-' }}"
                                           readonly>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="jabatan_jf_naik_jenjang" class="form-label">Jabatan Saat Ini</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-briefcase"></i></span>
                                    <input type="text" class="form-control bg-light" id="jabatan_jf_naik_jenjang"
                                           name="jabatan_jf_naik_jenjang"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="pangkat_jf_naik_jenjang" class="form-label">Pangkat Saat Ini</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-star"></i></span>
                                    <input type="text" class="form-control bg-light" id="pangkat_jf_naik_jenjang"
                                           name="pangkat_jf_naik_jenjang"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="satuan_kerja_jf_naik_jenjang" class="form-label">Satuan Kerja</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-building"></i></span>
                                    <input type="text" class="form-control bg-light" id="satuan_kerja_jf_naik_jenjang"
                                           name="satuan_kerja_jf_naik_jenjang"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="golongan_ruang_jf_naik_jenjang" class="form-label">Golongan/Ruang</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-layer-group"></i></span>
                                    <input type="text" class="form-control bg-light" id="golongan_ruang_jf_naik_jenjang"
                                           name="golongan_ruang_jf_naik_jenjang"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="usul_jabatan_jf_naik_jenjang" class="form-label">Usul Jabatan <span class="text-danger">*</span></label>
                                <div class="input-group">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="usul_satuan_kerja_jf_naik_jenjang" class="form-label">Usul Satuan Kerja <span class="text-danger">*</span></label>
                                <div class="input-group">
                            ...
                            @empty
                                <div class="col-12">
                                    <div class="alert alert-warning">
                                        Belum ada syarat dokumen yang diatur di database untuk layanan ini (jf-naik-jenjang).
                                    </div>
                                </div>
                            @endforelse
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function validateStep(currentStep) {
                ...
                if (currentStep == 1) {
                    // Cek apakah NIP terload (indikator data pegawai ada)
                    const nip = document.getElementById('nip_display_jf_naik_jenjang').value.trim();
                    // Cek Inputan Usulan (Manual)
