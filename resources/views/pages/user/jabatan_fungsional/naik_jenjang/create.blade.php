...
@section('content')
    <div class="container-fluid p-0">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                {{-- ACTION FORM --}}
                <form id="form-jf-naik-jenjang" action="{{ route('jf.naik_jenjang.store') }}" method="POST"
                    ...
                    <div class="form-step active" id="step-1-jf-naik-jenjang">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_pegawai_jf_naik_jenjang" class="form-label">Nama Pegawai <span
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="nip_display_jf_naik_jenjang" class="form-label">NIP Pegawai <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-id-card"></i></span>
                                    <input type="text" class="form-control bg-light" id="nip_display_jf_naik_jenjang"
                                           name="nip_display_jf_naik_jenjang" required readonly>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="jabatan_jf_naik_jenjang" class="form-label">Jabatan <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="pangkat_jf_naik_jenjang" class="form-label">Pangkat <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="satuan_kerja_jf_naik_jenjang" class="form-label">Satuan Kerja <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="golongan_ruang_jf_naik_jenjang" class="form-label">Golongan/Ruang <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                        ...
                        <div class="step-header mb-4 mt-4 border-top pt-4">
                            ...
                            <p class="text-muted">Isi detail jabatan dan satuan kerja tujuan</p>
                        </div>

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="usul_jabatan_jf_naik_jenjang" class="form-label">Usul Jabatan <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-user-tie"></i></span>
                                    <input type="text" class="form-control" id="usul_jabatan_jf_naik_jenjang"
                                           name="usul_jabatan_jf_naik_jenjang" required>
                                </div>
                                <div class="invalid-feedback">Harap isi usul jabatan pegawai</div>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="usul_satuan_kerja_jf_naik_jenjang" class="form-label">Usul Satuan Kerja <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-building"></i></span>
                                    <input type="text" class="form-control" id="usul_satuan_kerja_jf_naik_jenjang"
                                           name="usul_satuan_kerja_jf_naik_jenjang" required>
                                </div>
                    ...
                    <div class="form-step" id="step-2-jf-naik-jenjang">
                        <div class="step-header mb-4">
                            ...
                            <p class="text-muted">Unggah dokumen-dokumen yang diperlukan untuk pengajuan kenaikan jenjang
                                ...
                                <div>
                                    ...
                                    <div class="mt-2">
                                        <small class="text-muted">
                                            ...
                                            <span id="upload-progress-jf-naik-jenjang">0/{{ count($syarat) }}</span> dokumen
                                            terunggah
                                        </small>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>Jabatan Lama:</strong> <span id="review-jabatan-jf-naik-jenjang">-</span>
                                        </p>
                                        <p><strong>Pangkat:</strong> <span id="review-pangkat-jf-naik-jenjang">-</span></p>
                                    </div>
                                    <div class="col-md-6">
                                        <p><strong>Satuan Kerja Lama:</strong> <span
                                                id="review-satuan-kerja-jf-naik-jenjang">-</span></p>
                                        <p><strong>Golongan/Ruang:</strong> <span
                                                id="review-golongan-ruang-jf-naik-jenjang">-</span></p>
                                        <div class="border-top pt-2 mt-2">
                                            <p class="text-primary fw-bold mb-1">Usulan Baru:</p>
                                            <p><strong>Usul Jabatan:</strong> <span
                                                    id="review-usul-jabatan-jf-naik-jenjang">-</span></p>
                                            <p><strong>Usul Satuan Kerja:</strong> <span
                                                    id="review-usul-satuan-kerja-jf-naik-jenjang">-</span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function validateStep(currentStep) {
                ...
                // VALIDASI STEP 1: Data Diri & Usulan
                if (currentStep == 1) {
                    const nama = document.getElementById('nama_pegawai_jf_naik_jenjang').value.trim();
                    const usulJabatan = document.getElementById('usul_jabatan_jf_naik_jenjang').value.trim();
                    const usulSatuan = document.getElementById('usul_satuan_kerja_jf_naik_jenjang').value.trim();

                    if (!nama) {
                        isValid = false;
                        errorMsg = 'Silakan lakukan "Cek NIP" dan lengkapi data pegawai terlebih dahulu!';
                    } else if (!usulJabatan || !usulSatuan) {
                        isValid = false;
                        errorMsg = 'Harap lengkapi Usulan Jabatan dan Usulan Satuan Kerja!';
                    }
                }

                // VALIDASI STEP 2: Dokumen Required
                if (currentStep == 2) {
                    const requiredInputs = document.querySelectorAll('#step-2-jf-naik-jenjang input[type="file"][required]');
                    let emptyCount = 0;
            ...
            function updateUploadProgress() {
                const allFileInputs = document.querySelectorAll('#step-2-jf-naik-jenjang input[type="file"]');
                let filledCount = 0;
            ...
            // --- LOGIKA CEK NIP ---
            const btnCek = document.getElementById('btn-cek-nip-jf-naik-jenjang');
            if (btnCek) {
                btnCek.addEventListener('click', function () {
                    const nip = document.getElementById('nip_pegawai_jf_naik_jenjang').value;
                    if (!nip) {
                    ...
                    fetch(`{{ url('/kenaikan-pangkat/ajax/cek-nip') }}/${nip}`)
                        ...
                        .then(res => {
                            if (res.success) {
                                ...
                                set('nama_pegawai_jf_naik_jenjang', d.nama);
                                set('jabatan_jf_naik_jenjang', d.jabatan);
                                set('pangkat_jf_naik_jenjang', d.pangkat);
                                set('usul_jabatan_jf_naik_jenjang', d.usul_jabatan);
                                set('satuan_kerja_jf_naik_jenjang', d.unit_kerja);
                                set('golongan_ruang_jf_naik_jenjang', d.golongan_ruang);
                                set('usul_satuan_kerja_jf_naik_jenjang', d.usul_satuan_kerja);
                                set('nip_display_jf_naik_jenjang', d.nip);
            ...
            function updateReview() {
                ...
                // Set Data Diri & Lama
                setText('review-nama-jf-naik-jenjang', get('nama_pegawai_jf_naik_jenjang'));
                setText('review-nip-jf-naik-jenjang', get('nip_display_jf_naik_jenjang'));
                setText('review-jabatan-jf-naik-jenjang', get('jabatan_jf_naik_jenjang'));
                setText('review-pangkat-jf-naik-jenjang', get('pangkat_jf_naik_jenjang'));
                setText('review-satuan-kerja-jf-naik-jenjang', get('satuan_kerja_jf_naik_jenjang'));
                setText('review-golongan-ruang-jf-naik-jenjang', get('golongan_ruang_jf_naik_jenjang'));

                // Set Data Usulan
                setText('review-usul-jabatan-jf-naik-jenjang', get('usul_jabatan_jf_naik_jenjang'));
                setText('review-usul-satuan-kerja-jf-naik-jenjang', get('usul_satuan_kerja_jf_naik_jenjang'));
