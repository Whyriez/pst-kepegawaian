...
@section('title', 'Riwayat Naik Jenjang JF')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Kenaikan Jenjang Jabatan Fungsional</h2>
                    <p class="text-muted mb-0">Riwayat pengajuan kenaikan jenjang jabatan fungsional.</p>
                </div>
                <a href="{{ route('jf.naik_jenjang.create') }}" class="btn btn-primary shadow-sm">
                    <i class="fas fa-plus-circle me-2"></i>Ajukan Kenaikan Jenjang
                </a>
            </div>
        </div>
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tr>
                            <th class="py-3 px-3">Jenjang Awal</th>
                            <th class="py-3">Jenjang yang Diusul</th>
                        ...
                        @forelse($pengajuans as $item)
                            <tr>
                                {{-- 1. Jenjang Awal (Pangkat/Golongan) --}}
                                <td class="px-3">
                                    <div class="fw-bold text-dark">{{ $item->data_tambahan['pangkat'] ?? '-' }}</div>
                                    <small class="text-muted">{{ $item->data_tambahan['golongan_ruang'] ?? '-' }}</small>
                                </td>

                                {{-- 2. Jenjang yang Diusul (Usulan Jabatan Baru) --}}
                                <td>
                                ...
                                {{-- 3. Jabatan (Jabatan Saat Ini & Unit Kerja) --}}
                                <td>
                                            ...
                                            @if(in_array($item->status, ['pending', 'perbaikan']))
                                                ...
                                                <li>
                                                    <a class="dropdown-item fw-bold text-warning"
                                                       href="{{ route('jf.naik_jenjang.edit', ['id' => $item->id]) }}">
                            ...
                            <tr>
                                <td colspan="5" class="text-center py-5">
                                    <div class="py-4">
                                        ...
                                        <a href="{{ route('jf.naik_jenjang.create') }}" class="btn btn-sm btn-primary mt-2">
                                            Ajukan Sekarang
                                        </a>
                                    </div>
                                </td>
                ...
                html: `
                    <div class="text-start">
                        <table class="table table-sm table-borderless">
                            <tr><td width="35%"><strong>Layanan</strong></td><td>: Kenaikan Jenjang JF</td></tr>
