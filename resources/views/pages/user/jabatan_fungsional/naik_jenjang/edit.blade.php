    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.btn-next-jf-naik-jenjang').forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    if (next === 3) {
                        ...
                        const reqInputs = document.querySelectorAll('#step-2-jf-naik-jenjang input[type="file"][required]');
            ...
            function updateReview() {
                ...
                // Data Diri & Lama
                document.getElementById('review-nama-jf-naik-jenjang').textContent = document.getElementById('nama_pegawai_jf-naik-jenjang')?.value || '-';
                // Fix typo di atas, harusnya id inputnya 'nama_pegawai_jf_naik_jenjang'
