...
@section('content')
    <div class="container-fluid p-0">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                {{-- ACTION FORM --}}
                <form id="form-jf-pemberhentian" action="{{ route('jf.pemberhentian.store') }}" method="POST"
                    ...
                    <div class="form-step active" id="step-1-jf-pemberhentian">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_pegawai_jf_pemberhentian" class="form-label">Nama Pegawai <span
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="nip_display_jf_pemberhentian" class="form-label">NIP Pegawai <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-id-card"></i></span>
                                    <input type="text" class="form-control bg-light" id="nip_display_jf_pemberhentian"
                                           name="nip_display_jf_pemberhentian" required readonly>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="jabatan_jf_pemberhentian" class="form-label">Jabatan <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="pangkat_jf_pemberhentian" class="form-label">Pangkat <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="satuan_kerja_jf_pemberhentian" class="form-label">Satuan Kerja <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="golongan_ruang_jf_pemberhentian" class="form-label">Golongan/Ruang <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                    ...
                    <div class="form-step" id="step-2-jf-pemberhentian">
                        <div class="step-header mb-4">
                            ...
                            <p class="text-muted">Unggah dokumen-dokumen yang diperlukan untuk pengajuan pemberhentian
                                ...
                                <div>
                                    ...
                                    <div class="mt-2">
                                        <small class="text-muted">
                                            ...
                                            <span id="upload-progress-jf-pemberhentian">0/{{ count($syarat) }}</span>
                                            dokumen terunggah
                                        </small>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>Jabatan:</strong> <span id="review-jabatan-jf-pemberhentian">-</span>
                                        </p>
                                    </div>
                                    <div class="col-md-6">
                                        <p><strong>Pangkat:</strong> <span id="review-pangkat-jf-pemberhentian">-</span>
                                        </p>
                                        <p><strong>Satuan Kerja:</strong> <span
                                                id="review-satuan-kerja-jf-pemberhentian">-</span></p>
                                        <p><strong>Golongan/Ruang:</strong> <span
                                                id="review-golongan-ruang-jf-pemberhentian">-</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function validateStep(currentStep) {
                ...
                if (currentStep == 1) {
                    const nama = document.getElementById('nama_pegawai_jf_pemberhentian').value.trim();
                    const jabatan = document.getElementById('jabatan_jf_pemberhentian').value.trim();
                ...
                if (currentStep == 2) {
                    const requiredInputs = document.querySelectorAll('#step-2-jf-pemberhentian input[type="file"][required]');
                    let emptyCount = 0;
            ...
            function updateUploadProgress() {
                const allFileInputs = document.querySelectorAll('#step-2-jf-pemberhentian input[type="file"]');
                let filledCount = 0;
            ...
            // --- LOGIKA CEK NIP ---
            const btnCek = document.getElementById('btn-cek-nip-jf-pemberhentian');
            if (btnCek) {
                btnCek.addEventListener('click', function () {
                    const nip = document.getElementById('nip_pegawai_jf_pemberhentian').value;
                    if (!nip) {
                    ...
                    fetch(`{{ url('/kenaikan-pangkat/ajax/cek-nip') }}/${nip}`)
                        ...
                        .then(res => {
                            if (res.success) {
                                ...
                                set('nama_pegawai_jf_pemberhentian', d.nama);
                                set('jabatan_jf_pemberhentian', d.jabatan);
                                set('pangkat_jf_pemberhentian', d.pangkat);
                                set('nip_display_jf_pemberhentian', d.nip);
                                set('satuan_kerja_jf_pemberhentian', d.unit_kerja);
                                set('golongan_ruang_jf_pemberhentian', d.golongan_ruang);
            ...
            function updateReview() {
                ...
                // Set Data Diri
                setText('review-nama-jf-pemberhentian', get('nama_pegawai_jf_pemberhentian'));
                setText('review-nip-jf-pemberhentian', get('nip_display_jf_pemberhentian'));
                setText('review-jabatan-jf-pemberhentian', get('jabatan_jf_pemberhentian'));
                setText('review-satuan-kerja-jf-pemberhentian', get('satuan_kerja_jf_pemberhentian'));
                setText('review-pangkat-jf-pemberhentian', get('pangkat_jf_pemberhentian'));
                setText('review-golongan-ruang-jf-pemberhentian', get('golongan_ruang_jf_pemberhentian'));
            ...
            // --- SUBMIT FORM ---
            document.getElementById('form-jf-pemberhentian').addEventListener('submit', function (e) {
