                    ...
                    <div class="form-step active" id="step-1-jf-pemberhentian">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_pegawai_jf_pemberhentian" class="form-label">Nama Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-user"></i></span>
                                    <input type="text" class="form-control bg-light" id="nama_pegawai_jf_pemberhentian"
                                           name="nama_pegawai_jf_pemberhentian"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="nip_display_jf_pemberhentian" class="form-label">NIP Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-id-card"></i></span>
                                    <input type="text" class="form-control bg-light" id="nip_display_jf_pemberhentian"
                                           name="nip_display_jf_pemberhentian"
                                           value="{{ $pegawai->nip ?? '-' }}"
                                           readonly>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="jabatan_jf_pemberhentian" class="form-label">Jabatan</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-briefcase"></i></span>
                                    <input type="text" class="form-control bg-light" id="jabatan_jf_pemberhentian"
                                           name="jabatan_jf_pemberhentian"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="pangkat_jf_pemberhentian" class="form-label">Pangkat</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-star"></i></span>
                                    <input type="text" class="form-control bg-light" id="pangkat_jf_pemberhentian"
                                           name="pangkat_jf_pemberhentian"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="satuan_kerja_jf_pemberhentian" class="form-label">Satuan Kerja</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-building"></i></span>
                                    <input type="text" class="form-control bg-light" id="satuan_kerja_jf_pemberhentian"
                                           name="satuan_kerja_jf_pemberhentian"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="golongan_ruang_jf_pemberhentian" class="form-label">Golongan/Ruang</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-layer-group"></i></span>
                                    <input type="text" class="form-control bg-light" id="golongan_ruang_jf_pemberhentian"
                                           name="golongan_ruang_jf_pemberhentian"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function validateStep(currentStep) {
                ...
                // VALIDASI STEP 1: Data Diri (Cek NIP dari DB)
                if (currentStep == 1) {
                    const nip = document.getElementById('nip_display_jf_pemberhentian').value.trim();
                    if (!nip || nip === '-') {
                        isValid = false;
