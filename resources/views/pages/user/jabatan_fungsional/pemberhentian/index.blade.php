...
@section('title', 'Riwayat Pemberhentian JF')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Pemberhentian Jabatan Fungsional</h2>
                    <p class="text-muted mb-0">Riwayat pengajuan pemberhentian dari jabatan fungsional.</p>
                </div>
                <a href="{{ route('jf.pemberhentian.create') }}" class="btn btn-primary shadow-sm">
                    <i class="fas fa-plus-circle me-2"></i>Ajukan Pemberhentian
                </a>
            </div>
        </div>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        @forelse($pengajuans as $item)
                            <tr>
                                ...
                                {{-- 2. Jabatan --}}
                                <td>
                                    <div class="fw-bold text-dark">{{ $item->data_tambahan['jabatan'] ?? '-' }}</div>
                                            ...
                                            @if(in_array($item->status, ['pending', 'perbaikan']))
                                                ...
                                                <li>
                                                    <a class="dropdown-item fw-bold text-warning"
                                                       href="{{ route('jf.pemberhentian.edit', ['id' => $item->id]) }}">
                            ...
                            <tr>
                                <td colspan="4" class="text-center py-5">
                                    <div class="py-4">
                                        ...
                                        <a href="{{ route('jf.pemberhentian.create') }}" class="btn btn-sm btn-primary mt-2">
                                            Ajukan Sekarang
                                        </a>
                                    </div>
                                </td>
                ...
                html: `
                    <div class="text-start">
                        <table class="table table-sm table-borderless">
                            <tr><td width="35%"><strong>Layanan</strong></td><td>: Pemberhentian JF</td></tr>
