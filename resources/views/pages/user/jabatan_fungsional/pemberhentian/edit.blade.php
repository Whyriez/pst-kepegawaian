    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.btn-next-jf-pemberhentian').forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    if (next === 3) {
                        ...
                        if (document.querySelectorAll('#step-2-jf-pemberhentian input.is-invalid').length > 0) {
                        ...
                        let valid = true;
                        document.querySelectorAll('#step-2-jf-pemberhentian input[type="file"][required]').forEach(input => {
                            if (input.files.length === 0) {
                                input.classList.add('is-invalid');
                                valid = false;
                            }
            ...
            function updateReview() {
                ...
                // Default nama dari readonly input
                const nama = document.getElementById('nama_pegawai_jf_pemberhentian').value;

                document.getElementById('review-nama-jf-pemberhentian').textContent = nama;
