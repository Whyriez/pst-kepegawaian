...
@section('title', 'Riwayat Pengangkatan JF')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Pengangkatan Jabatan Fungsional</h2>
                    <p class="text-muted mb-0">Riwayat pengajuan pengangkatan pertama kali dalam jabatan fungsional.</p>
                </div>
                <a href="{{ route('jf.pengangkatan.create') }}" class="btn btn-primary shadow-sm">
                    <i class="fas fa-plus-circle me-2"></i>Ajukan Pengangkatan
                </a>
            </div>
        </div>
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tr>
                            <th class="py-3 px-3">Pangkat Golongan Ruang</th>
                            <th class="py-3">Jabatan</th>
                            <th class="py-3">Jabatan yang Diusulkan</th>
                        ...
                        @forelse($pengajuans as $item)
                            <tr>
                                ...
                                {{-- 3. Jabatan yang Diusulkan --}}
                                <td>
                                    <span class="text-primary fw-bold">
                                        {{ $item->data_tambahan['usul_jabatan'] ?? '-' }}
                                    </span>
                                    <div class="small text-muted">{{ $item->data_tambahan['usul_unit_kerja'] ?? '' }}</div>
                                </td>
                                            ...
                                            @if(in_array($item->status, ['pending', 'perbaikan']))
                                                ...
                                                <li>
                                                    <a class="dropdown-item fw-bold text-warning"
                                                       href="{{ route('jf.pengangkatan.edit', ['id' => $item->id]) }}">
                            ...
                            <tr>
                                <td colspan="5" class="text-center py-5">
                                    <div class="py-4">
                                        ...
                                        <a href="{{ route('jf.pengangkatan.create') }}" class="btn btn-sm btn-primary mt-2">
                                            Ajukan Sekarang
                                        </a>
                                    </div>
                                </td>
                ...
                html: `
                    <div class="text-start">
                        <table class="table table-sm table-borderless">
                            <tr><td width="35%"><strong>Layanan</strong></td><td>: Pengangkatan JF</td></tr>
