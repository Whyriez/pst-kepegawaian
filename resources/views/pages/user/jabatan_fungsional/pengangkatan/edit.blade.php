            ...
            <div class="card-body">
                ...
                <form id="form-jf-pengangkatan"
                    ...
                    <div class="form-step active" id="step-1-jf-pengangkatan">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Usul Jabatan Fungsional <span class="text-danger">*</span></label>
                                <input type="text" class="form-control"
                    ...
                    <div class="form-step" id="step-2-jf-pengangkatan">
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            <button type="button" class="btn btn-outline-secondary btn-prev-jf-pengangkatan" data-prev="1">
                    ...
                    <div class="form-step" id="step-3-jf-pengangkatan">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>Jabatan Lama:</strong> <span id="review-jabatan-jf-pengangkatan">-</span></p>
                                        <p><strong>Pangkat:</strong> <span id="review-pangkat-jf-pengangkatan">-</span></p>
                                    </div>
                                    <div class="col-md-6">
                                        <p><strong>Satuan Kerja Lama:</strong> <span id="review-satuan-kerja-jf-pengangkatan">-</span></p>
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            <button type="button" class="btn btn-outline-secondary btn-prev-jf-pengangkatan" data-prev="2">
                                <i class="fas fa-arrow-left me-2"></i>Kembali
                            </button>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.btn-next-jf-pengangkatan').forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    if (next === 3) {
                        ...
                        const reqInputs = document.querySelectorAll('#step-2-jf-pengangkatan input[type="file"][required]');
            ...
            function updateReview() {
                ...
                // Data Diri & Lama
                document.getElementById('review-nama-jf-pengangkatan').textContent = document.getElementById('nama_pegawai_jf-pengangkatan')?.value || '-';
