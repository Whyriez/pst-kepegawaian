...
@section('title', 'Edit Pengangkatan JF')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Edit Pengangkatan Jabatan Fungsional</h2>
                    <p class="text-muted mb-0">Perbaiki data atau dokumen pengajuan pengangkatan JF Anda.</p>
                </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                {{-- ACTION FORM UPDATE --}}
                <form id="form-jf-pengangkatan"
                      action="{{ route('jf.pengangkatan.update', $pengajuan->id) }}"
                      method="POST"
                    ...
                    <div class="form-step active" id="step-1-jf-pengangkatan">
                        ...
                        {{-- Hidden NIP Display --}}
                        <input type="hidden" name="nip_display_jf_pengangkatan" value="{{ $pengajuan->pegawai->nip }}">

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Nama Pegawai</label>
                                <input type="text" class="form-control bg-light"
                                       id="nama_pegawai_jf_pengangkatan"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control bg-light"
                                       id="nip_display_jf_pengangkatan"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="jabatan_jf_pengangkatan" name="jabatan_jf_pengangkatan"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="pangkat_jf_pengangkatan" name="pangkat_jf_pengangkatan"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="golongan_ruang_jf_pengangkatan" name="golongan_ruang_jf_pengangkatan"
                                       value="{{ $pengajuan->data_tambahan['golongan_ruang'] ?? '' }}" required>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label class="form-label">Satuan Kerja Saat Ini <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control"
                                       id="satuan_kerja_jf_pengangkatan" name="satuan_kerja_jf_pengangkatan"
                        ...
                        <div class="step-header mb-4 mt-4 border-top pt-4">
                            ...
                            <p class="text-muted">Perbaiki usulan jabatan fungsional jika diperlukan</p>
                        </div>

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Usul Jabatan Fungsional <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control"
                                       id="usul_jabatan_jf_pengangkatan" name="usul_jabatan_jf_pengangkatan"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="usul_satuan_kerja_jf_pengangkatan" name="usul_satuan_kerja_jf_pengangkatan"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>Jabatan Lama:</strong> <span
                                                id="review-jabatan-jf-pengangkatan">-</span></p>
                                        <p><strong>Pangkat:</strong> <span id="review-pangkat-jf-pengangkatan">-</span>
                                        </p>
                                    </div>
                                    <div class="col-md-6">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.btn-next-jf-pengangkatan').forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    if (next === 3) {
                        ...
                        if (document.querySelectorAll('#step-2-jf-pengangkatan input.is-invalid').length > 0) {
                        ...
                        let valid = true;
                        document.querySelectorAll('#step-2-jf-pengangkatan input[type="file"][required]').forEach(input => {
                            if (input.files.length === 0) {
                                input.classList.add('is-invalid');
                                valid = false;
                            }
            ...
            function updateReview() {
                ...
                document.getElementById('review-nip-jf-pengangkatan').textContent = get('nip_display_jf_pengangkatan');

                document.getElementById('review-jabatan-jf-pengangkatan').textContent = get('jabatan_jf_pengangkatan');
                document.getElementById('review-pangkat-jf-pengangkatan').textContent = get('pangkat_jf_pengangkatan');
                document.getElementById('review-satuan-kerja-jf-pengangkatan').textContent = get('satuan_kerja_jf_pengangkatan');
                document.getElementById('review-golongan-ruang-jf-pengangkatan').textContent = get('golongan_ruang_jf_pengangkatan');

                // Data Usulan (Khusus Pengangkatan)
                document.getElementById('review-usul-jabatan-jf-pengangkatan').textContent = get('usul_jabatan_jf_pengangkatan');
                document.getElementById('review-usul-satuan-kerja-jf-pengangkatan').textContent = get('usul_satuan_kerja_jf_pengangkatan');

                // Render List Dokumen
                const container = document.getElementById('review-documents-jf-pengangkatan');
                container.innerHTML = '';
