                    ...
                    <div class="form-step active" id="step-1-jf-pengangkatan">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_pegawai_jf_pengangkatan" class="form-label">Nama Pegawai <span
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="nip_display_jf_pengangkatan" class="form-label">NIP Pegawai <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-id-card"></i></span>
                                    <input type="text" class="form-control bg-light" id="nip_display_jf_pengangkatan"
                                           name="nip_display_jf_pengangkatan" required readonly>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="jabatan_jf_pengangkatan" class="form-label">Jabatan Saat Ini <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="pangkat_jf_pengangkatan" class="form-label">Pangkat <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="golongan_ruang_jf_pengangkatan" class="form-label">Golongan/Ruang <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="satuan_kerja_jf_pengangkatan" class="form-label">Satuan Kerja Saat Ini <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="usul_jabatan_jf_pengangkatan" class="form-label">Usul Jabatan Fungsional <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="usul_satuan_kerja_jf_pengangkatan" class="form-label">Usul Satuan Kerja <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-building"></i></span>
