    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('jf.pengangkatan') }}" class="btn btn-secondary">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                {{-- ACTION FORM --}}
                <form id="form-jf-pengangkatan" action="{{ route('jf.pengangkatan.store') }}" method="POST"
                    ...
                    <div class="form-step active" id="step-1-jf-pengangkatan">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_pegawai_jf_pengangkatan" class="form-label">Nama Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-user"></i></span>
                                    <input type="text" class="form-control bg-light" id="nama_pegawai_jf_pengangkatan"
                                           name="nama_pegawai_jf_pengangkatan"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="nip_display_jf_pengangkatan" class="form-label">NIP Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-id-card"></i></span>
                                    <input type="text" class="form-control bg-light" id="nip_display_jf_pengangkatan"
                                           name="nip_display_jf_pengangkatan"
                                           value="{{ $pegawai->nip ?? '-' }}"
                                           readonly>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="jabatan_jf_pengangkatan" class="form-label">Jabatan Saat Ini</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-briefcase"></i></span>
                                    <input type="text" class="form-control bg-light" id="jabatan_jf_pengangkatan"
                                           name="jabatan_jf_pengangkatan"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="pangkat_jf_pengangkatan" class="form-label">Pangkat</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-star"></i></span>
                                    <input type="text" class="form-control bg-light" id="pangkat_jf_pengangkatan"
                                           name="pangkat_jf_pengangkatan"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="golongan_ruang_jf_pengangkatan" class="form-label">Golongan/Ruang</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-layer-group"></i></span>
                                    <input type="text" class="form-control bg-light" id="golongan_ruang_jf_pengangkatan"
                                           name="golongan_ruang_jf_pengangkatan"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="satuan_kerja_jf_pengangkatan" class="form-label">Satuan Kerja Saat Ini</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-building"></i></span>
                                    <input type="text" class="form-control bg-light" id="satuan_kerja_jf_pengangkatan"
                                           name="satuan_kerja_jf_pengangkatan"
                        ...
                        {{-- DATA USULAN (EDITABLE) --}}
                        <div class="step-header mb-4 mt-4 border-top pt-4">
                            <h5 class="fw-bold text-primary mb-2">
                                <i class="fas fa-user-plus me-2"></i>Usulan Pengangkatan
                            </h5>
                            <p class="text-muted">Isi detail jabatan fungsional yang diusulkan</p>
                        </div>

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="usul_jabatan_jf_pengangkatan" class="form-label">Usul Jabatan Fungsional <span class="text-danger">*</span></label>
                                <div class="input-group">
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            <div></div>
                            <button type="button" class="btn btn-primary btn-next-jf-pengangkatan" data-next="2">
                                ...
                                <div>
                                    ...
                                    <div class="mt-2">
                                        <small class="text-muted">
                                            ...
                                            <span id="upload-progress-jf-pengangkatan">0/{{ count($syarat) }}</span> dokumen
                                            terunggah
                                        </small>
                                    </div>
                                </div>
                            ...
                            @empty
                                <div class="col-12">
                                    <div class="alert alert-warning">
                                        Belum ada syarat dokumen yang diatur di database untuk layanan ini (jf-pengangkatan).
                                    </div>
                                </div>
                            @endforelse
                        </div>
                    ...
                    <div class="form-step" id="step-3-jf-pengangkatan">
                        ...
                        <div class="card border-0 bg-light mb-4">
                            <div class="card-body">
                                ...
                                <div id="review-documents-jf-pengangkatan" class="small"></div>
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function showStep(idx) {
                ...
                document.getElementById(`step-${idx}-jf-pengangkatan`).classList.add('active');
                for (let i = 0; i < idx; i++) {
            ...
            function validateStep(currentStep) {
                ...
                if (currentStep == 1) {
                    const nama = document.getElementById('nama_pegawai_jf_pengangkatan').value.trim();
                    const usulJabatan = document.getElementById('usul_jabatan_jf_pengangkatan').value.trim();
                    const usulSatuan = document.getElementById('usul_satuan_kerja_jf_pengangkatan').value.trim();
                ...
                if (currentStep == 2) {
                    const requiredInputs = document.querySelectorAll('#step-2-jf-pengangkatan input[type="file"][required]');
                    let emptyCount = 0;
            ...
            document.querySelectorAll('.btn-next-jf-pengangkatan').forEach(btn => {
            ...
            document.querySelectorAll('.btn-prev-jf-pengangkatan').forEach(btn => {
                btn.addEventListener('click', function () {
            ...
            function updateUploadProgress() {
                const allFileInputs = document.querySelectorAll('#step-2-jf-pengangkatan input[type="file"]');
                let filledCount = 0;
            ...
            // --- LOGIKA CEK NIP ---
            const btnCek = document.getElementById('btn-cek-nip-jf-pengangkatan');
            if (btnCek) {
                btnCek.addEventListener('click', function () {
                    const nip = document.getElementById('nip_pegawai_jf_pengangkatan').value;
                    if (!nip) {
                    ...
                    fetch(`{{ url('/kenaikan-pangkat/ajax/cek-nip') }}/${nip}`)
                        ...
                        .then(res => {
                            if (res.success) {
                                ...
                                set('nama_pegawai_jf_pengangkatan', d.nama);
                                set('jabatan_jf_pengangkatan', d.jabatan);
                                set('pangkat_jf_pengangkatan', d.pangkat);
                                set('usul_jabatan_jf_pengangkatan', d.usul_jabatan);
                                set('satuan_kerja_jf_pengangkatan', d.unit_kerja);
                                set('golongan_ruang_jf_pengangkatan', d.golongan_ruang);
                                set('usul_satuan_kerja_jf_pengangkatan', d.usul_satuan_kerja);
                                set('nip_display_jf_pengangkatan', d.nip);
            ...
            function updateReview() {
                ...
                // Set Data Diri & Lama
                setText('review-nama-jf-pengangkatan', get('nama_pegawai_jf_pengangkatan'));
                setText('review-nip-jf-pengangkatan', get('nip_display_jf_pengangkatan'));
                setText('review-jabatan-jf-pengangkatan', get('jabatan_jf_pengangkatan'));
                setText('review-pangkat-jf-pengangkatan', get('pangkat_jf_pengangkatan'));
                setText('review-satuan-kerja-jf-pengangkatan', get('satuan_kerja_jf_pengangkatan'));
                setText('review-golongan-ruang-jf-pengangkatan', get('golongan_ruang_jf_pengangkatan'));

                // Set Data Usulan
                setText('review-usul-jabatan-jf-pengangkatan', get('usul_jabatan_jf_pengangkatan'));
                setText('review-usul-satuan-kerja-jf-pengangkatan', get('usul_satuan_kerja_jf_pengangkatan'));
            ...
            // --- SUBMIT FORM ---
            document.getElementById('form-jf-pengangkatan').addEventListener('submit', function (e) {
