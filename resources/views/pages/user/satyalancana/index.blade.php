...
@section('title', 'Riwayat Satyalancana')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Satyalancana Karya Satya</h2>
                    <p class="text-muted mb-0">Riwayat pengajuan penghargaan Satyalancana.</p>
                </div>
                <a href="{{ route('satyalancana.create') }}" class="btn btn-primary shadow-sm">
                    <i class="fas fa-medal me-2"></i>Ajukan Satyalancana
                </a>
            </div>
        </div>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        @forelse($pengajuans as $item)
                            <tr>
                                ...
                                {{-- 2. Pangkat / Golongan --}}
                                <td>
                                    {{ $item->data_tambahan['pangkat'] ?? '-' }}
                                    <div class="small text-muted">{{ $item->data_tambahan['golongan_ruang'] ?? '' }}</div>
                                </td>
                                            ...
                                            @if(in_array($item->status, ['pending', 'perbaikan']))
                                                ...
                                                <li>
                                                    <a class="dropdown-item fw-bold text-warning"
                                                       href="{{ route('satyalancana.edit', ['id' => $item->id]) }}">
                            ...
                            <tr>
                                <td colspan="5" class="text-center py-5">
                                    <div class="py-4">
                                        ...
                                        <a href="{{ route('satyalancana.create') }}" class="btn btn-sm btn-primary mt-2">
                                            Ajukan Sekarang
                                        </a>
                                    </div>
                                </td>
                ...
                html: `
                    <div class="text-start">
                        <table class="table table-sm table-borderless">
                            <tr><td width="35%"><strong>Layanan</strong></td><td>: Satyalancana</td></tr>
