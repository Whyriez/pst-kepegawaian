                    ...
                    <div class="form-step active" id="step-1-satyalancana">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_pegawai_satyalancana" class="form-label">Nama Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-user"></i></span>
                                    <input type="text" class="form-control bg-light" id="nama_pegawai_satyalancana"
                                           name="nama_pegawai_satyalancana"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="nip_display_satyalancana" class="form-label">NIP Pegawai</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-id-card"></i></span>
                                    <input type="text" class="form-control bg-light" id="nip_display_satyalancana"
                                           name="nip_display_satyalancana"
                                           value="{{ $pegawai->nip ?? '-' }}"
                                           readonly>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="jabatan_satyalancana" class="form-label">Jabatan</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-briefcase"></i></span>
                                    <input type="text" class="form-control bg-light" id="jabatan_satyalancana"
                                           name="jabatan_satyalancana"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="pangkat_satyalancana" class="form-label">Pangkat</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-star"></i></span>
                                    <input type="text" class="form-control bg-light" id="pangkat_satyalancana"
                                           name="pangkat_satyalancana"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="satuan_kerja_satyalancana" class="form-label">Satuan Kerja</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-building"></i></span>
                                    <input type="text" class="form-control bg-light" id="satuan_kerja_satyalancana"
                                           name="satuan_kerja_satyalancana"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="golongan_ruang_satyalancana" class="form-label">Golongan/Ruang</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="fas fa-layer-group"></i></span>
                                    <input type="text" class="form-control bg-light" id="golongan_ruang_satyalancana"
                                           name="golongan_ruang_satyalancana"
                        ...
                        <div class="alert alert-warning small mt-2">
                            ...
                            Jika terdapat kesalahan pada data diri di atas, harap hubungi Admin Kepegawaian.
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function validateStep(currentStep) {
                ...
                // VALIDASI STEP 1: Data Diri (Readonly)
                if (currentStep == 1) {
                    const nip = document.getElementById('nip_display_satyalancana').value.trim();
