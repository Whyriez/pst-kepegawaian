...
@section('title', 'Edit Satyalancana')
...
@section('content')
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 fw-bold text-dark mb-1">Edit Pengajuan Satyalancana</h2>
                    <p class="text-muted mb-0">Perbaiki data atau dokumen pengajuan Satyalancana Karya Satya.</p>
                </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                {{-- ACTION FORM UPDATE --}}
                <form id="form-satyalancana"
                      action="{{ route('satyalancana.update', $pengajuan->id) }}"
                      method="POST"
                    ...
                    <div class="form-step active" id="step-1-satyalancana">
                        ...
                        {{-- Hidden NIP Display --}}
                        <input type="hidden" name="nip_display_satyalancana" value="{{ $pengajuan->pegawai->nip }}">

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Nama Pegawai</label>
                                <input type="text" class="form-control bg-light"
                                       id="nama_pegawai_satyalancana"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="jabatan_satyalancana" name="jabatan_satyalancana"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="pangkat_satyalancana" name="pangkat_satyalancana"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="unit_kerja_satyalancana" name="unit_kerja_satyalancana"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"
                                       id="golongan_ruang_satyalancana" name="golongan_ruang_satyalancana"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <p><strong>Unit Kerja:</strong> <span
                                                id="review-unit-kerja-satyalancana">-</span></p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            // Notifikasi System
            @if (session('success')) Swal.fire('Berhasil', "{{ session('success') }}", 'success');
            @endif
            ...
            document.querySelectorAll('.btn-next-satyalancana').forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    if (next === 3) {
                        ...
                        if (document.querySelectorAll('#step-2-satyalancana input.is-invalid').length > 0) {
                        ...
                        let valid = true;
                        document.querySelectorAll('#step-2-satyalancana input[type="file"][required]').forEach(input => {
                            if (input.files.length === 0) {
                                input.classList.add('is-invalid');
                                valid = false;
                            }
            ...
            function updateReview() {
                ...
                document.getElementById('review-jabatan-satyalancana').textContent = get('jabatan_satyalancana');
                document.getElementById('review-pangkat-satyalancana').textContent = get('pangkat_satyalancana');
                document.getElementById('review-unit-kerja-satyalancana').textContent = get('unit_kerja_satyalancana');
                document.getElementById('review-golongan-ruang-satyalancana').textContent = get('golongan_ruang_satyalancana');

                // Render List Dokumen
                const container = document.getElementById('review-documents-satyalancana');
                container.innerHTML = '';
